    ...
    <div class="popup-wrapper" id="popup">
        <div class="popup-container">
            ...
            <div class="popup-content">
                <div class="info-item">
                    <div class="info-title">1. PO Outstanding</div>
                    <div class="info-desc">
                        Menu PO Outstanding kini bisa diakses oleh DP. Jika user anda terdaftar sebagai HO, maka dapat melihat seluruh data subbranch nya masing-masing. Klik menu inventory -> PO Outstanding.
                    </div>
                </div>
