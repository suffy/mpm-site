...
<div class="row">
    ...
    <div class="row mt-3">
        ...
        <div class="col-md-5">
            <input type="text" class="form-control" name="nama_event" value="<?= $nama_event ?>">
        </div>
    </div>
    ...
    <div class="row mt-3">
        ...
        <div class="col-md-5">
            <div class="input-group">
                <input type="datetime-local" name="from" class="form-control" value="<?= $event_from ?>">
                <input type="datetime-local" name="to" class="form-control" value="<?= $event_to ?>">
            </div>
        </div>
    </div>
    ...
    <div class="row mt-3">
        ...
        <div class="col-md-5">
            <input type="text" class="form-control" name="lokasi_event" value="<?= $lokasi_event ?>">
        </div>
    </div>
    ...
    <div class="row mt-3">
        ...
        <div class="col-md-5">
            <input type="text" class="form-control" name="ref_perdin" value="<?= $referensi_rpd ?>">
        </div>
    </div>
    ...
    <div class="row mt-3">
        ...
        <div class="col-md-5">
            <input type="text" class="form-control" name="value_omzet" value="<?= $value_omzet ?>">
        </div>
    </div>
        ...
        <div class="col-md-5">
                    ...
                    if ($attach_1) { ?>
                        ...
                        <div class="input-group">
                            <div class="col-md-12 mb-2">
                                <a href="<?= base_url().'assets/uploads/management_event/'.$attach_1 ?>" target="_blank" class="btn-pending"><?= $attach_1 ?></a>
                            </div>
                            <div class="col-md-12">                                
                                <input type="hidden" class="form-control mb-2" name="attach1_old" value="<?= $attach_1 ?>">
                ...
                <?php 
                    if ($attach_2) { ?>
                        ...
                        <div class="input-group">
                            <div class="col-md-12 mb-2">
                                <a href="<?= base_url().'assets/uploads/management_event/'.$attach_2 ?>" target="_blank" class="btn-pending"><?= $attach_2 ?></a>
                            </div>
                            <div class="col-md-12">                                
                                <input type="hidden" class="form-control mb-2" name="attach2_old" value="<?= $attach_2 ?>">
                ...
                <?php 
                    if ($attach_3) { ?>
                        ...
                        <div class="input-group">
                            <div class="col-md-12 mb-2">
                                <a href="<?= base_url().'assets/uploads/management_event/'.$attach_3 ?>" target="_blank" class="btn-pending"><?= $attach_3 ?></a>
                            </div>
                            <div class="col-md-12">
                                <input type="hidden" class="form-control mb-2" name="attach3_old" value="<?= $attach_3 ?>">
    ...
    <div class="row mt-3">
        ...
        <div class="col-md-5">
            ...
            <button type="submit" class="btn btn-generate">Update Data</button>            
