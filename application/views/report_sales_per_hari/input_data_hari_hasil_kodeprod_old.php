...
<html>
    ...
    <div class="row">        
        ...
        <div class="col-xs-5">
            ...
            <?php echo form_close();?>
            <a href="<?php echo base_url()."report_sales_per_hari/export_sales_kodeprod/"; ?>   " class="btn btn-warning" role="button"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> export hasil proses ke dalam excel</a>
        </div>
    </div>
    </div>
    <hr>
