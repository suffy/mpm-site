<div class="col-sm-10">
    ...
    - Breakdown : SubBranch, Salesman<br>
    ...
    <a href="<?php echo base_url()."sales_omzet/sell_out_product"; ?>"class="btn btn-dark" role="button">
                kembali</a>
    <a href="<?php echo base_url()."sales_omzet/export_sales_per_product_kode_salesman"; ?>"class="btn btn-warning" role="button">
    export(.csv)</a>
    <a href="<?php echo base_url()."sales_omzet/export_excel_sales_per_product/59"; ?>"class="btn btn-success" role="button">
    export(.excel)</a>
    </div>
    <br>
...
<div class="card table-card">
    ...
    <div class="dt-responsive table-responsive">
        <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">    
            <thead>     
                <tr>    
                    <th width="4"><font size="2px">Kode</font></th>            
                    <th width="1"><font size="2px">SubBranch</font></th>
                    <th width="1"><font size="2px">Salesman</font></th>
            ...
            <tbody>
                ...
                <tr>                            
                    <td><font size="2px"><?php echo $product->kode; ?></td>
                    <td><font size="2px"><?php echo $product->nama_comp; ?></td>
                    <td><font size="2px"><?php echo $product->namasales; ?></td>
