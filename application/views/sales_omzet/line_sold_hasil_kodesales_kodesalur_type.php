<div class="col-sm-12">
        ...
        - kodeprod : <b> <?php echo $kodeprod; ?>
        <br>
        - Breakdown = Salesman, Class, Type<hr>
        Informasi !! :<br> 
    ...
    <div class="col-sm-10">
        <div class="form-group row">            
            <div class="col-sm-10">
                ...
                kembali</a>
                <a href="<?php echo base_url()."sales_omzet/export_csv_linesold/4"; ?>"class="btn btn-warning" role="button">
        ...
        <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">
            <thead>
                <tr>
                    ...
                    <th colspan="6"><center>Breakdown</center></th>
            ...
            <?php foreach($proses as $a) : ?>
                <tr>                 
                    ...
                    <td><font size="2px"><?php echo $a->kodesales; ?></td>
                    <td><font size="2px"><?php echo $a->namasales; ?></td>
                    <td><font size="2px"><?php echo $a->kodesalur; ?></td>
                    <td><font size="2px"><?php echo $a->namasalur; ?></td>
