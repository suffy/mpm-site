        ...
        <div class="col-sm-12">
            <div class="form-group row">
                <label class="col-sm-2 col-form-label"></label>
                    ...
                    <div class="col-lg-2">
                        <div class="checkbox-color checkbox-primary">
                            <input id="checkbox11" type="checkbox"  name="kojiesan" value="023" class="checkbox">
                    ...
                    <div class="col-lg-2">
                        <div class="checkbox-color checkbox-primary">
                            <input id="checkbox12" type="checkbox"  name="tempo" value="024" class="checkbox">
                    ...
                    <div class="col-lg-2">
                        <div class="checkbox-color checkbox-primary">
                            <input id="checkbox13" type="checkbox"  name="gdp" value="025" class="checkbox">
