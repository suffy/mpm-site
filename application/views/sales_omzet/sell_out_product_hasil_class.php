<div class="col-sm-10">
    ...
    - Class Outlet Condition : <?php echo $kdc; ?> <br>
    - Breakdown : Per Class<br>
    ...
    <a href="<?php echo base_url()."sales_omzet/sell_out_product"; ?>"class="btn btn-dark" role="button">
                kembali</a>
    <a href="<?php echo base_url()."sales_omzet/export_sales_per_product/$year/2/class"; ?>"class="btn btn-warning" role="button">
    export(.csv)</a>
    </div>
    <br>
        ...
        <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">    
            <thead>     
                <tr>    
                    ...
                    <th width="1"><font size="2px">Jenis</font></th>
