<div class="col-sm-10">
    ...
    <a href="<?php echo base_url()."sales_omzet/sell_out_product"; ?>"class="btn btn-dark" role="button">
                kembali</a>
    <a href="<?php echo base_url()."sales_omzet/export_sales_per_product/$year/5/"; ?>"class="btn btn-warning" role="button">
    export(.csv)</a>
    </div>
    <br>
        ...
        <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">    
            <thead>     
                <tr>    
                    ...
                    <th width="1"><font size="2px">Sub Branch</font></th>
            ...
            <tfoot><tr>    
                    <th width="4"><font size="2px">Branch</font></th>            
                    <th width="1"><font size="2px">Sub Branch</font></th>
                    <th width="1"><font size="2px">Jan</font></th>
                    <th width="1"><font size="2px">Feb</font></th>
                    <th width="1"><font size="2px">Mar</font></th>
