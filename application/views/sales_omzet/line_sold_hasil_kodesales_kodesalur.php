    ...
    <div class="col-sm-10">
        <div class="form-group row">            
            <div class="col-sm-10">
                ...
                kembali</a>
                <a href="<?php echo base_url()."sales_omzet/export_csv_linesold/2"; ?>"class="btn btn-warning" role="button">
        ...
        <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">
            <thead>
                <tr>
                    ...
                    <th colspan="4"><center>Breakdown</center></th>
