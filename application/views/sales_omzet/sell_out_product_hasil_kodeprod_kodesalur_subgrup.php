<div class="col-sm-10">
    ...
    - Breakdown : Kodeprod, Class, Sub Group<br>
    ...
    <a href="<?php echo base_url()."sales_omzet/sell_out_product"; ?>"class="btn btn-dark" role="button">
                kembali</a>
    <a href="<?php echo base_url()."sales_omzet/export_sales_per_product_kodeprod_kodesalur_subgrup"; ?>"class="btn btn-warning" role="button">
    export(.csv)</a>
    <a href="<?php echo base_url()."sales_omzet/export_excel_sales_per_product/42"; ?>"class="btn btn-success" role="button">
    export(.excel)</a>
    </div>
    <br>
        ...
        <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">    
            ...
            <tbody>
                ...
                <tr>                
                    ...
                    <td><font size="2px"><?php echo $product->namasalur; ?></td>
