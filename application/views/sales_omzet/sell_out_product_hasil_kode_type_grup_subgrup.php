<div class="col-sm-10">
    ...
    - Breakdown : Tipe, Group Product<, Sub Group<br>
    ...
    <a href="<?php echo base_url()."sales_omzet/sell_out_product"; ?>"class="btn btn-dark" role="button">
                kembali</a>
    <a href="<?php echo base_url()."sales_omzet/export_sales_per_product_kode_type_grup_subgrup"; ?>"class="btn btn-warning" role="button">
    export(.csv)</a>
    <a href="<?php echo base_url()."sales_omzet/export_excel_sales_per_product/47"; ?>"class="btn btn-success" role="button">
    export(.excel)</a>
    </div>
    <br>
        ...
        <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">    
            <thead>     
                <tr>    
                    ...
                    <th width="1"><font size="2px">Nama Tipe</font></th>
                    <th width="1"><font size="2px">Sektor</font></th>
                    <th width="1"><font size="2px">Segment</font></th>
                    <th width="1"><font size="2px">Group</font></th>
                    <th width="1"><font size="2px">Sub Group</font></th>
                    <th width="1"><font size="2px">Nama Sub Group</font></th>
            ...
            <tbody>
                ...
                <tr>      
                    ...
                    <td><font size="2px"><?php echo $product->nama_type; ?></td>
                    <td><font size="2px"><?php echo $product->sektor; ?></td>
                    <td><font size="2px"><?php echo $product->segment; ?></td>
                    <td><font size="2px"><?php echo $product->nama_group; ?></td>
                    <td><font size="2px"><?php echo $product->subgroup; ?></td>
                    <td><font size="2px"><?php echo $product->nama_sub_group; ?></td>
