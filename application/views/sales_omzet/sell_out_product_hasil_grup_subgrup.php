<div class="col-sm-10">
    ...
    - Breakdown : Group Product, Sub Group <br>
    ...
    <a href="<?php echo base_url()."sales_omzet/sell_out_product"; ?>"class="btn btn-dark" role="button">
                kembali</a>
    <a href="<?php echo base_url()."sales_omzet/export_sales_per_product_grup_subgrup"; ?>"class="btn btn-warning" role="button">
    export(.csv)</a>
    <a href="<?php echo base_url()."sales_omzet/export_excel_sales_per_product/37"; ?>"class="btn btn-success" role="button">
    export(.excel)</a>
    </div>
    <br>
