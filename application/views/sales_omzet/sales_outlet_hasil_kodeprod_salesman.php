<div class="col-sm-10">
    ...
    - Breakdown : Kodeprod, Salesman
    <hr>
    Informasi !! : <br>
    - Halaman ini hanya menampilkan nilai Unit. Untuk melihat Value. Silahkan klik Export.<br>
    ...
    <a href="<?php echo base_url()."sales_omzet/sales_outlet"; ?>"class="btn btn-dark" role="button">
                kembali</a>
    <a href="<?php echo base_url()."sales_omzet/export_outlet/$tahun/3/kodeprod_salesman"; ?>"class="btn btn-warning" role="button">
    export(.csv)</a>
    <a href="<?php echo base_url()."sales_omzet/export_excel_outlet/$tahun/3/kodeprod_salesman"; ?>"class="btn btn-success" role="button">
    export(.excel)</a>
    </div>
    <br>
           ...
           <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">    
                ...
                <?php foreach($proses as $a) : ?>
                    <tr>                      
                        ...
                        <td><font size="2px"><?php echo ($a->namasales); ?></td>
