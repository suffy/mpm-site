                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <!-- <a href="#" onclick="getImage('<?= $a->id ?>')"><img
                                                                            alt=""
                                                                            src="<?= base_url() . 'assets/uploads/helpdesk/' . $a->filename1; ?>"
                                                                            style='max-width: 25%;'></a>
                                                                    <a href="#" onclick="getImage('<?= $a->id ?>')"><img
                                                                            alt=""
                                                                            src="<?= base_url() . 'assets/uploads/helpdesk/' . $a->filename2; ?>"
                                                                            style='max-width: 25%;'></a>
                                                                    <a href="#" onclick="getImage('<?= $a->id ?>')"><img
                                                                            alt=""
                                                                            src="<?= base_url() . 'assets/uploads/helpdesk/' . $a->filename3; ?>"
                                                                            style='max-width: 25%;'></a> -->
                                                                </td>
                                                                <td>
                            ...
                            <div class="card sale-card">
                                ...
                                <div class="card-block">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea id='pesan' name="pesan" rows="6" cols="90%" class="form-control"
