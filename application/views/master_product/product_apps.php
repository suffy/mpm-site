...
<a href="export_product_apps" role="button" class="btn btn-warning btn-sm">Export Product (Apps)</a>
<a href="<?php echo base_url()."master_product/pricelist"; ?>"class="btn btn-dark btn-sm" role="button">Pricelist</a>
<br>
<br>
                ...
                <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">
                    ...
                    <tbody>
                        ...
                        <td><font size="2px"><?php echo $report; ?></td> -->
                                <td>
                                    <font size="1px">
                                        <button class="fa fa-edit fa-xl btn-info" id="testOnclick" onclick="getEditIDProduct_Apps('<?= $a->kodeprod ?>')"></button>
                                </td>
                                <td>
                                    <font size="1px">
                                        <button class="fa fa-plus fa-xl btn-info" id="testOnclick" onclick="getHargaIDProduct_Apps('<?= $a->kodeprod ?>')"></button>
                                </td>
                                <td>
                                    <font size="1px">
                                        <button class="fa fa-eye fa-xl btn-info" onclick='window.location.href="<?php echo base_url() . "master_product/product_detail_harga_apps/$a->kodeprod"; ?>"'></button>
                                </td>
                            </tr>
...
<!-- =========================================== Tambah Product =============================================== -->
<?php $this->load->view('master_product/modal_addproduct'); ?>

<!-- =========================================== Edit Product =============================================== -->
<?php $this->load->view('master_product/modal_editproduct_apps'); ?>

<!-- =========================================== Tambah Harga =============================================== -->
<?php $this->load->view('master_product/modal_addharga_apps'); ?>

<!-- =========================================== Tambah Harga Jual DP =============================================== -->
<?php $this->load->view('master_product/modal_addharga_dp'); ?>