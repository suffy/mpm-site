        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="kodeprod" minlength='6' maxlength='6' id="kodeprod_apps"  readonly />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Namaprod</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="namaprod" id="namaprod"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Nama Invoice</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="namainvoice" id="namainvoice"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Kode PRC</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="prc" id="prc"  />
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row kodedelto">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="kd_delto" id="kode_deltomed2"  />
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="divisi" id="divisiid"  />
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="hrg_beli" id="beli"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Harga Grosir</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="hrg_grosir" id="h_grosir"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Harga Ritel</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="hrg_ritel" id="h_ritel"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Harga Motoris Ritel</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="hrg_motoris_ritel" id="h_motoris_ritel"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Karoseri</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="karoseri" id="karoseri"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Ppnbm</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="ppnbm" id="ppnbm"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Locker</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="locker" id="locker"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Dimensi 1</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="dimensi_1" id="dimensi1"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Dimensi 2</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="dimensi_2" id="dimensi2"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Pallete 1</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="pallete_1" id="pallete1"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Pallete 2</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="pallete_2" id="pallete2"  />
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="prodid_supplier" id="product_id_supplier"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Product Supplier</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="prod_supplier" id="product_supplier"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Group 1</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="group_1" id="group1"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Group 2</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="group_2" id="group2"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Group 3</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="group_3" id="group3"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Buffer Stock</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="buffer_stock" id="buffer_stock"  />
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="status_po" id="status_po"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Free Tax</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="free_tax" id="free_tax"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Harga Toko 1</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="hrg_toko_1" id="harga_toko1"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Harga Toko 2</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="hrg_toko_2" id="harga_toko2"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Harga Toko 3</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="hrg_toko_3" id="harga_toko3"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Group Id Target</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="group_id_target" id="group_id_target"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Product Focus</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="prod_focus" id="product_focus"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Discount Grosir</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="disc_grosir" id="discount_grosir"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Discount Ritel</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="disc_ritel" id="discount_ritel"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Discount Motoris Ritel</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="disc_motoris_ritel" id="discount_motoris_ritel"  />
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <textarea name="deskripsi" rows="7" cols="50" id="deskripsi" ></textarea>
                    </div>
                </div>
                <hr>
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="apps_namaprod" id="apps_namaprod"  />
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="apps_konversi" id="apps_konversi"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Apps Min Pembelian</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="apps_min_pembelian" id="apps_min_pembelian"  />
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <select name="apps_kategori" class="form-control" id="apps_kategori" >
                            <option value=""></option>
