                                ...
                                <?php foreach ($asset as $a) : ?>
                                    <ul>
                                        ...
                                        <label class="col-sm-4 col-form-label">No. PO</label>
                                                <div class="col-sm-8">
                                                    <input class="form-control" type="text" name="nopo" value="<?php echo $a->no_pengajuan ;?>" readonly />
                                                </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <?php if($a->upload_faktur != ''){
                                         echo anchor("assets_2/file/faktur_asset/".$a->upload_faktur, 'Faktur', "class='btn btn-success btn-sm'");
                                        } ?>
