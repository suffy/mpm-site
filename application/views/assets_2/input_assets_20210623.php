<a href="<?php echo base_url()."assets/view_assets"; ?>" class='btn btn-sm btn-warning'>Kembali</a>
<br>
<br>
<div class="card table-card">
        ...
        <div class="dt-responsive table-responsive">
            <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">    
                <thead>
                    <tr>                
                        <th width="1"><font size="2px">No. Voucher</th>
                ...
                <?php   foreach($q_modal as $a) : 
                        $tglentry =trim($a->tgl_entry);
                        $convert_tglentry=date('Y-m-d',strtotime($tglentry));
                ?>
                        <tr>                      
                            <td><font size="2px"><?php echo $a->nick_voucher; ?></td>
                            <td><font size="2px"><?php echo $a->keterangan; ?></td>
                            <td><font size="2px"><?php echo number_format($a->kredit); ?></td>
                            <td><font size="2px"><?php echo $a->tgl_entry; ?></td>
                            <td><button  type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal<?php echo $a->nourut; ?>">
                            Pilih
                            </button>
                            </td>
                        </tr>
 ...
 <!----------------------------------------------------------- Modal ----------------------------------------------------------------------------------->
                        ...
                        <div class="modal fade" id="exampleModal<?php echo $a->nourut; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg " role="document">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" value="<?php echo $a->nick_voucher; ?>" type="text" name="nv" required readonly />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Nama Barang</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" value="<?php echo $a->keterangan; ?>" type="text" name="nb" required />
                                            </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Keperluan :</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" value="<?php echo $a->cos_description; ?>" type="text" name="kpr" required/>
                                            </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Tanggal Payroll</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" type="date" value="<?php echo $convert_tglentry; ?>" name="tp" required />
                                            </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Nilai Perolehan</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" value="<?php echo $a->kredit; ?>" type="text" name="np" required />
                                            </div>
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Nilai Jual</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" name="nj" />
                                            </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Tanggal Jual</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" type="date" name="tj" />
                                            </div>
                                    </div>
                                </div>
                            ...
                            <?php echo form_open('assets/input_assets_hasil/'); ?>
