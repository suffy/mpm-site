...
<div class="card table-card">
        ...
        <div class="dt-responsive table-responsive">
            <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">    
                <thead>
                    <tr>                
                        <th width="1"><font size="2px">No. Jurnal</th>
                ...
                <?php foreach($q_modal as $a) : 
                    ...
                    $tgl_payroll = date("Y-m-d",$f);?>
                        <tr>                      
                            <td><font size="2px"><?php echo $a->nojurnal; ?></td>
                            ...
                            <div class="modal-dialog modal-lg " role="document">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" value="<?php echo $a->nojurnal; ?>" type="text" name="nv" readonly required />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Keperluan :</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" value="<?php echo $a->description; ?>" type="text" name="kpr" readonly required/>
                                            </div>
                                    </div>
                                </div>
