...
<div class="card table-card">
                ...
                <?php foreach($q_modal as $a) : 
                    ...
                    $tgl_payroll = date("Y-m-d",$f);?>
                        <tr>                      
                            ...
                            <td><font size="2px"><?php if ($a->debet > $a->kredit){
 ...
 <!----------------------------------------------------------- Modal ----------------------------------------------------------------------------------->
                        ...
                        <div class="modal fade" id="exampleModal<?php echo $a->nourut; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg " role="document">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" value="<?php echo $a->nick_voucher; ?>" type="text" name="nv" readonly required />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Tanggal Payroll</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" type="date" name="tp" value="<?php echo $tgl_payroll; ?>" readonly required />
                                            </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Keperluan :</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" value="<?php echo $a->cos_description; ?>" type="text" name="kpr" readonly required/>
                                            </div>
                                    </div>
                                </div>
                            ...
                            <?php echo form_open('assets_2/input_assets_hasil/'); ?>
