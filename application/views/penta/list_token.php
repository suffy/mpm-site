    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-9">
                    <button type="submit" class="pastel-btn pastel-mint" id="btnKirim" onclick="return button()">Get Sales All+Batam+GT</button>
                    <button class="btn btn-loading" id="btnLoading" type="button" disabled>
                    ... Please wait ...
                    </button>                    
                    <!-- <a href="<?= base_url().'penta/get_penta_batam' ?>" class="pastel-btn pastel-mint">Get Sales Batam</a> -->
                    <!-- <a href="<?= base_url().'penta/get_penta_sales_all' ?>" class="pastel-btn pastel-mint">Get Sales Nasional+Batam+GT</a> -->
                    <a href="<?= base_url().'penta/get_penta_stock_new' ?>" class="pastel-btn pastel-mint">Get stock live</a>
                    <a href="<?= base_url().'penta/get_penta_stock_all_new' ?>" class="pastel-btn pastel-mint">Get stock all live</a>
                </div>
            </div>            
        </div>
    </div>
