            ...
            <table id="tabel">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $p->bulan ?></td>
                        <td>                         
                            <label class="btn btn-submit status pending-rilis-po" style="font-size:14px"><?= number_format($p->total_gross,0) ?></label>
                        </td>
                        <td>
                            <label class="btn btn-submit status pending-finance" style="font-size:14px"><?= number_format($p->total_net,0) ?></label>
                        </td>
                        <td><?= $p->created_at ?></td>
                        <td><?= $p->username ?></td>
