...
<div class="az-content-left az-content-left-components">
    <div class="component-item">
        <label>Sales Penta</label>
        <nav class="nav flex-column">
            <a href="<?= base_url().'penta/sales_dashboard' ?>" class="nav-link-new">Sales</a>
            <a href="<?= base_url().'penta/stock_doi' ?>" class="nav-link-new">Stock dan Doi</a>
            <hr>
            
            <label>Integration Penta</label>
            <a href="<?= base_url().'penta/list_token' ?>" class="nav-link-new">Request Token</a>
            <a href="<?= base_url().'penta/log_sales' ?>" class="nav-link-new">History Sales</a>
            <hr>
            <a href="<?= base_url().'penta/log_stock' ?>" class="nav-link-new">History Stock</a>
