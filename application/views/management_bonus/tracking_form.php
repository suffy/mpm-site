...
<?= form_open($url); ?>
    ...
    <div class="card-block">
                    ...
                    <tbody>     
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="number" name="qty_penggantian[]" value="" size="10">
                            </td>
                            <td>
                                <textarea name="keterangan[]" cols="20" rows="2"></textarea>
                            </td>
                        </tr>
                        <?php endforeach; ?>   
                    </tbody>
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-5">
                <input type="date" name="tgldo" class="form-control">
            </div>
        </div>
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-5">
                <input type="submit" value="Save Tracking" class="btn btn-danger">
            </div>
        </div>
