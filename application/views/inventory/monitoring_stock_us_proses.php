...
<div class="card-block">
    ...
    <div class="col-sm-10">
        <div class="form-group row">            
            <div class="col-sm-10">
                <a href="<?php echo base_url()."inventory/monitoring_stock_us/"; ?>"class="btn btn-dark" role="button">
                kembali</a>
                <a href="<?php echo base_url()."inventory/export_monitoring_stock_us/"; ?>"class="btn btn-warning" role="button">
                <span class="glyphicon glyphicon-print" aria-hidden="true"></span> export (csv)</a>     
                <a href="<?php echo base_url()."inventory/export_monitoring_stock_po_outstanding/005"; ?>"class="btn btn-primary" role="button">
                <span class="glyphicon glyphicon-print" aria-hidden="true"></span> export po outstanding (csv)</a> 
                <!-- <a href="<?php echo base_url()."inventory/monitoring_stock_us_next/"; ?>"class="btn btn-success" role="button">
                Proses 2</a>      -->
            </div>
