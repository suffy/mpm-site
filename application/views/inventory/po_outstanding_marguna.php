    ...
    <div class="col-sm-10">
        <div class="form-group row">            
            <div class="col-sm-10">
                ...
                kembali</a>
                <a href="<?php echo base_url()."inventory/po_outstanding_marguna_export/"; ?>"class="btn btn-warning" role="button">
        ...
        <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">
            ...
            foreach($proses as $x) : ?>
                <tr>                 
                    ...
                    <td><font size="2"><?php echo number_format($x->qty_po_unit); ?></td>
                    <td><font size="2"><?php echo number_format($x->qty_pemenuhan_unit); ?></td>
                </tr>
            <?php 
            endforeach; 
            ?>
