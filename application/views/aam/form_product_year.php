...
<div class='row'>
    ...
    foreach($query->result() as $value)
    {
        ...
        <td>
           <div class="checkbox-inline">
           <INPUT NAME="options[]"  TYPE="CHECKBOX" id="options" VALUE="<?php echo $value->kode_aam ?>"><?php echo $value->deskripsi?>
           </div>
        </td>
        ...
        else
        {
            ...
            <td>
                <div class="checkbox-inline">
                    <INPUT NAME="options[]" class="checkbox" TYPE="CHECKBOX" id="options" VALUE="<?php echo $value->kode_aam ?>"><?php echo $value->deskripsi?>
                </div>
            </td>
        <?php
            echo '</tr><tr>';
