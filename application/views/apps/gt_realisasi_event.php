                ...
                <table id="tabel" class="table table-striped" style="width:100%">
                    <thead>
                        <tr>       
                            ...
                            <th class="text-center">TargetSelling</th>         
                            <th class="text-center">ActualSelling</th>         
                            <th class="text-center">Achievement</th>         
                            <th class="text-center">activity1</th>         
                            <th class="text-center">activity2</th>         
                    ...
                    <tbody>     
                        <?php foreach ($get_data->result() as $a) : ?>        
                            <tr> 
                                ...
                                <td><?= $a->kategori ?></td>   
                                <td><?= $a->audience ?></td>   
                                <td><?= $a->target_selling ?></td>   
                                <td><?= $a->actual_selling ?></td>   
                                <td><?= $a->achievement ?></td>   
                                <td>
                                    <?php if (empty($a->image_activity1)) { ?>
                                        No Image
                                    <?php } else { ?>
                                        <img src="<?= $a->image_activity1 ?>" alt="<?= $a->nama ?>" style="width: 100px; height: 100px; object-fit: cover;border-radius: 10px;">
                                    <?php } ?>
                                </td>  
                                <td>
                                    <?php if (empty($a->image_activity2)) { ?>
                                        No Image
                                    <?php } else { ?>
                                        <img src="<?= $a->image_activity2 ?>" alt="<?= $a->nama ?>" style="width: 100px; height: 100px; object-fit: cover;border-radius: 10px;">
                                    <?php } ?>
                                </td>  
                                <td>
                                    <?php if (empty($a->image_branding)) { ?>
                                        No Image
                                    <?php } else { ?>
                                        <img src="<?= $a->image_branding ?>" alt="<?= $a->nama ?>" style="width: 100px; height: 100px; object-fit: cover;border-radius: 10px;">
                                    <?php } ?>
                                </td>  
                                <td>
                                    <?php if (empty($a->image_faktur_penyelesaian)) { ?>
                                        No Image
                                    <?php } else { ?>
                                        <img src="<?= $a->image_faktur_penyelesaian ?>" alt="<?= $a->nama ?>" style="width: 100px; height: 100px; object-fit: cover;border-radius: 10px;">
                                    <?php } ?>
                                </td>  
                            </tr>
                        <?php endforeach; ?>   
...
if (is_object($get_data)) {
    foreach ($get_data->result() as $a) {
        if (isset($a->nama) && isset($a->latitude) && isset($a->longitude)) {
            $nama[] = $a->nama;
