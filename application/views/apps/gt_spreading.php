                ...
                <table id="tabel" class="table table-striped" style="width:100%">
                    <thead>
                        <tr>       
                            ...
                            <th class="text-center">Image After</th>         
                        </tr>
                    </thead>
                    <tbody>     
                        <?php foreach ($get_data->result() as $a) : ?>        
                            <tr> 
                                ...
                                <td>
                                    <?php if (empty($a->image_before)) { ?>
                                        No Image
                                    <?php } else { ?>
                                        <img src="<?= $a->image_before ?>" alt="<?= $a->nama_toko ?>" style="width: 100px; height: 100px; object-fit: cover;border-radius: 10px;">
                                    <?php } ?>
                                </td>  
                                <td>
                                    <?php if (empty($a->image_after)) { ?>
                                        No Image
                                    <?php } else { ?>
                                        <img src="<?= $a->image_after ?>" alt="<?= $a->nama_toko ?>" style="width: 100px; height: 100px; object-fit: cover;border-radius: 10px;">
                                    <?php } ?>
                                </td>  
                            </tr>
                        <?php endforeach; ?>   
