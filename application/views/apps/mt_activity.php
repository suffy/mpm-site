                ...
                <table id="tabel" class="table table-striped" style="width:100%">
                    <thead>
                        <tr>       
                            ...
                            <th class="text-center">result competitor</th>         
                            ...
                            <tr> 
                                ...
                                <td>                                    
                                    <?php if (empty($a->image)) { ?>
                                        No Image
                                    <?php } else { ?>
                                        <img src="<?= $a->image ?>" alt="<?= $a->toko ?>" style="width: 100px; height: 100px; object-fit: cover;border-radius: 10px;">
                                    <?php } ?>
                                </td>   
                            </tr>
                        <?php endforeach; ?>   
...
if (is_object($get_data)) {
    foreach ($get_data->result() as $a) {
        if (isset($a->toko) && isset($a->latitude) && isset($a->longitude)) {
            $nama[] = $a->toko;
