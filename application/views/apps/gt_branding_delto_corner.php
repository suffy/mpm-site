                ...
                <table id="tabel" class="table table-striped" style="width:100%">
                    <thead>
                        <tr>       
                            ...
                            <th class="text-center">ImageSpanduk</th>                 
                            <th class="text-center">ImageCOC</th>                 
                            <th class="text-center">ImageHangingMobile</th>                 
                            <th class="text-center">ImageSticker</th>                 
                            <th class="text-center">ImageDoorFrame</th>                 
                        </tr>
                    </thead>
                    <tbody>     
                        <?php foreach ($get_data->result() as $a) : ?>        
                            <tr> 
                                ...
                                <td>
                                    <?php if (empty($a->image_spanduk)) { ?>
                                        No Image
                                    <?php } else { ?>
                                        <img src="<?= $a->image_spanduk ?>" alt="<?= $a->nama_toko ?>" style="width: 100px; height: 100px; object-fit: cover;border-radius: 10px;">
                                    <?php } ?>
                                </td>  
                                <td>
                                    <?php if (empty($a->image_coc)) { ?>
                                        No Image
                                    <?php } else { ?>
                                        <img src="<?= $a->image_coc ?>" alt="<?= $a->nama_toko ?>" style="width: 100px; height: 100px; object-fit: cover;border-radius: 10px;">
                                    <?php } ?>
                                </td>  
                                <td>
                                    <?php if (empty($a->image_hanging_mobile)) { ?>
                                        No Image
                                    <?php } else { ?>
                                        <img src="<?= $a->image_hanging_mobile ?>" alt="<?= $a->nama_toko ?>" style="width: 100px; height: 100px; object-fit: cover;border-radius: 10px;">
                                    <?php } ?>
                                </td>  
                                <td>
                                    <?php if (empty($a->image_sticker)) { ?>
                                        No Image
                                    <?php } else { ?>
                                        <img src="<?= $a->image_sticker ?>" alt="<?= $a->nama_toko ?>" style="width: 100px; height: 100px; object-fit: cover;border-radius: 10px;">
                                    <?php } ?>
                                </td>  
                                <td>
                                    <?php if (empty($a->image_door_frame)) { ?>
                                        No Image
                                    <?php } else { ?>
                                        <img src="<?= $a->image_door_frame ?>" alt="<?= $a->nama_toko ?>" style="width: 100px; height: 100px; object-fit: cover;border-radius: 10px;">
                                    <?php } ?>
                                </td>  
                            </tr>
                        <?php endforeach; ?>   
