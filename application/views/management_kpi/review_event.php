...
<div class="row">
    ...
    <div class="row mt-4">
        ...
        <div class="col-md-5">
            <button type="submit" class="btn btn-submit-black" id="btnKirim" onclick="return button()">Save Review</button>
            <button class="btn btn-loading" id="btnLoading" type="button" disabled>
            ... Please wait ...
            </button>
            <a href="<?= base_url('kpi/manage_workspace/'.$signature_workspace) ?>" class="btn btn-submit-black" id="btnBack">back</a>
        </div>
    </div>
            ...
            <table id="review" class="display" style="overflow-x: scroll; width: 100%;">
                ...
                <tbody>     
                    ...
                    <tr>
                        ...
                        <td class="td-review text-center"><a href="#" class="btn btn-submit"><?= $a->point ?></td>  
                        <td class="td-review text-center">
                            <a href="<?= base_url('kpi/delete_review_event/'.$a->signature.'/'.$signature_workspace.'/'.$signature_event) ?>" class="btn-submit-black" onclick="return confirm('Anda ingin menghapus data ini ?')" style = "background-color: red"><i class="fa-solid fa-trash-can" style="color: white"></i> del</a>
                        </td>                     
                    </tr>
                    <?php endforeach; ?> 
                </tbody>
