                    ...
                    <table id="table-report-tim">
                        <thead>
                            <tr>
                                ...
                                <th>Kuartal</th>
                                <th>Tahun</th>
                                <th>Total Pemerataan Product</th>
                                <th>Total Pemerataan Product Verified</th>
                                <th>Point</th>
                            </tr>
                        </thead>
                        <tbody>
                        ...
                        foreach ($get_report_point_tim->result() as $a) : ?>
                            <tr>
                                ...
                                <td><?= $a->kuartal ?></td>
                                <td><?= $a->tahun ?></td>
                                <td><?= $a->total_pemerataan_product ?></td>
                                <td><?= $a->total_pemerataan_product_verified ?></td>
                                <td><?= $a->point ?></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                ...
                <div class="card-body">
                    ...
                    <p style="font-size: 70px;">
                        <?php if ($get_report_point->num_rows() > 0) {
                            ...
                            echo '<br><button type="button" class="btn btn-submit-black" onclick="review_click()">Review Pemerataan Product</button>';
                        } else {
                            echo '0';
                        }?>
                    </p>
