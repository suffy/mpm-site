                ...
                <div class="card-body">
                    ...
                    <p style="font-size: 70px;">
                        <?php if ($get_report_point->num_rows() > 0) {
                            ...
                            echo '<br><button type="button" class="btn btn-submit-black" onclick="review_click()">Review Event</button>';
                        } else {
                            echo '0';
                        }?>
                    </p>
...
<div class="container-fluid mb-5" id="review">
    <div class="card">
        <div class="card-body">
            ...
            <h5 class="card-title" style="text-align: center;">Review Event</h5>
