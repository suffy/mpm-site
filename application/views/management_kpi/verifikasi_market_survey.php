...
<div class="container-fluid">
    ...
    <?php if(!$signature){ ?>
    <div class="title-square">Silahkan pilih market survey yang ingin anda verifikasi pada tabel di bawah ini</div>
    <?php
}else{ ?>
    ...
    <div class="row mt-3">
        ...
        <div class="col-md-5">
            <input type="text" class="form-control" value="<?= $get_data->row()->survey_from ?>" readonly>
        </div>
    </div>
    ...
    <!-- <div class="row mt-3">
        ...
        <div class="col-md-5">
            <input type="text" class="form-control" value="<?= $get_data->row()->pic_toko ?>" readonly>
        </div>
    </div>
    ...
    <div class="row mt-3">
        ...
        <div class="col-md-5">
            <input type="text" class="form-control" value="<?= $get_data->row()->area ?>" readonly>
        </div>
    </div> -->
    ...
    <div class="row mt-3">
        ...
        <div class="col-md-5">
            <textarea type="text" class="form-control" rows="4" readonly><?= $get_data->row()->keterangan ?></textarea>
        </div>
    </div>
    ...
    <!-- <div class="row mt-4">
        ...
        <div class="col-md-5">
            <?php 
            if ($get_data->row()->attach_2) { ?>
            <a href="<?= base_url() ?>assets/uploads/kpi/<?= $get_data->row()->attach_2 ?>" class="btn btn-submit-black" target="_blank">
                <?= $get_data->row()->attach_2 ?>
            </a>
            <?php
            }
        ?>
    ...
    <div class="row mt-4 mb-5">
        ...
        <div class="col-md-5">
            <?php 
            if ($get_data->row()->attach_3) { ?>
            <a href="<?= base_url() ?>assets/uploads/kpi/<?= $get_data->row()->attach_3 ?>" class="btn btn-submit-black" target="_blank">
                <?= $get_data->row()->attach_3 ?>
            </a>
            <?php
            }
        ?>
    ...
    <div class="row mt-5">
        <div class="col-md-12 az-content-label">
            Proses Verifikasi Market Survey
        </div>
    </div>
