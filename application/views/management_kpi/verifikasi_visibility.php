...
<div class="container-fluid">
    ...
    <?php if(!$signature){ ?>
    <div class="title-square">Silahkan pilih Visibility/Branding OB DP yang ingin anda verifikasi pada tabel di bawah ini</div>
    <?php
}else{ ?>
    ...
    <div class="row mt-1">
        <div class="col-md-12 az-content-label">
            Verifikasi Visibility/Branding OB DP
        </div>
    </div>
    ...
    <div class="row mt-3">
        ...
        <div class="col-md-5">
            <textarea type="text" class="form-control" rows="4" readonly><?= $get_data->row()->branding ?></textarea>
        </div>
    </div>
    ...
    <div class="row mt-5">
        <div class="col-md-12 az-content-label">
            Proses Verifikasi Visibility/Branding OB DP
        </div>
    </div>
