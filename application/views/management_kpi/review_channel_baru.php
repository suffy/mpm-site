...
<div class="row">
    ...
    <div class="row mt-4">
        <div class="col-md-2">
            ...
            <input type="hidden" name='signature_channel_baru' value = <?= $signature_channel_baru ?>>
            <input type="hidden" name='id_channel_baru' value = <?= $id_channel_baru ?>>
        </div>
        <div class="col-md-5">
                ...
                <tbody>     
                    ...
                    <tr>
                        ...
                        <td class="td-review text-center">
                            <a href="<?= base_url('kpi/delete_review_channel_baru/'.$a->signature.'/'.$signature_workspace.'/'.$signature_channel_baru) ?>" class="btn btn-delete" onclick="return confirm('Are you sure?')"><i class="fa-solid fa-trash-can" style="color: white"></i> del</a> 
                        </td>                     
                    </tr>
                    <?php endforeach; ?> 
                </tbody>
