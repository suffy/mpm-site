...
<a href="index.html">
<!-- <img class="img-fluid" src="<?php echo base_url() ?>assets_new/web/png/logo.png" alt="Theme-Logo" /> -->
</a>
...
<img class="media-object img-radius img-radius" src="<?php echo base_url() ?>assets_new/web/jpg/avatar-3.jpg" alt="Generic placeholder image ">
...
<a class="media-left" href="#!">
<img class="media-object img-radius" src="<?php echo base_url() ?>assets_new/web/jpg/avatar-2.jpg" alt="Generic placeholder image">
<div class="live-status bg-success"></div>
</a>
<div class="media-body">
...
<i class="feather icon-x"></i> NoName
</a>
</div>
