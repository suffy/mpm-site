...
<!-- Modal -->
<div class="modal fade" id="barang_masuk" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <?php echo form_submit('submit', 'Tampilkan Data', 'class="btn btn-primary" required'); ?>
                <?php echo form_close(); ?>
            </div>
        </div>
    </div>
