    ...
    <div class="col-sm-10">
        <div class="form-group row">            
            <div class="col-sm-10">
                ...
                kembali</a>
                <a href="<?php echo base_url()."status/export_upload_stock_bangka/$kode"; ?>"class="btn btn-primary" role="button">
                <span class="glyphicon glyphicon-print" aria-hidden="true"></span> Export (.csv)</a> 
                <a href="<?php echo base_url()."status/stock_rilis_bangka/$kode/$tahun/$bulan"; ?>"class="btn btn-warning" role="button">
