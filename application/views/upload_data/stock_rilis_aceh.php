    ...
    <div class="col-sm-10">
        <div class="form-group row">            
            <div class="col-sm-10">
                ...
                kembali</a>
                <a href="<?php echo base_url()."status/export_stock_aceh/$kode/$tahun/$bulan"; ?>"class="btn btn-primary" role="button">
                <span class="glyphicon glyphicon-print" aria-hidden="true"></span> Export (.csv)</a>             </div>
