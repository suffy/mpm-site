...
<div class="card">
    ...
    <div class="col-sm-12">
        <div class="form-group row">
            <label class="col-sm-2 col-form-label">Upload CV (.xls)</label>
            <div class="col-sm-9">
                <div class="col-sm-6">
    ...
    <div class="col-sm-12">
        <div class="form-group row">
            <label class="col-sm-2 col-form-label">Upload UD (.xls)</label>
            <div class="col-sm-9">
                <div class="col-sm-6">
                    <input type="file" name="file_ud" class="form-control" required>
                </div>
            </div>
        </div>
    </div>
