        ...
        <div class="form-group row">
            <div class="col-sm-10">
                <a href="<?php echo base_url() . "status/upload_stock/"; ?>" class="btn btn-dark" role="button">
                    kembali</a>
                <a href="<?php echo base_url() . "status/export_mapping_stock_palembang/$kode"; ?>" class="btn btn-primary" role="button">
                    <span class="glyphicon glyphicon-print" aria-hidden="true"></span> Export (.csv)</a>
                <a href="<?php echo base_url() . "status/stock_rilis_palembang/$kode/$tahun/$bulan"; ?>" class="btn btn-warning" role="button">
            ...
            <tbody>
                ...
                <?php foreach ($mapping_stock as $a) : ?>
                    <tr>
                        ...
                        <td>
                            <font size="2px"><?php echo $a->isisatuan; ?>
                        </td>
                        <td>
                            <font size="2px"><?php echo $a->so_awal_mpm; ?>
                        </td>
                        <td>
                            <font size="2px"><?php echo $a->masuk_mpm; ?>
                        </td>
                        <td>
                            <font size="2px"><?php echo $a->keluar_mpm; ?>
                        </td>
                        <td>
                            <font size="2px"><?php echo $a->so_akhir_mpm; ?>
                        </td>
                        <td>
