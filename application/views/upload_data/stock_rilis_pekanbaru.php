...
<div class="card-block">
    ...
    <div class="col-sm-10">
        <div class="form-group row">
            <div class="col-sm-10">
                <a href="<?php echo base_url() . "status/upload_stock_pekanbaru/"; ?>" class="btn btn-dark" role="button">
                    kembali</a>
                <a href="<?php echo base_url() . "status/export_stock_pekanbaru/$kode/$tahun/$bulan"; ?>" class="btn btn-primary" role="button">
