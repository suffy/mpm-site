...
<div class="card-block">
    ...
    <div class="col-sm-10">
        <div class="form-group row">
            <div class="col-sm-10">
                <a href="<?php echo base_url() . "status/upload_stock_palembang/"; ?>" class="btn btn-dark" role="button">
                    kembali</a>
                <a href="<?php echo base_url() . "status/export_stock_palembang/$kode/$tahun/$bulan"; ?>" class="btn btn-primary" role="button">
            ...
            <tbody>
                ...
                <?php foreach ($mapping_stock as $a) : ?>
                    <tr>
                        ...
                        <td>
                            <font size="2px"><?php echo $a->SALDOAWAL; ?>
                        </td>
                        <td>
                            <font size="2px"><?php echo $a->MASUK_PBK; ?>
                        </td>
                        <td>
                            <font size="2px"><?php echo $a->SALES; ?>
                        </td>
                        <td>
                            <font size="2px"><?php echo ($a->SALDOAWAL + $a->MASUK_PBK - $a->SALES); ?>
                        </td>
                        <td>
                            <font size="2px"><?php echo $a->BULAN; ?>
                        </td>
                        <td>
                            <font size="2px"><?php echo $a->NOCAB; ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
