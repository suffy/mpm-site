    ...
    <div class="row">        
        <div class="col-xs-16">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="nodo" value ="<?php echo $principle->nodo ?>" readonly>
                </div>
            </div>
            <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label">Tanggal Pengiriman</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="tgldo" value ="<?php echo $principle->tgldo ?>" readonly>
            ...
            <h4>
            <p>Silahkan Isi Tanggal Penerimaan Barang di bawah ini (<b><i>hanya dapat diisi oleh DP</i></b>)</p>
            
            </h4><br>
            <?php echo form_open('all_report/proses_branch/' . $single->id_ref, "class='form-horizontal'") ?>
            <font color ="red">
            <div>
            ...
            <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label">Tanggal Terima Barang</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="datepicker" name="tglterima" placeholder="Masukkan Tanggal Terima Barang">
