...
<html>
    ...
    <div class="row">        
        ...
        <div class="col-xs-5">
            ...
            <a href="<?php echo base_url()."omzet/export_cut_off/1"; ?>   " class="btn btn-warning" role="button"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> export hasil proses ke dalam excel</a>
