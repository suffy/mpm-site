            ...
            <table id="myTable" class="table table-striped table-bordered table-hover"> 
                    ...
                    <tbody>
                        ...
                        <tr>        
                            ...
                            <td><center><font size="2px"><?php echo number_format($omzet->b1_ot); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b2_ot); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b3_ot); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b4_ot); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b5_ot); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b6_ot); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b7_ot); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b8_ot); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b9_ot); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b10_ot); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b11_ot); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b12_ot); ?></font></center></td>
                            
                            <td><center><font size="2px"><?php echo number_format($omzet->total_ot); ?></font></center></td>
                           <td><center><font size="2px"><?php echo number_format($omzet->rata_ot); ?></font></center></td>
