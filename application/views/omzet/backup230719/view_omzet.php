    ...
    <div class="row">        
        ...
        <div class="col-xs-6">
            ...
            <?php echo form_close();?>
             ...
             <a href="<?php echo base_url()."omzet/export_omzet/". $tahun."/".$supp."/".$note."/"; ?>  " class="btn btn-warning" role="button"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> export hasil proses ke dalam excel</a>
        </div>
    </div>
