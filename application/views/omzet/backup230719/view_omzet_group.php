...
<a href="<?php echo base_url()."omzet/export_omzet_group/". $tahun."/".$supp."/".$note_x; ?>  " class="btn btn-warning" role="button"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> export hasil proses ke dalam excel</a>
        </div>
            ...
            <table id="myTable" class="table table-striped table-bordered table-hover"> 
                    <thead>
                        <tr>                
                            ...
                            <th rowspan="2"><font size="2px"><center><br>Upload Terakhir</th>
                        </tr>
                    ...
                    <tbody>
                        ...
                        <tr>        
                            ...
                            <td><center><font size="2px"><?php echo substr($omzet->lastupload, 0,11); ?></font></center></td>
                        </tr>
                    <?php endforeach; ?>
