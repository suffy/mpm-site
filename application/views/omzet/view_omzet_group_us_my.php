            ...
            <table id="myTable" class="table table-striped table-bordered table-hover"> 
                    ...
                    <tbody>
                        ...
                        <tr>        
                            ...
                            <td><center><font size="2px"><?php echo number_format($omzet->b1_my); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b2_my); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b3_my); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b4_my); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b5_my); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b6_my); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b7_my); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b8_my); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b9_my); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b10_my); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b11_my); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b12_my); ?></font></center></td>
                            
                            <td><center><font size="2px"><?php echo number_format($omzet->total_my); ?></font></center></td>
                           <td><center><font size="2px"><?php echo number_format($omzet->rata_my); ?></font></center></td>
