            ...
            <table id="myTable" class="table table-striped table-bordered table-hover"> 
                    ...
                    <tbody>
                        ...
                        <tr>        
                            ...
                            <td><center><font size="2px"><?php echo number_format($omzet->b1_tr); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b2_tr); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b3_tr); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b4_tr); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b5_tr); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b6_tr); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b7_tr); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b8_tr); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b9_tr); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b10_tr); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b11_tr); ?></font></center></td>
                            <td><center><font size="2px"><?php echo number_format($omzet->b12_tr); ?></font></center></td>
                            
                            <td><center><font size="2px"><?php echo number_format($omzet->total_tr); ?></font></center></td>
                           <td><center><font size="2px"><?php echo number_format($omzet->rata_tr); ?></font></center></td>
