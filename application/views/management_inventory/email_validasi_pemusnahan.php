  ...
  <body>
    ...
    <table border="0">
        ...
        <tr>
            ...
            <td width="50%">: <a href="<?= base_url().'assets/file/retur/'.$file_pemusnahan; ?>"><?= $file_pemusnahan; ?></a> </td>
        </tr>
        <tr>
            <td width="20%"> - Foto Pemusnahan 1</td>
            <td width="50%">: <a href="<?= base_url().'assets/file/retur/'.$foto_pemusnahan_1; ?>"><?= $foto_pemusnahan_1; ?></a> </td>
        </tr>
        <tr>
            <td width="20%"> - Foto Pemusnahan 2</td>
            <td width="50%">: <a href="<?= base_url().'assets/file/retur/'.$foto_pemusnahan_2; ?>"><?= $foto_pemusnahan_2; ?></a></td>
        </tr>
        <tr>
        ...
        <tr>
            <td width="20%"> - Tanggal Validasi Pemusnahan</td>
            <td width="50%">: <?= $validasi_pemusnahan_at; ?></td>
        </tr>
        <tr>
            <td width="20%"> - PIC Validasi Pemusnahan</td>
            <td width="50%">: <?= $nama_pemusnahan; ?></td>
        </tr>
    </table>
    <br>
    ...
    <table border = 1>
        <tr>
            ...
            <th width="10%">ED</th>
            <th width="10%">QtyApproval Area</th>
            <th width="10%">QtyApproval HO</th>
            <th width="10%">Qty Pemusnahan</th>
        ...
        <tr>
            ...
            <td><?= $a->qty_approval_ho ?></td>
            <td><?= $a->qty_pemusnahan ?></td>
            <td><?= $a->satuan ?></td>
            <td><?= $a->nama_outlet ?></td>
            <td><?= $a->keterangan ?></td>
        </tr>
