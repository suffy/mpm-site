...
<div class="container-fluid">
                    ...
                    if ($get_pengajuan->row()->tipe != "retur_administrasi" && $get_pengajuan->row()->tipe != "retur_khusus") {
                        if ($get_pengajuan->row()->file) {
                            if ($get_pengajuan->row('is_file_folder_retur') == 1) { ?>
                                <a href="<?= base_url() . 'assets/file/retur/email_capture/' . $get_pengajuan->row()->file ?>" target="_blank" class="btn btn-submit-black">
                                    <label readonly><?= $get_pengajuan->row()->file ?></label></a>
                            <?php } else { ?>
                                <a href="<?= base_url() . 'assets/file/retur/' . $get_pengajuan->row()->file ?>" target="_blank" class="btn btn-submit-black">
                                    <label readonly><?= $get_pengajuan->row()->file ?></label></a>
                            <?php } ?>
                        <?php
                        } else { ?>
                        ...
                        if ($get_pengajuan->row()->file) { ?>
                            <a href="<?= base_url() . 'assets/file/retur/email_capture/' . $get_pengajuan->row()->file ?>" target="_blank" class="btn btn-submit-black"><label readonly><?= $get_pengajuan->row()->file ?></label></a><br>
                            <a href="<?= base_url() . 'assets/file/retur/tanda_terima/' . $get_pengajuan->row()->file_2 ?>" target="_blank" class="btn btn-submit-black"><label readonly><?= $get_pengajuan->row()->file_2 ?></label></a><br>
                            <a href="<?= base_url() . 'assets/file/retur/foto/' . $get_pengajuan->row()->file_3 ?>" target="_blank" class="btn btn-submit-black"><label readonly><?= $get_pengajuan->row()->file_3 ?></label></a>
                        <?php
                        } else { ?>
                            <label class="form-control"><i>user tidak melampirkan file</i></label>
                    <?php
    ...
    <div class="row mt-4">
        <div class="col-md-6">
            <div class="form-group row">
                <label for="nomor_ajuan" class="col-lg-4 col-form-label"><strong>Keterangan Override</strong></label>
                <div class="col-lg-8">
                    <textarea class="form-control" name="keterangan_overide" id="keterangan_overide" cols="3" placeholder="Isi keterangan"><?= $keterangan_lain; ?></textarea>
                </div>
            </div>
        </div>
    </div>
