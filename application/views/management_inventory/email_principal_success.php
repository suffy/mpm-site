...
<html lang="en">
  ...
  <body>
    ...
    <table border="0">
        ...
        <tr>
            <td width="20%"> - File Principal HO</td>
            <td width="50%">: <?= $file_principal_ho; ?></td>
        </tr>
        <!-- <tr>
    ...
    <table border = 1>
        <tr>
            ...
            <th width="10%">Ket</th>
            <th width="10%">Qty Approval Area</th>
            <th width="10%">Ket Principal Area</th>
            <th width="10%">Qty Approval HO</th>
        ...
        <tr>
            ...
            <td><?= $a->keterangan_principal_ho ?></td>
            <td><?= $a->nama_status ?></td>
            <td><?= $a->deskripsi ?></td>
        </tr>
        <?php endforeach; ?>
