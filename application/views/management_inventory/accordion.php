                                    ...
                                    if ($get_pengajuan->row()->tipe != "retur_administrasi" && $get_pengajuan->row()->tipe != "retur_khusus") { ?>
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            if ($get_pengajuan->row()->file) { ?>
                                                ...
                                                <a href="<?= base_url().'management_inventory/is_file_exist/' . $get_pengajuan->row()->file.'/'.$get_pengajuan->row('is_file_folder_retur') ?>" target="_blank"><?= $get_pengajuan->row()->file ?></a> 
