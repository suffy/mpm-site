    ...
    <div class="col-sm-10">
        <div class="form-group row">            
            <div class="col-sm-10">
                ...
                kembali</a>
                <!-- <a href="<?php echo base_url()."stok/export_stok_product/$tahun/$created_date->created_date"; ?>"class="btn btn-warning" role="button"> -->
                <a href="<?php echo base_url()."stok/export_stok_product/"; ?>"class="btn btn-warning" role="button">
