...
<script type="text/javascript">
    ...
    function drawChart() {
      // Define the chart to be drawn.
        ...
        data.addRows([
        [{v:1, f:'b1'}, <?php echo $omzet->omzet_a; ?>],
        [{v:2, f:'b2'}, <?php echo $omzet->omzet_b; ?>],
        [{v:3, f:'b3'}, <?php echo $omzet->omzet_c; ?>],
        [{v:4, f:'b4'}, <?php echo $omzet->omzet_d; ?>],
        [{v:5, f:'b5'}, <?php echo $omzet->omzet_e; ?>],
        [{v:6, f:'b6'}, <?php echo $omzet->omzet_f; ?>],
        [{v:7, f:'b7'}, <?php echo $omzet->omzet_g; ?>],
        [{v:8, f:'b8'}, <?php echo $omzet->omzet_h; ?>],
        [{v:9, f:'b9'}, <?php echo $omzet->omzet_i; ?>],
        // [{v:10, f:'b10'}, <?php echo $omzet->omzet_j; ?>],
        // [{v:11, f:'b11'}, <?php echo $omzet->omzet_k; ?>],
        // [{v:12, f:'b12'}, <?php echo $omzet->omzet_l; ?>]
                    ...
                    <div class="latest-update-box">
                        <div class="row p-t-20 p-b-30">
                            <div class="col-auto text-right update-meta p-r-0">
                                <img src="<?php echo base_url() ?>assets_new/web/jpg/avatar-4.jpg" alt="user image" class="img-radius img-40 align-top m-r-15 update-icon">
                            </div>
                            <div class="col p-l-5">
