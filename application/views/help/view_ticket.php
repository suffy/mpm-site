            ...
            <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">    
                <thead>
                    <tr>                
                        ...
                        <th><font size="2px">Description</th>
                        <th><font size="2px">status</th>
                        <th><font size="2px">created date</th>
                        <th><font size="2px">detail po</th>
                    </tr>
                </thead>
                <tbody>
                <?php foreach($asset as $a) : ?>
                    <tr>                      
                        ...
                        <td><font size="2px"><?php echo $a->deskripsi; ?></td>
                        <td><font size="2px">
                        <?php  
                            if ($a->status_ticket == 1) {
                                echo "open";
                            }elseif ($a->status_ticket == 2) {
                                echo "checking";
                            }else{
                                echo "done";
                            }    
                        ...
                        <td><center>
                            <?php
                                echo anchor('help/detail_ticket/' . $a->id, 'detail',"class='btn btn-primary btn-sm'");
                            ?>
