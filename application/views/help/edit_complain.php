...
<html>
    ...
    <?php echo form_open_multipart('all_help/proses_update_complain/' . $this->uri->segment(3)); ?>
    ...
    <div class="row">
        ...
        <div class="col-xs-2">Gambar / File Pendukung (*) (File yang mendukung .doc / .docx)</div>
        ...
        <div class="col-xs-2">Keterangan Tambahan (*) <br>(hanya internal IT)</div>
        <div class="col-xs-5">
            <textarea rows='7' name="note_tambahan" class = 'form-control'><?php echo $help->note_tambahan; ?></textarea>
        </div>
        <div class="col-xs-11">&nbsp;</div>
