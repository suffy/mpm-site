            ...
            <table id="myTable" class="table table-striped table-bordered table-hover">     
                    ...
                    <tbody>
                        ...
                        <tr>        
                            ...
                            <td width="5%"><?php echo $help->nama_pelapor; ?></td>
                            <td width="10%"><?php echo $help->nama_kategori; ?></td>
                            <td><?php echo $help->masalah; ?></td>
                            <td>
                                 <?php  
                                 $images = [
                            ...
                            <td><center>
                                <?php
                                    echo anchor('all_help/detail_complain_user/' . $help->id, 'view',"class='btn btn-primary btn-sm'");
                                ?>
                                </center>
                            </td>                                                        
                        </tr>
