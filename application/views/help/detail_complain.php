...
<html>
    ...
    <div class="row">
        ...
        <div class="col-xs-5">
            <input type="text" class = 'form-control' name="user" value="<?php echo $help->id_tiket; ?>" readonly>
        </div>
        <div class="col-xs-11">&nbsp;</div>

        <div class="col-xs-2">Nama User / Pelapor</div>
        <div class="col-xs-5">
            <input type="text" class = 'form-control' name="user" value="<?php echo $help->nama_pelapor . " - " . $help->username; ?>" readonly>
        </div>
        <div class="col-xs-11">&nbsp;</div>
    ...
    <div class="row">
        ...
        <div class="col-xs-5">
            <input type="text" class = 'form-control' name="tgl_selesai" value="<?php echo $help->tgl_selesai; ?>" readonly>
        </div>
        <div class="col-xs-11">&nbsp;</div>
        <div class="col-xs-2">Gambar / File Pendukung :</div>
        <div class="col-xs-5">
            <?php  
                ...
                $images_it = [
                                'src'   => 'uploads/' . $help->file_it,
                                'width' => '100'
                        ];

                if ($help->file_it == "" || $help->file_it == NULL || $help->file_it == "tidak ada") {
                    echo "<i>tidak ada attachment</i>";
                } else {
                    echo img($images_it)."<br>";
                    //echo "<a href=base_url() target=_blank>download </a>";
                    echo anchor(base_url() . "uploads/it/" . $help->file_it, 'download');
                }

            ?>
        </div>
        <div class="col-xs-11">&nbsp;</div>
        <div class="col-xs-2">Note Tambahan * <br>(hanya internal IT)</div>
        <div class="col-xs-5">
            <textarea rows='7' name="note_tambahan" class = 'form-control' readonly><?php echo $help->note_tambahan; ?></textarea>
        </div>
        <div class="col-xs-11">&nbsp;</div>
