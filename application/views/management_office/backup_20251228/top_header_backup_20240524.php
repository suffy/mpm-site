        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <nav class="az-menu-sub">
              ...
              <a href="<?= base_url() . 'management_claim/registrasi_program_mti' ?>" class="nav-link">Registrasi Program MPI</a>
              <a href="<?= base_url() . 'management_claim/ajuan_claim' ?>" class="nav-link">Pengajuan Claim</a>
              <a href="<?= base_url() . 'management_claim/ajuan_claim_mti' ?>" class="nav-link">Pengajuan Claim MPI</a>
            ...
            <li class="nav-item">
              ...
              <nav class="az-menu-sub">
                ...
                <a href="<?= base_url() ?>trans/retur" class="nav-link" target="_blank">Retur Versi 1
                  <i>(Accounting)</i></a>
                <a href="<?= base_url() ?>management_retur/report_progress_nota_retur" class="nav-link" target="_blank">Report Progress Nota Retur <i>(Accounting)</i></a>
              </nav>
            </li>
          <?php } ?>
