            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li>
                  ...
                  <?php if ($this->session->userdata('username') == 'nanda_deltomed' || $this->session->userdata('username') == 'frengky' || $this->session->userdata('username') == 'denny' || $this->session->userdata('username') == 'risa_deltomed') { ?>
                  <a href="<?= base_url() ?>management_sales/sell_out_product" class="dropdown-item d-flex align-items-center" target="_blank">Sell out Product </a>
