          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <nav class="az-menu-sub">
                ...
                <a href="<?= base_url().'management_claim/registrasi_program_mti' ?>" class="nav-link">Registrasi Program MTI</a>
                <a href="<?= base_url().'management_claim/ajuan_claim' ?>" class="nav-link">Pengajuan Claim</a>
                <a href="<?= base_url().'management_claim/ajuan_claim_mti' ?>" class="nav-link">Pengajuan Claim MTI</a>
