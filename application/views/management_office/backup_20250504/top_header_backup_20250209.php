  ...
  <div class="az-header">
    <div class="container-fluid">
      <div class="az-header-left">
        <a href="<?= base_url() ?>management_office" class="az-logo"><span></span>
        ...
        <ul class="nav">
            ...
            <nav class="az-menu-sub">
               <?php 
                if ($this->session->userdata('username') == 'suffy' || $this->session->userdata('username') == 'septian') { ?>
                  ...
                  <a href="<?= base_url() ?>target_outlet/dashboard_loyalty" class="nav-link" target="_blank">Dashboard RM Kal-Sul</a>
                <?php
                }
               ?>
          ...
          <li class="nav-item">
            ...
            <nav class="az-menu-sub">
              ...
              <a href="<?= base_url() . 'management_inventory/master_data' ?>" class="nav-link">Retur Master Data</a>
              ...
              <a href="<?= base_url() . 'management_inventory/pengajuan_retur' ?>" class="nav-link" target="_blank">Retur Khusus</a>
              <?php
              }
              ?>
              <a href="#" class="nav-link">Dashboard Tracking Bonus (*)</a>
              <a href="<?= base_url() . 'spk/dashboard' ?>" class="nav-link">PO Dashboard</a>
              <?php
          ...
          <li class="nav-item">
            ...
            <nav class="az-menu-sub">
              ...
              <a href="<?= base_url() ?>management_sales/sell_out_product" class="nav-link">Sell out Product </a>
              ...
              <a href="<?= base_url() ?>penta/log_sales" class="nav-link">Penta & MPI</a>
            </nav>
          </li>
          ...
          <li class="nav-item">
            ...
            <nav class="az-menu-sub">
              <a href="<?= base_url() . 'management_claim/buletin_program' ?>" class="nav-link">Buletin Program</a>
              ...
              <a href="<?= base_url() . 'management_claim/master_data' ?>" class="nav-link">Master Data</a>
              <a href="<?= base_url() . 'management_claim/monitoring' ?>" class="nav-link">Monitoring</a>
            </nav>
          </li>

          <?php
          if ($this->session->userdata('username') == 'suffy' || $this->session->userdata('username') == 'erick' || $this->session->userdata('username') == 'sara' || $this->session->userdata('username') == 'tria' || $this->session->userdata('username') == 'ilham' || $this->session->userdata('username') == 'rani') { ?>
            <li class="nav-item">
              <a href="" class="nav-link with-sub"><i class="typcn typcn-document-text"></i> Retur Monitoring</a>
              <nav class="az-menu-sub">
                <a href="<?= base_url() ?>management_retur/dashboard" class="nav-link" target="_blank">Dashboard Nota
                  Retur <i>(Accounting)</i></a>
                <a href="<?= base_url() ?>management_retur/master_dbsls" class="nav-link" target="_blank">Master DBSLS
                  <i>(Accounting)</i></a>
                <a href="<?= base_url() ?>management_retur/ajuan_retur" class="nav-link" target="_blank">Ajuan Retur
                  <i>(Accounting)</i></a>
                <a href="#" class="nav-link" target="_blank">Ajuan Relokasi <i>(Accounting)</i></a>
                <a href="<?= base_url() ?>management_retur/nota_retur" class="nav-link" target="_blank">History Nota Retur
                  <i>(Accounting)</i></a>
                <a href="<?= base_url() ?>trans/retur" class="nav-link" target="_blank">Retur Versi 1
                  <i>(Accounting)</i></a>
                <a href="<?= base_url() ?>management_retur/data_retur" class="nav-link" target="_blank">Pengajuan Retur Vs
          ...
          <li class="nav-item">
            ...
            <nav class="az-menu-sub">
              <a href="<?= base_url() ?>absensi" class="nav-link">Absensi & Ruang Meeting</a>
              <a href="<?= base_url() ?>barcode" class="nav-link">Request Barcode</a>
              <a href="<?= base_url() ?>management_rpd/pengajuan" class="nav-link">Rencana Perjalanan Dinas</a>
              <a href="<?= base_url() ?>kpi" class="nav-link">KPI S&P</a>
          ...
          <li class="nav-item">
            ...
            <nav class="az-menu-sub">
              ...
              <?php
              if ($this->session->userdata('username') == 'nanita' || $this->session->userdata('username') == 'suffy' || $this->session->userdata('username') == 'tria') { ?>
                <a href="<?= base_url() ?>all_transaction/open_credit_limit" class="nav-link" target="_blank">Open Credit Limit <i>(Finance)</i></a>
              <?php
              }
              ?>
              <?php
              if ($this->session->userdata('username') == 'milla' || $this->session->userdata('username') == 'melinda' || $this->session->userdata('username') == 'tria' || $this->session->userdata('username') == 'fakhrul' || $this->session->userdata('username') == 'aletheia') { ?>
              ...
              if ($this->session->userdata('username') == 'suffy') { ?>
                <a href="<?= base_url() ?>management_claim/buletin_program" class="nav-link" target="_blank">Claim Dashboard <i>(Admin)</i></a>
              ...
              ?>
              <?php
              if ($this->session->userdata('username') == 'sampurno' || $this->session->userdata('username') == 'zul' || $this->session->userdata('username') == 'suffy') { ?>
