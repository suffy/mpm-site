          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <a href="<?= base_url().'management_claim/buletin_program' ?>" class="nav-link">Buletin Program</a> 
                ...
                <a href="#" class="nav-link">Registrasi Program MTI</a>
                <a href="<?= base_url().'management_claim/ajuan_claim' ?>" class="nav-link">Pengajuan Claim</a>
                <a href="#" class="nav-link">Pengajuan Claim MTI</a>
            ...
            <li class="nav-item">
              ...
              <nav class="az-menu-sub">
                ...
                ?>
                <?php 
                  if ($this->session->userdata('username') == 'suffy' || $this->session->userdata('username') == 'erick' || $this->session->userdata('username') == 'gabriela' || $this->session->userdata('username') == 'sara' || $this->session->userdata('username') == 'tria' || $this->session->userdata('username') == 'ilham' || $this->session->userdata('username') == 'rani') { ?>
                    ...
                    <a href="<?= base_url() ?>management_retur/data_retur" class="nav-link" target="_blank">Pengajuan Retur Vs Nota Retur <i>(Accounting)</i></a>
                  <?php
                  }
                ?>
                <?php 
                ...
                <!-- AM Pak isa -->
                <?php 
                  if ($this->session->userdata('username') == 'suyanto' || $this->session->userdata('username') == 'aris' || $this->session->userdata('username') == 'ari' || $this->session->userdata('username') == 'rudi') { ?>
                    <a href="<?= base_url() ?>management_raw" class="nav-link" target="_blank">Management Raw Area <i>(RM)</i></a>
                  <?php
                  }
                ?>
