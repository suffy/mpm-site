...
<body>
   ...
   <nav class="navbar navbar-expand-lg bg-body-tertiary">
      <div class="container">
        <a class="navbar-brand" href="<?= base_url() ?>management_office"><img class="img-fluid" src="<?= base_url() ?>assets/css/images/semutgajah.png" alt="semutgajah" width="70" /></a>
        <button
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li>
                  ...
                  <a href="<?= base_url() ?>biaya_operasional/history" class="dropdown-item d-flex align-items-center" target="_blank">Klaim BIOP</a>
