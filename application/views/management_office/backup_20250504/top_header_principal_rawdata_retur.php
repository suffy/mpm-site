        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mb-2 mb-lg-0 d-flex gap-3 me-auto justify-center">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li>
                  <?php if ($this->session->userdata('username') == 'jimmy' || $this->session->userdata('username') == 'vischa' || $this->session->userdata('username') == 'kevin_delto'){ ?>
                  <a href="<?= base_url() ?>penta/log_sales" class="dropdown-item d-flex align-items-center">Penta & MPI</a>
                  <?php 
                  } else { ?>
                    <?php 
                      if ($this->session->userdata('username') == 'lina' || $this->session->userdata('username') == 'deny' || $this->session->userdata('username') == 'yosi' || $this->session->userdata('username') == 'herwin') {
                    ?>
