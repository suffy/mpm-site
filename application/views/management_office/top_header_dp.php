<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mb-2 mb-lg-0 d-flex gap-4 me-auto justify-center">
        <li class="nav-item">
          <a href="<?= base_url() ?>management_office/dashboard" class="nav-link"><i class="bi bi-graph-up-arrow me-2"></i>Dashboard</a>
        </li>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li>
              ...
              <a href="<?= base_url() ?>spk" class="dropdown-item d-flex align-items-center">Surat Pesanan Khusus (SPK)</a>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li>
              ...
              <!-- <?php if ($this->session->userdata('username') == 'kandar' || $this->session->userdata('username') == 'eldiano' || $this->session->userdata('username') == 'nesa' || $this->session->userdata('username') == 'irfan') { ?>
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="bi bi-calendar-day me-2"></i>Aktivitas</a>            
          <ul class="dropdown-menu">
            <li>
              <a href="<?= base_url() ?>barcode" class="dropdown-item d-flex align-items-center">Request Barcode</a>
              <a href="<?= base_url() ?>management_upload" class="dropdown-item d-flex align-items-center" target="_blank">Upload Data</a>
              <a href="<?= base_url() ?>bridging" class="dropdown-item d-flex align-items-center">Upload Data Bridging</a>
              <a href="<?= base_url() ?>transaction/list_product" class="dropdown-item d-flex align-items-center" target="_blank">SPK</a>
              <a href="<?= base_url() ?>inventory/konfirmasi_po" class="dropdown-item d-flex align-items-center" target="_blank">Konfirmasi PO</a>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li>
              ...
              <a href="<?= base_url() ?>management_claim/master_outlet" class="dropdown-item d-flex align-items-center">Database Outlet</a>
            </li>                              
          </ul>
        </li>
