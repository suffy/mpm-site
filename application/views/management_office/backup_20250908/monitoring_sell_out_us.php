            ...
            <div class="accordion_sellout" id="accordionExample">
                <div class="card">
                    <div class="card-header" style="background-color: #fff;" id="headingKam">
                        <h5 class="mb-0">
                            <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#sell_out_us" aria-expanded="true" aria-controls="collapseOne"><font color="black">Monitoring Sell Out Us <i>click here</i></font>
                            </button>
                        </h5>
                    </div>

                    <div id="sell_out_us" class="collapse" aria-labelledby="headingKam" data-parent="#accordionExample" style="width:100%; overflow:hidden;">
                        <div class="card-body">
