              ...
              <ul class="dropdown-menu">
                <li>
                  ...
                  <?php 
                    ...
                    <?php 
                      if ($this->session->userdata('username') == 'lina' || $this->session->userdata('username') == 'deny' || $this->session->userdata('username') == 'yosi' || $this->session->userdata('username') == 'herwin' || $this->session->userdata('username') == 'yosep_mt') {
                    ?>
