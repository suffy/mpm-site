        ...
        <div class="az-content-body pd-lg-l-40 d-flex flex-column">
          ...
          <div class="row row-sm">
            <div class="col-sm-12">
                <div class="table-responsive">
                    ...
                    <tbody>
                        <?php 
                        $no = 1;
                        foreach ($get_data_mapping->result() as $a) : 
                        ?>
                        <tr>
                            <th scope="row"><?= $no++; ?></th>
                            <th scope="row"><?= $a->bulan; ?></th>
                            <th scope="row"><?= $a->site_code; ?></th>
                            <th scope="row"><?= $a->branch_name; ?></th>
                            <th scope="row"><?= $a->nama_comp; ?></th>
                            <th scope="row"><?= $a->kodeprod; ?></th>
                            <th scope="row"><?= $a->namaprod; ?></th>
            ...
            <div class="col-sm-12 mt-4">
                ...
                <?php echo form_submit('submit', 'Commit Mapping', 'class="btn btn-primary"'); ?>
                <?php echo form_close(); ?>
            </div>

            <div class="col-sm-12 mt-4">
                <a href="#" class="btn btn-outline-war">Export</a>
            </div>
