<div class="card">
    ...
    <div class="col-sm-5">
        <a href="<?php echo base_url()."report_sales/export_candy/"; ?>" class="btn btn-warning" role="button">export (.csv)</a>
            ...
            <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">
                ...
                <?php foreach ($get_data as $key) { ?>
                    <tr>
                        ...
                        <td><?php echo number_format($key->b1); ?></td>
                        <td><?php echo number_format($key->b2); ?></td>
                        <td><?php echo number_format($key->b3); ?></td>
