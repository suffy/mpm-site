...
<?php   
    ...
    {
        echo " ".$value->grup_lang." (".$tahun."-".$bulan.")";
    }
...
<div class='row'>
    <div class='col-xs-3'>    
        ...
        ?>
            <a href="<?php echo base_url()."all_surat_jalan/export_do/$grup_lang/$tahun/$bulan"; ?>  " class="btn btn-danger" role="button"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> export to pdf</a>
    </div>
