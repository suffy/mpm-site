<div class="col-sm-10">
    ...
    <a href="<?php echo base_url()."outlet_transaksi/otsc"; ?>"class="btn btn-dark" role="button">
                kembali</a>
    <a href="<?php echo base_url()."outlet_transaksi/otsc_export_harian"; ?>" class="btn btn-warning" role="button">export (.csv)</a>
           ...
           <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">    
            ...
            <?php foreach($proses as $x) : ?>
                <tr>                      
                    ...
                    <td><font size="2px"><?php echo $x->tahun; ?></td>
                    <td><font size="2px"><?php echo $x->bulan; ?></td>
                    <td><font size="2px"><?php echo $x->hrdok; ?></td>
