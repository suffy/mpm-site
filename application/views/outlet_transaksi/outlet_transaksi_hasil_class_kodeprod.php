<div class="col-sm-10">
    ...
    <a href="<?php echo base_url()."outlet_transaksi/outlet_transaksi_ytd"; ?>"class="btn btn-dark" role="button">
                kembali</a>
    <a href="<?php echo base_url()."outlet_transaksi/export_outlet_transaksi_ytd_kodesalur_kodeprod"; ?>" class="btn btn-warning" role="button">export (.csv)</a>
