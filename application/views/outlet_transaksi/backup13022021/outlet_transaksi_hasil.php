<div class="col-sm-10">
    ...
    Informasi !! : Halaman ini hanya menampilkan data Outlet Transaksi. Silahkan klik Export
    <br>
    <br>
    <a href="<?php echo base_url()."outlet_transaksi/outlet_transaksi_ytd"; ?>"class="btn btn-dark" role="button">
                kembali</a>
    <a href="<?php echo base_url()."outlet_transaksi/export_outlet_transaksi_ytd/4/"; ?>" class="btn btn-warning" role="button">export (.csv)</a>
    </div>
    <br>
