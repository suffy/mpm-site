...
<html>
    ...
    <div class="col-xs-7">  
        ...
        <?php echo form_close();?>
        <a href="<?php echo base_url()."omzet/export_omzet_mpi_groupby_kodeprod_temp"; ?>" class="btn btn-warning" role="button"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> export hasil proses ke dalam excel</a>
    </div>
    ...
    <div class="row"> 
        <div class="col-xs-12">
            ...
            <table id="myTable" class="table table-striped table-bordered table-hover">     
                    <thead>
                        <tr>                
                            <th width="1"><font size="2px">Nama Produk MPI</th>
