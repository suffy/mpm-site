    ...
    <div class="col-xs-7">  
        ...
        <?php echo form_close();?>
        <a href="<?php echo base_url()."omzet/export_omzet_mpi_temp"; ?>" class="btn btn-warning" role="button"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> export hasil proses ke dalam excel</a>
    </div>
