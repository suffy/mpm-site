                ...
                <div class="modal-body" id="form_realisasi">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="radio" id="btn_tidak_reimburse_realisasi" name="select_reimburse_realisasi">
    ...
    function editRealisasi(param) { 
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                var reimburse = response.get_realisasi.reimburse;

                if (reimburse == 1) {
                    document.getElementById("btn_ya_reimburse_realisasi").checked = true;
                    document.getElementById("btn_tidak_reimburse_realisasi").checked = false;
                    $("input#value_reimburse").val('1');
                } else {
