                    ...
                    <div class="col-12">
                        <ol>
                            <li>Pastikan selalu mengikuti template yang sudah di sepakati. 
                                <a href="<?= base_url().'bridging/download_template_mmm_palopo' ?>" class="download-link">
            ...
            <div class="instruction-box">
                <div class="row">
                    <div class="col-12">
                        <ol>
                            <li>Pastikan selalu mengikuti template yang sudah di sepakati. 
                                <a href="<?= base_url().'bridging/download_template_mmm_palopo_customer' ?>" class="download-link">
