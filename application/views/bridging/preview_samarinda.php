            ...
            <div class="card mb-4 border-0 bg-light">
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label for="sum_gross_amount" class="col-sm-5 col-form-label">Sum Gross Amount</label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" id="sum_gross_amount" name="sum_gross_amount" 
                                           value="<?= number_format($get_summary->row()->sumgrossamount, 0, ',', '.') ?>" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label for="invalid_kodeprod" class="col-sm-5 col-form-label fw-bold text-danger">
                                    <i class="fas fa-exclamation-triangle me-1"></i> Invalid Kodeproduk Principal
                                </label>
                                <div class="col-sm-7">
                        ...
                        <table id="tabel" class="table table-striped table-hover" style="width:100%">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="text-center">nomornota</th>
                                    <th class="text-center">kodeprodukprincipal</th>  
                                    <th class="text-center">namaproduk</th>
                                    <th class="text-center">packaging</th>
                                    <th class="text-center">kodecustomer</th>
                                    <th class="text-center">namacustomer</th>
                                    <th class="text-center">kodesalesman</th>
                                    <th class="text-center">namasalesman</th>
                                    <th class="text-center">qtysoldtotalpcs</th>
                                    <th class="text-center">grossamount</th>
                                </tr>
                            </thead>
                            <tbody>  
                                <?php 
