                    ...
                    <div class="col-12">
                        <ol>
                            <li>Pastikan selalu mengikuti template yang sudah di sepakati. 
                                <a href="../assets/uploads/bridging/template/download_template_sales_mms_parepare.xlsx" class="download-link">
            ...
            <div class="instruction-box">
                <div class="row">
                    <div class="col-12">
                        <ol>
                            <li>Pastikan selalu mengikuti template yang sudah di sepakati. 
                                <a href="<?= base_url().'bridging/download_template_mms_parepare_customer' ?>" class="download-link">
