    ...
    <div class="col-md-12">
        ...
        <div class="row mt-4">
            <div class="col-md-5">
                ...
                <a href="<?= base_url() ?>management_retur/truncate_nota_retur" class="btn btn-danger">Truncate Nota
                    Retur
                    (Delete All)</a>
            </div>
        </div>
                        ...
                        <thead>
                            <tr>
                                <th style="background-color: darkslategray;" class="text-center">
                                    <font color="white">customerid
                                </th>
                                <th style="background-color: darkslategray;" class="text-center">
                                    <font color="white">nama_customer
                                </th>
                                <th style="background-color: darkslategray;" class="text-center">
                                ...
                                <th style="background-color: darkslategray;" class="text-center">
                                    <font color="white">qty_nota_retur
                                </th>
                                <th style="background-color: darkslategray;" class="text-center">
                                ...
                                <th style="background-color: darkslategray;" class="text-center">
                                    <font color="white">disc_cabang
                                </th>
                                <th style="background-color: darkslategray;" class="text-center">
                                    <font color="white">disc_beli
                                </th>
                            </tr>
                        </thead>
                        <tbody>
