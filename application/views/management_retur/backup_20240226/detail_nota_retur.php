...
<div class="container">
    ...
    <div class="row mt-3">
        ...
        <div class="col-md-3">
            <input type="text" class="form-control" name="nodo_beli" value="<?= $get_retur_by_id->row()->nodo_beli ?>">
        </div>
    </div>
    ...
    <div class="row mt-3">
        ...
        <div class="col-md-3">
            <input type="date" class="form-control" name="tgl_beli" value="<?= $get_retur_by_id->row()->tgl_beli ?>">
                    ...
                    <table id="example" class="display" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $a->namaprod; ?></td>
                                <td><input type="text" size="10" value="<?= $a->banyak; ?>" name="banyak[]" class="edit">
                                    <p class="text"><?= $a->banyak; ?></p>
                                </td>
                                <td><input type="text" size="10" value="<?= $a->harga; ?>" name="harga[]"
                                        class="edit">
                                    <p class="text"><?= number_format($a->harga,2); ?></p>
                                </td>
                                <td><input type="text" size="10" value="<?= $a->diskon; ?>" name="diskon[]" class="edit">
                                    <p class="text"><?= $a->diskon; ?></p>
                                </td>
                                <td><input type="text" size="10" value="<?= $a->harga_beli; ?>"
                                        name="harga_beli[]" class="edit">
