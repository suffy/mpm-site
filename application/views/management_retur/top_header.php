        ...
        <div class="az-header-menu">
          ...
          <ul class="nav">
            <li class="nav-item <?= $this->uri->segment('2') == "dashboard" ? 'active show' : '' ?>">
              <a href="<?= base_url().'management_retur/dashboard' ?>" class="nav-link"><i class="typcn typcn-chart-area-outline"></i> Dashboard</a>
            </li>
            <li class="nav-item <?= $this->uri->segment('2') == "master_dbsls" ? 'active show' : '' ?>">
              <a href="<?= base_url().'management_retur/master_dbsls' ?>" class="nav-link">Master DBSLS</a>
            </li>
            <li class="nav-item <?= $this->uri->segment('2') == "ajuan_retur" && "product_ajuan" ? 'active show' : '' ?>">
              <a href="<?= base_url().'management_retur/ajuan_retur' ?>" class="nav-link">Ajuan Retur</a>
            </li>
            <li class="nav-item <?= $this->uri->segment('2') == "ajuan_relokasi" ? 'active show' : '' ?>">
              <a href="#" class="nav-link">Ajuan Relokasi</a>
            </li>
            <li class="nav-item <?= $this->uri->segment('2') == "nota_retur" ? 'active show' : '' ?>">
              <a href="<?= base_url().'management_retur/nota_retur' ?>" class="nav-link">Nota Retur</a>
            </li>
            <li class="nav-item">
              ...
              <nav class="az-menu-sub">
                ...
                <a href="<?= base_url() ?>trans/retur" class="nav-link" target="_blank">Retur V1</a>
                <a href="<?= base_url() ?>retur/generate" class="nav-link" target="_blank">Generate Retur</a>
                <a href="<?= base_url() ?>relokasi" class="nav-link" target="_blank">Relokasi</a>
                <a href="https://semutgajah.com/" class="nav-link" target="_blank">Semut Gajah</a>
              </nav>
            </li>
          </ul>
        </div>
