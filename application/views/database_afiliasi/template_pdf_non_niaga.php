...
<body>
    <div>
        <table class="table table-bordered">
            <thead align="center">
                <tr>
                    <th colspan="12">DATA NON NIAGA</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                ...
                <tr>
                    <td colspan="2">NAMA PEMAKAI</td>
                    <td colspan="10"><?= strtoupper($nama_pemakai);?></td>
                </tr>
                <tr>
                    <td colspan="2">JABATAN</td>
                    <td colspan="10"><?= strtoupper($jabatan);?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="10"><?= $tahun_pembuatan;?></td>
                </tr>
                <tr>
