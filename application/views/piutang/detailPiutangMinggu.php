...
<hr />
<a href="<?php echo base_url()."piutang/emailPiutangMinggu/". $key."/".$grup_lang."/".$tanggal."/"; ?>  " class="btn btn-primary" role="button"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> email</a>
