            ...
            <table id="myTable" class="table table-striped table-bordered table-hover">     
                <thead>
                    <tr>                
                        ...
                        <th><font size="2px">8-14</th>
                        <th><font size="2px">15-30</th>
                ...
                <tbody>
                    ...
                    <tr>        
                        ...
                        echo anchor('piutang/detailPiutangMinggu/1/'.$q->grup_lang.'/'.$q->tanggal, number_format($q->debit));
                        ?></td>
                        <td><font size="2px"><?php
                        echo anchor('piutang/detailPiutangMinggu/2/'.$q->grup_lang.'/'.$q->tanggal, number_format($q->kredit));
                        ?>
                        </td>
                        <td><font size="2px"><?php echo number_format( $q->saldoakhir); ?></td>
                        <td><font size="2px"><?php                             
                        echo anchor('piutang/detailPiutangMinggu/3/'.$q->grup_lang.'/'.$q->tanggal, number_format($q->current));
                        ?></td>
                        <td><font size="2px"><?php                             
                        echo anchor('piutang/detailPiutangMinggu/4/'.$q->grup_lang.'/'.$q->tanggal, number_format($q->duedate)); ?></td>
                        <td><font size="2px"><?php
                        echo anchor('piutang/detailPiutangMinggu/5/'.$q->grup_lang.'/'.$q->tanggal, number_format($q->r1)); 
                        ?></td>
                        <td><font size="2px"><?php  
                        echo anchor('piutang/detailPiutangMinggu/6/'.$q->grup_lang.'/'.$q->tanggal, number_format($q->r2));
                        ?></td>
                        <td><font size="2px"><?php 
                        echo anchor('piutang/detailPiutangMinggu/7/'.$q->grup_lang.'/'.$q->tanggal, number_format($q->r3));
                        ?></td>
                        <td><font size="2px"><?php
                        echo anchor('piutang/detailPiutangMinggu/8/'.$q->grup_lang.'/'.$q->tanggal, number_format($q->r4));
                        ?></td>
