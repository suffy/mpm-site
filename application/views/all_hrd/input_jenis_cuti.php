            ...
            <table id="myTable" class="table table-striped table-bordered table-hover">     
                    <thead>
                        <tr>                
                            ...
                            <th width="2"><font size="2px">Kode Cuti</th>
                            <th><font size="2px">Jenis Cuti</th>
                    ...
                    <tbody>
                        ...
                        <tr>        
                            ...
                            <td><font size="2px"><?php echo $div->kode_cuti; ?></td>
                            <td><font size="2px"><?php echo $div->jenis_cuti; ?></td>
                            <td>
                                <center>
                                <?php
