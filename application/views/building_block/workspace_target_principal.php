                ...
                <tbody>  
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="<?= base_url().'building_block/delete_workspace_target_principal/'.$a->signature ?>" onclick="return confirm('Anda yakin menghapus data ini ?')" class="btn btn-delete">del</a>
                            <a href="<?= base_url().'building_block/target_by_principal/'.$a->signature ?>" class="btn btn-generate">Manage</a>
                        </td>
                    </tr>
                    <?php
                    endforeach; 
