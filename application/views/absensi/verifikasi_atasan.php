                                        ...
                                        <div class="d-flex flex-row">
                                            <?php 
                                                ...
                                                { 
                                                    ...
                                                    {
                                                        // echo "total_hari_no_information : ".$total_hari_no_information; 
                                                        if ($total_tidak_lengkap_and_keterang_null == 0) {
                                                            // echo "flag_status: ".$flag_status;
                                                        ...
                                                        { 
                                                            echo '<button type="submit" class="btn btn-submit" disabled>Data Belum Lengkap</button>';
                                                        }
                                                    }elseif ($this->session->userdata('id') == 306){
                                                        if ($total_tidak_lengkap_and_keterang_null == 0) {
                                                            // echo "flag_status: ".$flag_status;
                                                            if ($flag_status == 1 || $flag_status == 0 ) 
                                                            { 
