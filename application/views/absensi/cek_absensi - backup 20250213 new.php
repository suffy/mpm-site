                    ...
                    <form action="<?= base_url($url_update); ?>" method="post">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left;">                                                    
                                                    ...
                                                    {                                                                                
                                                        ...
                                                        {
                                                            if (($a->flag_terlambat == 1 || $a->flag_status_absensi == 1) && $a->userid == $this->session->userdata('id')) 
                                                            { 
                        ...
                        <div class="row mb-5">
                            <div class="col-lg-12 d-flex justify-content-center gap-3">
                                ...
                                { 
                                    // echo "total_tidak_lengkap_and_keterangan_null : ".$total_tidak_lengkap_and_keterangan_null; 
                                    // echo "total_terlambat_and_keterangan_null : ".$total_terlambat_and_keterangan_null; 
                                ...
                                <!-- <label for="" class="btn btn-submit-black" style="border-radius: 20px; width: 200px; padding: 15px 10px 15px 10px" >Success Send Data</label> -->
