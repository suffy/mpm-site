                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form action="<?= base_url($url); ?>" method="post">
                                <input type="text" class="form-control form-control-md" id="userid_karyawan" name="userid_karyawan"
                                    value="<?= $userid ?>" hidden>
                            ...
                            <table id="tabel-data" class="display table-striped table-bordered"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th colspan="2">Kehadiran Harian</th>
                                        <th rowspan="2">Total Jam Kerja</th>
                                        <th rowspan="2">Status Kehadiran</th>
                                        </th>
                                        <th rowspan="2">Keterangan Terlambat</th>
                                    </tr>
                                    <tr>
                                        <th>Masuk</th>
                                        <th>Keluar</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($a->flag_terlambat == 1) { ?>
                                            <label class="btn btn-submit status pending-finance"
                                                style="font-size:14px">Terlambat</label>
                                            <?php }else{ ?>
                                            <label class="btn btn-submit status" style="font-size:14px">Hadir</label>
                                            <?php } ?>
                                        </td>
                                        <td style="text-align: left;"><?= $a->keterangan; ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
