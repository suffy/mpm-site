                                ...
                                <table id="tabel-data" class="display table-striped table-bordered"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">No Information</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <a href="<?= base_url('absensi/detail_absensi/'.$key->signature); ?>"
                                                    class="btn btn-submit status pending-rilis-po"
                                                    style="font-size:14px">
                                                    <?= $key->status ?></a>
                                                <?php } else { ?><a
                                                    href="<?= base_url('absensi/detail_absensi/'.$key->signature); ?>"
                                                    class="btn btn-submit status pending-finance"
                                                    style="font-size:14px">
                                                    <?= $key->status ?></a>
                                                <?php } ?>
                                            </td>
                                            ...
                                            <td><label class="btn btn-submit status pending-finance" style="font-size:14px"><?= $key->no_information ?></label></td>
