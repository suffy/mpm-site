...
<html lang="en">
  ...
  <body>
    ...
    <p>Dear Bapak Hendra</p>
    <p>Berikut adalah ajuan relokasi yang membutuhkan approval anda</p>
    ...
    <table border="0">
        ...
        <tr>
            ...
            <a href="<?= base_url() ?>master_data/accept_finance/<?= $signature ?>"><button type="button" class="button_accept">Accept Finance</button></a>
            <a href="<?= base_url() ?>master_data/reject_finance/<?= $signature ?>"><button type="button" class="button_reject">Reject Finance</button></a>
