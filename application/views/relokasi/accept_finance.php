...
<?php echo form_open('master_data/accept_finance_proses'); ?>
...
<div class="card">
    ...
    <?php 
        if ($status == 3) { ?>
          ...
          <div class="row mt-3">
              ...
              <div class="col-md-8">
                  ...
                  <button class="btn btn-primary" type="submit">Accept Finance</button>
        ...
        <?php }elseif($status == 6){ ?>
          ...
          <div class="row mt-5">
            <div class="col-auto">&nbsp;</div>
            <div class="col-md-4">status : <i><b>"REJECTED BY FINANCE"</b></i> at <?= $approve_finance_at; ?>
              <img src="<?= base_url().'assets/uploads/signature/'.$signature.'-signature-finance.png' ?>" alt="" srcset="">
            </div>
        </div>
