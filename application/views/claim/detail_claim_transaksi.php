...
<html>
    <head>
        ...
        <title>Admin Page | Detail Transaksi</title>
    ...
    <div class="row">
        <div class="col-xs-11">
            <div class="col-xs-9">
                ...
                <a href="<?php echo base_url()."monitor_claim/export_claim_detail_transaksi/" ?>   " class="btn btn-warning" role="button"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> export</a>  
            </div>
        </div>
    </div><br>
            ...
            <table id="myTable" class="table table-striped table-bordered table-hover">     
                    <thead>
                        <tr>                
                            ...
                            <th><font size="2px"><center> Sub</th>
                            <th><font size="2px"><center> NoClaim</th>
                            <th><font size="2px"><center> NoSales</th>
                            <th><font size="2px"><center> Tanggal</th>
                            <th><font size="2px"><center> Flag</th>
                            <th><font size="2px"><center> CustomerId</th>
                            <th><font size="2px"><center> Customer</th>
                            <th><font size="2px"><center> Kodeprod</th>
                            <th><font size="2px"><center> Namaprod</th>
                            <th><font size="2px"><center> QtyJual</th>
                            <th><font size="2px"><center> QtyBonus</th>
                            <th><font size="2px"><center> RpKotor</th>
                            <th><font size="2px"><center> RpNetto</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>        
                            ...
                            <td><font size="2px"><?php echo $x->no_klaim; ?></td>
                            <td><font size="2px"><?php echo $x->no_sales; ?></td>
                            <td><font size="2px"><?php echo $x->tanggal; ?></td>
                            <td><font size="2px"><?php echo $x->flag_transaksi; ?></td>
                            <td><font size="2px"><?php echo $x->customerid; ?></td>
                            <td><font size="2px"><?php echo $x->nama_customer; ?></td>
                            <td><font size="2px"><?php echo $x->kodeprod; ?></td>
                            <td><font size="2px"><?php echo $x->namaprod; ?></td>
                            <td><font size="2px"><?php echo $x->qty_jual; ?></td>
                            <td><font size="2px"><?php echo $x->qty_bonus; ?></td>
                            <td><font size="2px"><?php echo $x->rp_kotor; ?></td>
                            <td><font size="2px"><?php echo $x->rp_netto; ?></td>
