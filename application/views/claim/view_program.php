...
<head>
    ...
    <!-- <link rel="stylesheet" href="<?php echo base_url().'assets/' ?>popper/tail.select-light.min.css"> -->
...
<div class="row">
    <div class="col-xs-13">
        ...
        <div class="col-xs-2">
            <input type="text" class="form-control" name = "unit_beli1" placeholder="Unit" value="">
        </div>
        <div class="col-xs-2">
            <input type="text" class="form-control" name = "value_beli1" placeholder="Value" value="">
        </div>
    </div>
</div>
<div class="row">
...
<div class="row">
    <div class="col-xs-13">
        ...
        <div class="col-xs-2">
            <input type="text" class="form-control" name = "unit_beli2" placeholder="Unit" value="">
        </div>
        <div class="col-xs-2">
            <input type="text" class="form-control" name = "value_beli2" placeholder="Value" value="">
        </div>
    </div>
</div>
<div class="row">
...
<div class="row">
    <div class="col-xs-13">
        ...
        <div class="col-xs-2">
            <input type="text" class="form-control" name = "unit_beli3" placeholder="Unit" value="">
        </div>
        <div class="col-xs-2">
            <input type="text" class="form-control" name = "value_beli3" placeholder="Value" value="">
        </div>
    </div>
</div>
<div class="row">
...
<div class="row">
    <div class="col-xs-13">
        ...
        <div class="col-xs-2">
            <input type="text" class="form-control" name = "unit_bonus" placeholder="Unit" value="">
        </div>
        <div class="col-xs-2">
            <input type="text" class="form-control" name = "value_bonus" placeholder="Value" value="">
        </div>
    </div>
</div>
<div class="row">
