...
<div class="row">
    <div class="col-xs-13">       
        ...
        <div class="col-xs-10">
           ...
           <a href="<?php echo base_url()."monitor_claim/export_rekap/"; ?>   " class="btn btn-warning" role="button"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> export ke dalam excel</a>
        </div>        
        ...
        <table id="myTable" class="table table-striped table-bordered table-hover"> 
                <thead>
                    <tr>
                        ...
                        <th width="3%"><font size="2px">No Surat Program</th>
                        <th width="3%"><font size="2px">Nama Program</th>
                        <th width="3%"><font size="2px">Detail Program</th>
                        <th width="3%"><font size="2px">Area</th>
                        <th width="3%"><font size="2px">Keterangan dari MPM</th>
                        <th width="3%"><font size="2px">Tgl Claim DP</th>
                        <th width="3%"><font size="2px">Status</th>
                        <th width="3%"><font size="2px">Keterangan dari Principal</th>
                        <th width="3%"><font size="2px">Tgl Update Status Principal</th>
                        <th width="3%"><font size="2px">File Rekap MPM</th>
                        <th width="3%"><font size="2px">File Principal</th>
                    </tr>
                </thead>
                <tbody>
                <?php $no = 1;?>
                <?php foreach($proses as $row){ ?>
                    <tr>
                        ...
                        <td><?php echo $row->nama_comp; ?></td>  
                        <td><?php echo $row->ket; ?></td>   
                        <td><?php echo $row->tgl_claim_dr_dp; ?></td> 
                        <td><?php echo $row->status_verifikasi; ?></td>  
                        <td><?php echo $row->ket_penggantian; ?></td>          
                        <td><?php echo $row->tgl_penggantian; ?></td>     
                        <td><?php echo $row->filename_to_principal; ?></td>          
                        <td><?php echo $row->filename_principal; ?></td>     
                    </tr>
                <?php } ?>
                </tbody>
            </table>
