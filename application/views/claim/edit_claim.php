...
<div class="col-xs-16">
 ...
 <?php $id = $row->id; ?>
 <?php echo form_open_multipart('monitor_claim/proses_edit_claim/'.$id);?>
...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="col-xs-3">
            <input type="text" class = 'form-control' name="no_ap" placeholder="" value="<?php echo $row->no_ap;?>">
        </div>
        ...
        <div class="col-xs-3">
            <input type="text" class = 'form-control' name="no_surat_program" placeholder="" value="<?php echo $row->no_surat_program;?>">
        </div>
        ...
        <div class="col-xs-3">
            <input type="text" class = 'form-control' name="nama_program" placeholder="" value="<?php echo $row->nama_program;?>">
        </div>
        ...
        <div class="input-group input-daterange">
            <input type="text" class = 'form-control' id="datepicker2" name="from" placeholder="" autocomplete="off" value="<?php echo $row->from;?>">
            <div class="input-group-addon">to</div>
                <input type="text" class = 'form-control' id="datepicker" name="to" placeholder="" autocomplete="off" value="<?php echo $row->to;?>">
            </div>
        </div>
            ...
            <table class="table table table-striped table-bordered table-hover table-outlet">
                <thead>
                    <tr>
                        ...
                        <th width="2%"><font size="2px">Area/DP</th>
                        <th width="1%"><font size="2px">Created By</th>
                        <th width="4%"><font size="2px">Created Date</th>
                        <th width="2%"><font size="2px">Send DP</th>
                        <th width="2%"><font size="2px">FileMPM</th>
                        <th width="2%"><font size="2px">Del</th>
                        <th width="2%"><font size="2px">Edit</th>
...
$(".table-outlet").DataTable({
    ...
    serverSide: true,
    ajax: {
      url: "<?php echo base_url('monitor_claim/ambil_data_edit/'.$id) ?>",
      type:'POST',
    }
});
