...
<?php 
    $url = base_url()."monitor_claim/proses_status_claim/".$row->id;
...
<div class="row">
    <div class="col-xs-12">
        ...
        $status = array(
            ...
            // '1'  => 'Terkirim ke MPM',
            '2'  => 'Cross cek di MPM',
            '3'  => 'Kirim ke Principal',
            // '4'  => 'Cross cek di Principal',
        ...
        <div class="col-xs-3">
            <input type="text" class = 'form-control' name="nama_program" placeholder="" value = "<?php echo $row->nama_comp;?>" readonly>
        </div>
        ...
        <div class="col-xs-3">
            <?php
                ...
                }elseif($row->principal == '4'){
                    $principal = "Ultra Sakti";
                }elseif($row->principal == '5'){
                    $principal = "Marguna";
                }else{
                    $principal = "-";
                }
            ?>
            <input type="text" class = 'form-control' name="no_ap" placeholder="" value = "<?php echo $principal;?>" readonly>
        </div>
        ...
        <div class="col-xs-3">                
            <input type="hidden" class = 'form-control' name="verifikasi_by" value="<?php echo $userid; ?>" readonly>
            <input type="hidden" class = 'form-control' name="id_ref" value="<?php echo $row->id_ref; ?>" readonly>
            <input type="text" class = 'form-control' name="verifikasi_username" value="<?php echo $username; ?>" readonly>
        </div>
            ...
            <table class="table table table-striped table-bordered table-hover table-outlet">
                <thead>
                    <tr>
                        ...
                        <th width="4%"><font size="2px">Area</th>
                        ...
                        <th width="4%"><font size="2px">FIleDP</th> 
                        <th width="4%"><font size="2px">Status</th> 
                        <th width="4%"><font size="2px">UbahStatus</th> 
...
$(".table-outlet").DataTable({
    ...
    serverSide: true,
    ajax: {
      url: "<?php echo base_url('monitor_claim/ambil_data_detail/'.$row->id_ref) ?>",
      type:'POST',
    }
});
