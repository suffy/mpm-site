            ...
            <table id="tabel" class="datatable" >
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?= $p->kode_outlet ?></td>
                        <td><?= $p->nama_outlet ?></td>
                        <td>Rp. <?= number_format($p->actual_value,0) ?></td>
                        <td>Rp. <?= number_format($p->target_value,0) ?></td>
                        <td>Rp. <?= number_format($p->gap,0) ?></td>
                        <td><?= number_format($p->gap_persen,0) ?></td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
