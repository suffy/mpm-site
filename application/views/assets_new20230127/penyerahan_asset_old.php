...
<div class="dt-responsive table-responsive">
    <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">
        ...
        <tbody>
            <?php foreach($penyerahan_asset as $value) : ?>
            <tr>
                <td><a href="#" onclick="Detail('<?= $value->no_po;?>')"><?= $value->no_po;?></a></td>
                <td><a href="#" onclick="Detail_pr('<?= $value->no_pr;?>')"><?= $value->no_pr;?></a></td>
                <td><?= $value->ekspedisi; ?></td>
                <td><?= $value->resi; ?></td>
                <td><?= date('d-m-Y', strtotime($value->tgl_pengiriman)); ?></td>
