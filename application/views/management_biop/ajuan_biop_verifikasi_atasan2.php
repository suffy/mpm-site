        ...
        <div class="row mt-2">
            <div class="col-md">
                <div class="card" id="tabel">
                    <form action="<?= base_url($url_atasan2_proses) ?>" method="post">
                        <div class="biop-form">
                            <div class="row mt-4">
...
<table id="tabel-data-biop">
    <thead>
        <tr>
            <th style="text-align: center;" colspan="7">Data</th>
        ...
        <?php foreach ($get_data_biop as $biop) { ?>
            <tr>
                ...
                <td>
                    ...
                    <input type="number" class="form-control" name="biaya_atasan2[]" max="<?= $biop->biaya_atasan1;?>" id="biaya_atasan2" value="<?= $biop->biaya_atasan2 != null ? $biop->biaya_atasan2 : $biop->biaya_atasan1 ; ?>" >
                </td>
                <td><textarea class="form-control" name="keterangan_atasan2[]" id="keterangan_atasan2"><?= $biop->keterangan_atasan1 ?></textarea></td>
                <td class="col-status">
                    <Select class="form-control" name="status[]" id="status" required>
                        <option value=""> -- Pilih -- </option>
                        <option value="0" <?= ($biop->flag_tolak_atasan2 ? $biop->flag_tolak_atasan2 : $biop->flag_tolak_atasan1) == "0" ? "selected" : "" ?>>ok</option>
                        <option value="1" <?= ($biop->flag_tolak_atasan2 ? $biop->flag_tolak_atasan2 : $biop->flag_tolak_atasan1) == "1" ? "selected" : "" ?>>no</option>
                    </Select>
                </td>
            </tr>
        <?php } ?>
                                ...
                                <div class="col-md">
                                    ...
                                    <?php 
                                        if($is_authorized) { ?>
                                            ...
                                            <?php 
                                                if($get_biop->status != 5 ) { ?>
                                                    <button type="submit" name="proses" value="1" class="btn btn-submit-approve" style="height: 44px; padding: 10px 20px 10px 20px;">
                                                    <i class="bi bi-check2-square"></i> Approve & Proses Ke Admin Finance</button>
                                                <?php
                                                }else{ ?>
                                                    <label for="" style="border: 1px solid black; padding: 10px 20px 10px 20px; border-radius: 5px">menunggu verifikasi atasan 2</label>
                                                <?php
                                                }
                                            ?>  
                                        <?php 
