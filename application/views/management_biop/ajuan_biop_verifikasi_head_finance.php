        ...
        <div class="row mt-2">
            <div class="col-md">
                <div class="card" id="tabel">
                    <form action="<?= base_url($url_head_finance_proses) ?>" method="post">
                        <div class="biop-form">
                            <div class="row mt-4">
...
<table id="tabel-data-biop">
    <thead>
        <tr>
            <th style="text-align: center;" colspan="9">Data</th>
        ...
        <?php foreach ($get_data_biop as $biop) { ?>
            <tr>
                ...
                <td>
                    ...
                    <input type="number" class="form-control" name="biaya_head_finance[]" id="biaya_head_finance" max="<?= $biop->biaya_admin_finance;?>" value="<?= $biop->biaya_head_finance != null ? $biop->biaya_head_finance : $biop->biaya_admin_finance ; ?>" >
                </td>
                <td><textarea class="form-control" name="keterangan_head_finance[]" id="keterangan_head_finance"><?= $biop->keterangan_head_finance ?></textarea></td>
                <td class="col-status">
                    <!-- <Select class="form-control" style="text-transform: capitalize;" name="status[]" id="status" required>
                        ...
                        <option value="1" <?= ($biop->flag_tolak == "1") ? "selected" : "" ?>> Tolak </option>
                    </Select> -->
                    <select class="form-control" name="status[]" id="status" required>
                        <option value=""> -- Pilih -- </option>
                        <option value="0" <?= ($biop->flag_tolak_head_finance ? $biop->flag_tolak_head_finance : $biop->flag_tolak_admin_finance) == "0" ? "selected" : "" ?>>ok</option>
                        <option value="1" <?= ($biop->flag_tolak_head_finance ? $biop->flag_tolak_head_finance : $biop->flag_tolak_admin_finance) == "1" ? "selected" : "" ?>>no</option>
                    </select>
                </td>
            </tr>
        <?php } ?>
                                        ...
                                        if($is_authorized) { ?>
                                            ...
                                            <?php 
                                                ...
                                                <?php
                                                    ...
                                                    <i class="bi bi-check2-square"></i> Approved </button>
                                                <?php
                                                }else{ ?>
                                                    <label for="" style="border: 1px solid black; padding: 10px 20px 10px 20px; border-radius: 5px"><?= $nama_status; ?> </label>
                                                <?php
