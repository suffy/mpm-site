...
<div class="container-fluid">
    <div class="col-md">
                        ...
                        <?= form_open_multipart($url,  ['method' => 'post', 'class' => 'mt-3', 'id' => 'employeeForm']) ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-8">
                                            <select name="status_karyawan" id="status_karyawan" class="form-control" onchange="toggleStatus()">
                                                <option value="">-- Pilih --</option>
                            ...
                            <div class="row mt-4 mb-4">
                                <div class="col-md-12 text-center">
                                    ...
                                    <button type="submit" name="button_action" class="btn btn-submit-red px-4" value="2">
        ...
        <!-- Form Import -->
        <div class="row mt-2" id="form-import" style="display:none;">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h3><i class="fas fa-file-excel"></i> Import Data Karyawan dari Excel</h3>
                        ...
                        <div class="alert alert-info">
                            ...
                            <ol>
                                ...
                                <!-- <li>Maksimal 100 data per upload</li> -->
                            </ol>
                        </div>

                        <?= form_open_multipart('management_karyawan/import_excel', ['id' => 'formImport']) ?>
                        
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Download Template Excel</label><br>
                                    <a href="<?= base_url('management_karyawan/download_template') ?>" 
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <button type="button" onclick="toggleImport()" class="btn btn-secondary">
                                    Batal
                                </button>
                            </div>
                        </div>
                                ...
                                <div class="col-md-12">
                                    <?= form_open($url_search, ['method' => 'post']);?>
                                        <select name="status" class="form-control" >
                                            ...
                                            <option value="MPMHO" <?= $search === 'MPMHO'? 'selected' : '' ?>>PT. MULIA PUTRA MANDIRI</option>
                                            ...
                                            <td class ="action-column aksispesial">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li><a class="dropdown-item" href="#">Rembursement(Coming Soon)</a></li>
...
<script>
    function toggleImport() {
        ...
        const tombolImport = document.getElementById('button_import');
        const formInput = document.getElementById('form');

        // Tutup form input jika terbuka
        if (formInput.classList.contains('show')) {
            formInput.classList.remove('show');
            document.getElementById('button_form').textContent = 'Form Input Data Karyawan';
        }

        // Toggle form import
        if (formImport.style.display === 'none' || formImport.style.display === '') {
            formImport.style.display = 'block';
            tombolImport.innerHTML = '<i class="fas fa-times"></i> Tutup Form Import';
        } else {
            formImport.style.display = 'none';
            tombolImport.innerHTML = '<i class="fas fa-file-import"></i> Import Data Karyawan';
        }
    }
</script>
...
function toggleStatus() {
    ...
    const groupKontrak = document.getElementById('group_kontrak');
    const groupTetap   = document.getElementById('group_tetap');

    if (!groupKontrak || !groupTetap) return;

    groupKontrak.style.display = 'none';
    groupTetap.style.display = 'none';

    if (status === 'kontrak' || status === 'probation' || status === 'phl') {
        groupKontrak.style.display = 'block';
    }
