...
<div class="row mt-2">
    ...
    <div class="col-md-4">
        <select name="status" id="status" class="form-control" required>
            ...
            <option value="6"> APPROVE FINANCE</option>
            <option value="7"> REJECT FINANCE</option>
        </select>
    </div>
</div>
...
<div class="row mt-4 mb-5">
    ...
    <div class="col-md-5">
        <button type="submit" class="btn btn-submit" id="btnKirim" onclick="return button()">Update Status</button>
        <button class="btn btn-loading" id="btnLoading" type="button" disabled>
        ... Sedang verifikasi data. Mohon menunggu ...
        </button>
        <a href="<?= base_url().'management_claim/verifikasi_mpm_mti/'.$signature_program.'/'.$signature_ajuan ?>" class="btn btn-back" id="btnBack">Back</a>
    </div>
</div>
