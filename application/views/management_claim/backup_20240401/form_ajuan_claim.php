    ...
    if ($kategori == 'bonus_barang') { ?>
        <div class="row mt-5">
            <div class="col-md-7">
                ...
                <a href="<?= base_url().'management_claim/export_template_bonus_barang/'.$signature_program ?>" class="btn btn-dark btn-sm rounded mt-3" id="download">download template bonus barang.xlsx</a>
...
<div class="row mt-4 mb-5">
    ...
    <div class="col-md-5">
        <?php
            // echo "tanggal_claim : ".$tanggal_claim;
