...
<?php 
    ...
    <div class="row mt-1">
        ...
        <div class="col-md-6">
            <a href="<?= base_url().'management_claim/proses_pengajuan_diskon/'.$signature_program.'/'.$signature; ?>" class="btn btn-submit btn-sm rounded" id="btnKirim" onclick="return button()">Data Anda Aman. Silahkan Lanjut Pelaporan ke MPM</a>
