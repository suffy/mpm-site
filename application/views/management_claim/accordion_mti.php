                ...
                <div class="collapse multi-collapse" id="multiCollapseExample1">
                    <div class="card card-body">
                        <div class="container">       
                            ...
                            <div class="row mt-1">
                                <div class="col-md-3">
                                    <label for="supp">Status MPM</label>
                                </div>
                                <div class="col-md-9">
                                    <textarea class="form-control" cols="30" rows="3" readonly><?= $nama_status ?></textarea>
                                </div>
                            </div>
                ...
                <div class="collapse multi-collapse" id="multiCollapseExample1">
                    <div class="card card-body">
                        <div class="container">                            
                            ...
                            <div class="row mt-1">
                                <div class="col-md-3">
                                    <label for="supp">Status Hardcopy MPM</label>
                                </div>
                                <div class="col-md-9">
                                    ...
                                    <?php
                                        if (!empty($file_hardcopy)) { ?>
                                         ...
                                         <?php   
                                            ...
                                            echo '<label class="form-control" readonly>File Tidak Ada</label>';
                                        }?>
                                </div>
                            </div>
                            ...
                            <div class="row mt-1">
                                <div class="col-md-3">
                                    <label for="supp">File Tanda Terima ke Principal</label>
                                </div>
                                <div class="col-md-9">
                                    <?php 
                                        if (!empty($file_tanda_terima_hardcopy_ke_principal)) { ?>
                                    <a href="<?= base_url().'assets/uploads/management_claim/mti/'.$file_tanda_terima_hardcopy_ke_principal ?>" target="_blank" class ="btn btn-submit"><?= $file_tanda_terima_hardcopy_ke_principal ?></a>
                                    <?php
                                        }else{
                                            echo '<label class="form-control" readonly>Tidak ada file</label>';
                                        }
