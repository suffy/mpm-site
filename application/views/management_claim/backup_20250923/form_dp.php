...
<div class="card">
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-2">
                <label for="tanggal_terima_barang" class="form-label">PIC MPM</label>
            </div>
        ...
        <div class="row">
            <div class="col-md-2">
                <label for="first_pic" class="form-label">First PIC</label>
            </div>
            <div class="col-md-5 d-flex flex-row">
                <input type="text" class="form-control" name="first_pic" value="<?= $pic ?>" readonly>
            </div>
        </div>
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-5">
                <input type="text" class="form-control" name="status_validasi" value="<?= $nama_status_validasi." | ".$keterangan ?>" readonly>
            </div>
        </div>

        <div class="row mt-2">
            <div class="col-md-2">
                <label for="status_validasi" class="form-label">Deadline</label>
            </div>
            <div class="col-md-5 d-flex flex-row">
        ...
        <div class="row">
            <div class="col-md-2">
                <label for="status_validasi" class="form-label">Template</label>
            </div>
...
<div class="card mt-5 mb-5">
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <input type="text" name="site_code" class="form-control" value="<?= $site_code ?>" readonly>
            </div>
        </div>
        ...
        <div class="row mt-2">
            <div class="col-md-2">
                <label for="ajuan_excel" class="form-label">Attach File (Excel)</label>
            </div>
            <div class="col-md-5">
        ...
        <div class="row mt-2">
            <div class="col-md-2">
                <label for="ajuan_zip" class="form-label">Attach File (Zip)</label>
            </div>
            <div class="col-md-5">
