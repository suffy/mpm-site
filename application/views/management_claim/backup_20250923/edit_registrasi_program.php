    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-2">
                    <label for="supp" class="form-label">Current</label> 
                </div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-2">
                    <label for="supp" class="form-label"><i><?= $namasupp; ?></i></label> 
                </div>
            ...
            <div class="row mt-1">
                ...
                <div class="col-lg-2">
                    <label for="supp" class="form-label"><i><?= $kategori; ?></i></label> 
                </div>
            </div>

            <div class="row mt-1">
                <div class="col-lg-2">
                    <label for="flag_validasi" class="form-label">Flag Validasi</label>
                </div>
                <div class="col-lg-4">
                ...
                <div class="col-lg-2">
                    <label for="supp" class="form-label"><i><?= $nama_status_validasi; ?></i></label> 
                </div>
            </div>
            ...
            <div class="row mt-1">
                ...
                <div class="col-lg-2">
                    <label for="supp" class="form-label"><i><?= $segment; ?></i></label> 
                </div>
            </div>

            <div class="row mt-1">
                <div class="col-lg-2">
                    <label for="pic" class="form-label">First PIC</label>
                </div>
                <div class="col-lg-4">
                ...
                <div class="col-lg-2">
                    <label for="supp" class="form-label"><i><?= $pic; ?></i></label> 
                </div>
            </div>
            ...
            <div class="row mt-1">
                ...
                <div class="col-lg-2">
                    <label for="supp" class="form-label"><?= ($nama_template == null) ? '<i>no template</i>' : $nama_template; ?></label> 
                </div>
            </div>            
        </div>
    </div>
