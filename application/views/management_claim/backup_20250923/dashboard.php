...
<div class="container-fluid">
    ...
    <form action="<?= $url ?>">
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-8">
                <input type="submit" value="Tampilkan Data Sesuai Filter" class="btn btn-submit-black">
                <a href="<?= base_url('management_claim/dashboard') ?>" class="btn btn-submit-black">Tampilkan All Data</a>
                <input type="submit" value="Export Sesuai Filter" class="btn btn-submit-black" name="export">
            </div>
        </div>
                            ...
                            <thead>
                                <tr>                                    
                                    ...
                                    <th>
                                        ...
                                        <div>
                                            <?= $program->kategori.' | '.$program->from.' sd '.$program->to ?>
                                        </div>
                                        <div class="mt-2">
                                            <?php 
