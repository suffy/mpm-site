...
<ul>
            ...
            <div class="d-flex gap-4">
                ...
                <?php 
                    ...
                    <?php    
                        ...
                        <div>
                            <span class="card-text text-muted pending-finance" style="padding : 10px 5px 10px 5px; border-radius: 5px">secara default, hanya menampilkan 100 row</span>
                        </div>
                    <?php
                    } ?>
            </div>
                                ...
                                <td align="center">
                                    <?php 
                                        ...
                                        <?php
                                            ...
                                            <label class="form-label"><font size="2px"><i>blank</i></font></label>    
                                        <?php
                                        }
                                    ?>
    ...
    <div class="card mt-4">
        <div class="card-body">
            ...
            <div class="row mt-3">
                <div class="col-lg-2">
                    <label for="nama_program" class="form-label">Deadline yang diinginkan </label>
                </div>
                <div class="col-lg-4">
                    <div class="input-group">
