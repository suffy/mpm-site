            ...
            <div class="col-md-6" id="divform1">
              <h4>Revisi Claim NKA</h4>
                <div class="row mt-3" id="divform_no_klaim">
                  ...
                  <div class="col-md-7">
                    <input type="text" class="form-control" name="no_klaim" id="no_klaim" value="<?= $get_data->row()->nomor_ajuan; ?>" readonly>
                  </div>
                </div>
                ...
                <div class="row mt-1" id="divform_channel">
                  ...
                  <div class="col-md-7">
                    <input class="form-control" name="pic_nama" value="<?= $get_data->row()->pic_nama; ?>" id="pic_nama" readonly required>
                  </div>
                </div>
                ...
                <div class="row mt-1" id="divform_channel">
                  ...
                  <div class="col-md-7">
                    <input class="form-control" name="pic_email" value="<?= $get_data->row()->pic_email; ?>" id="pic_email" readonly required>
                  </div>
                </div>
...
<script>
    ...
    if (kategori == 'B2B') {
        ...
        '<div class="col-md-6" id="divform2">' +
            ...
            '</div>'+
        '</div>';
    } else if (kategori == 'Fixed Rebate' || kategori == 'Monthly' || kategori == 'Promotion Cost') {
        uploadDiv =
        '<div class="col-md-6" id="divform2">' +
            '<div class="row mt-1" id="divform_upload">' +
                '<h5>Persyaratan</h5>' +
        ...
        '<div class="col-md-6" id="divform2">' +
            ...
            '</div>'+
        '</div>';
    } else if (kategori == 'Promosi Instore') {
        uploadDiv =
        '<div class="col-md-6" id="divform2">' +
            '<div class="row mt-1" id="divform_upload">' +
                '<h5>Persyaratan</h5>' +
