...
<?php echo form_open_multipart($url); ?>
    ...
    <div class="row mt-3">
        <div class="col-md-2">
            <label for="attachment" >Upload File (.zip)</label>
        </div>
        <div class="col-md-4 d-flex flex-row">
    ...
    <div class="row mt-3">
        ...
        <div class="col-md-4 d-flex flex-row">
            <button type="submit" class="btn btn-submit-black" id="btnKirim" onclick="return button()">Submit Buletin Program</button>
                    ...
                    <tbody>     
                        ...
                        <tr>
                            ...
                            <td class = "text-center">
                                <?php 
                                    if ($a->file) { ?>
                                        <a href="<?= base_url('management_claim/tracking_download_buletin/'.$a->signature) ?>" target="_blank" class="btn-submit-black">download</a>
                                    <?php
                                    }else{
                                        echo "-";
                                    }
                            ...
                            <td class = "text-center">
                                <div class="col-md-12">
                                    <a href="<?= base_url('management_claim/delete_buletin/'.$a->signature) ?>" class="btn btn-submit-red" onclick="return confirm('Are you sure?')"><i class="fa-solid fa-trash-can" style="color: white"></i> del</a>
                
                                    <a href="<?= base_url('management_claim/edit_buletin/'.$a->signature) ?>" class="btn btn-submit-black"><i class="fa-regular fa-pen-to-square"></i> edit</a>
                                </div>
                            </td>                     
                        </tr>
                        <?php endforeach; ?>   
