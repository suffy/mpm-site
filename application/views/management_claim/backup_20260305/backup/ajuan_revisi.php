...
<div class="row">
    <div class="col-md-6 mb-5">
        ...
        <div class="col-md-12 mt-3 d-flex justify-content-center">     
            <div class="col-md-3">
                <label for="ajuan_revisi" class="form-label">upload File Revisi</label>
            </div>
            <div class="col-md-8 d-inline">
                <input type="file" class="form-control d-inline" id="ajuan_revisi" name="ajuan_revisi">
            </div>
        </div>

        <div class="col-md-12 mt-3 d-flex justify-content-center">     
            <div class="col-md-3">
                <label for="catatan_revisi" class="form-label">Catatan / Keterangan</label>
            </div>
            <div class="col-md-8 d-inline">
                <textarea name="catatan_revisi" id="catatan_revisi" cols="30" rows="5" class="form-control"></textarea>
            </div>
        </div>
        ...
        <div class="col-md-12 mt-3 d-flex justify-content-center">     
            ...
            <div class="col-md-8">
                ...
                <?php 
                    if ($get_registrasi_program->row()->status == 5) { ?>
                        <input type="submit" class="btn btn-outline-primary" value="Kirim File Revisi">
                    <?php    
                    }
                ?>
