        ...
        <?= form_open_multipart($url_search, ['method' => 'get'])?> 
          ...
          <div class="row mt-2">
            ...
            <div class="col-lg-9">
                ...
                <a href="<?= base_url().'assets/uploads/management_claim/Tutorial Penggunaan Menu Claim NKA Web MPM.pdf' ?>" class='btn btn-danger' style="height: 45px; padding-top: 10px">Tutorial Pengajuan Claim</a>
            </div>
          </div>
        <?= form_close(); ?>
      </div>
          ...
          <tbody>     
              ...
              foreach ($get_data->result() as $key)  {?>
                  <tr>
                      ...
                      <td><?= $key->kategori;?></td>
                      <td><?= $key->channel == 'nka' || $key->channel == 'nka_herbana' ? $key->key_account : '-';?></td>
                      <td>
                          <?php
