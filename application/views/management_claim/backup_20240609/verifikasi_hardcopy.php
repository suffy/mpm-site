    ...
    <div class="row mt-2">
        ...
        <div class="col-md-4">
            <select name="status_hardcopy" id="status_hardcopy" class="form-control" required>
                ...
                <option value="1" <?= $status_hardcopy == 2 ? 'selected' : '' ?>> PENDING DP</option>
                <option value="2" <?= $status_hardcopy == 1 ? 'selected' : '' ?>> PENDING MPM</option>
                <option value="3" <?= $status_hardcopy == 3 ? 'selected' : '' ?>> REJECT MPM</option>
                <option value="4" <?= $status_hardcopy == 4 ? 'selected' : '' ?>> PENDING PRINCIPAL</option>
                <option value="5" <?= $status_hardcopy == 5 ? 'selected' : '' ?>> REJECT PRINCIPAL</option>
