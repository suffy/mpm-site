...
<?php 
    ...
    <div class="row mt-3">
        ...
        <div class="col-md-6">
            <a href="<?= base_url().'management_claim/proses_pengajuan/'.$signature_program.'/'.$signature; ?>" class="btn btn-submit-red" id="btnKirim" onclick="return button()">Data Anda Aman. Silahkan Lanjut Pelaporan ke MPM</a>
