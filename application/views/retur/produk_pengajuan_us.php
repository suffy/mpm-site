...
<a href="<?= base_url() . "retur/export_pengajuan/" . $this->uri->segment('3'); ?>" class="btn btn-warning" role="button">export(.csv)</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <font size="2px"><i>
                                            ...
                                            if ($this->session->userdata('id') == 297 || $this->session->userdata('id') == 442 || $this->session->userdata('id') == 515 || $this->session->userdata('id') == 547 || $this->session->userdata('id') == 588) {
                                            ?>
                                                <a href="#" onclick="get_produk_retur_by_id('<?= $a->id ?>')"><?= $a->nama_status; ?></a>
                                            <?php } else {
                                                echo $a->nama_status;
                                            } ?>
                                </td>
