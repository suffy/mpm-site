  ...
  ?>
    <table class="table table-bordered">
        <tr>
            <th colspan="3">
                <center>
                    <font size="12px">Produk
            </th>
            <th colspan="3">
                <center>
                    <font size="12px">Total All
            </th>
            <th colspan="3">
                <center>
                    <font size="12px">Harga
            </th>
            <th colspan="3">
                <center>
                    <font size="12px">
        ...
        <tr>
            <th width="1%">#</th>
            <th width="5%">
                <font size="12px">kodeprod
            </th>
            <th width="10%">
                <font size="12px">namaprod
            </th>
            <th width="5%">
                <font size="12px">karton
            </th>
            <th width="5%">
                <font size="12px">dus
            </th>
            ...
            <th width="5%">
                <font size="12px">kode_produksi
            </th>
            <th width="10%">
                <font size="12px">keterangan
            </th>
        </tr>
        <?php 
      $no = 1;
      foreach ($detail as $row) { ?>
        <tr>
            ...
            <td>
                <font size="12px"><?php echo $row->total_karton; ?>
            </td>
            <td>
                <font size="12px"><?php echo $row->total_dus; ?>
            </td>
            <td>
                <font size="12px"><?php echo $row->total_pcs; ?>
            </td>
            <td>
                <font size="12px"><?php echo $row->harga_karton; ?>
            </td>
            <td>
                <font size="12px"><?php echo $row->harga_dus; ?>
            </td>
            <td>
                <font size="12px"><?php echo $row->harga_pcs; ?>
            </td>
            <td>
                <font size="12px"><?php echo $row->value; ?>
            </td>
            <td>
                <font size="12px"><?php echo $row->kode_produksi; ?>
            </td>
            <td>
        ...
        <tr>
            <th colspan="7" width="1%"></th>
            <th colspan="2" width="5%">
                <font size="12px">Discount
            </th>
            <th colspan="3" width="5%">
                <font size="12px"><?= $diskon ?>
            </th>
        </tr>
        <tr>
            <th colspan="7" width="1%"></th>
            ...
            <th colspan="3" width="5%">
                <font size="12px"><?= $value_ppn ?>
            </th>
        </tr>
        <tr>
            <th colspan="7" width="1%"></th>
            <th colspan="2" width="5%">
                <font size="12px">Total Akhir
            </th>
            <th colspan="3" width="5%">
                <font size="12px"><?= $total_akhir ?>
            </th>
        </tr>
