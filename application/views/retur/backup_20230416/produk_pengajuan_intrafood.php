                ...
                <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">
                    <thead>
                        <tr>
                            ...
                            <th width="2">
                                <font size="2px">Karton
                            </th>
                            <th width="2">
                                <font size="2px">Dos/Pack
                            </th>
                            <th width="2">
                                <font size="2px">Pcs
                            </th>
                            <th width="2">
                                <font size="2px">Karton (harga)
                            </th>
                            <th width="2">
                                <font size="2px">Dos/Pack (harga)
                            </th>
                            <th width="2">
                                <font size="2px">Pcs (harga)
                            </th>
                            <th width="2">
                                <font size="2px">Value
                            </th>
                            <th width="2">
                                <font size="2px">KodeProduksi
                            </th>
                            <th width="2">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <font size="2px"><?= $a->total_karton; ?>
                            </td>
                            <td>
                                <font size="2px"><?= $a->total_dus; ?>
                            </td>
                            <td>
                                <font size="2px"><?= $a->total_pcs; ?>
                            </td>
                            <td>
                                <font size="2px"><?= $a->harga_karton; ?>
                            </td>
                            <td>
                                <font size="2px"><?= $a->harga_dus; ?>
                            </td>
                            <td>
                                <font size="2px"><?= $a->harga_pcs; ?>
                            </td>
                            <td>
                                <font size="2px"><?= $a->value; ?>
                            </td>
                            <td>
                                <font size="2px"><?= $a->kode_produksi; ?>
                            </td>
                            <td>
    ...
    <div class="card-header">
        <div class="card-block">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <input id="" class="form-control" type="text" name="ppn" value="<?= $ppn ?>" required readonly />
                    <input id="" class="form-control" type="hidden" name="signature" value="<?= $this->uri->segment('3'); ?>"  required />
                    <input id="" class="form-control" type="hidden" name="supp" value="<?= $this->uri->segment('4'); ?>"  required />
                </div>
            </div>
