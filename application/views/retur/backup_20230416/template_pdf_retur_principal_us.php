  ...
  ?>
    <table class="table table-bordered">
        <tr>
            ...
            <th width="10%">
                <font size="12px">batch number
            </th>
            <th width="10%">
                <font size="12px">expired date
            </th>
            <th width="7%">
                <font size="12px">jumlah
            </th>
            <th width="7%">
                <font size="12px">satuan
            </th>
            <th width="10%">
                <font size="12px">nama_outlet
            </th>
            <th width="10%">
                <font size="12px">alasan
            </th>
            <th width="10%">
      ...
      foreach ($detail as $row) { ?>
        <tr>
            ...
            <td>
                <font size="12px"><?php echo $row->jumlah; ?>
            </td>
            <td>
