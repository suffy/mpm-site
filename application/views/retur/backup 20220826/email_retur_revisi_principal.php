...
<body>
    ...
    <center class="wrapper">
        <table class="top-panel center" width="602" border="0" cellspacing="0" cellpadding="0">
            <tbody>
                <tr>
                    <td class="title" width="300">Yth Bapak/Ibu  <?= $namasupp ?></td>
                </tr>
            </tbody>
        </table>
                    ...
                    <td class="column">
                        ...
                        <table class="content" border="0" cellspacing="0" cellpadding="0">
                            <tbody>
                                <tr>
                                    <td class="padded">
                                        <p>Kami ingin mengirimkan pengajuan retur kami dengan data sebagai berikut :</p>
                                        <p>Nomor ajuan retur : <?= $no_pengajuan; ?><br />
                                        Company : <?= $nama_comp; ?><br />
                                        Tanggal : <?= $tanggal_pengajuan; ?><br />
                                        File Pengajuan DP : <?= $file; ?><br>
                                        Detail produk terlampir.</p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
