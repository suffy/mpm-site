        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input id="" class="form-control" type="text" name="total_karton"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Total Dus/Pack</label>
                    <div class="col-sm-6">
                        <input id="" class="form-control" type="text" name="total_dus"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Total Pcs</label>
                    <div class="col-sm-6">
                        <input id="" class="form-control" type="text" name="total_pcs"  />
                    </div>
                </div>
                <hr>
