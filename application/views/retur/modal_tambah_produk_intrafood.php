            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input class="form-control" type="text" name="namaprod" id="namaprod" placeholder="klik button cek" required onkeypress="return false;"/>
                    </div> 
                </div>
                <hr>
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input id="" class="form-control" type="number" name="total_karton"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Total Dus/Pack</label>
                    <div class="col-sm-6">
                        <input id="" class="form-control" type="number" name="total_dus"  />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4">Total Pcs</label>
                    <div class="col-sm-6">
                        <input id="" class="form-control" type="number" name="total_pcs"  />
                    </div>
                </div>
                
                <div class="form-group row">
                    <label class="col-sm-4">Kode Produksi</label>
                    <div class="col-sm-6">
                        <input id="" class="form-control" type="text" name="kode_produksi" required />
                    </div>
                </div>
