        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="olshop" value="<?= $get_transaksi->row()->nama_olshop.' - '.$get_transaksi->row()->nama_store; ?>" readonly>
                </div>

                <div class="form-group">
                    <label for="tgl_proses">Tanggal Proses</label>
                    <input type="text" class="form-control" name="tgl_proses" value="<?= $get_transaksi->row()->tgl_proses; ?>" readonly>
                </div>

                <div class="form-group">
                    <label for="no_proses">No Proses</label>
                    <input type="text" class="form-control" name="no_proses" value="<?= $get_transaksi->row()->no_proses; ?>" readonly>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="tgl_invoice" value="" placeholder="enter tgl invoice">
                </div>
                <div class="form-group">
                    <label for="no_invoice">No Invoice</label>
                    <input type="text" class="form-control" name="no_invoice" value="" placeholder="enter no invoice">
                </div>
                <div class="form-group">
                    <label for="customer">Customer</label>
                    <input type="text" class="form-control" name="customer" value="" placeholder="enter customer">
                </div>
                <!-- <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="no_resi" name="no_resi" placeholder="Enter no_resi">
                </div>

                <div class="form-group">
                    <?php echo form_submit('submit', 'Simpan Invoice Header', 'class="btn btn-primary"'); ?>
                    <?php echo form_close(); ?>
