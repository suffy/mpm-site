                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                <input type="date" name="from" id="from" min="2023-01-01" class="form-control" value="<?= $this->input->get('from') ?>" required>
                                <input type="date" name="to" id="to" min="2023-01-01" class="form-control" value="<?= $this->input->get('to') ?>" required>
                            </div>
                        </div>
                    </div>
