                        ...
                        <table id="tabel-data" class="table-striped dataTable no-footer">    
                            <thead>
                                <tr>                                     
                                    ...
                                    <th width="1"><font size="2px">TanggalTerima</th>                            
                                    <th width="1"><font size="2px">List Nodo</th>                            
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <td>
                                    <div class="position-relative">
                                        <a href="<?= base_url("spk/konfirmasi_po_detail/$value->id") ?>" target="_blank">
