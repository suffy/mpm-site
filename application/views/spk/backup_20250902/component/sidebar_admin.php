<div class="az-content-left az-content-left-components">
    <div class="component-item">
        ...
        <nav class="nav flex-column"> 
            ...
            <a href="<?= base_url().'spk/lead_time' ?>" class="nav-link-new" target="_blank">Report Lead Time (new)</a>
        </nav>
        ...
        <nav class="nav flex-column"> 
            ...
            <a href="<?= base_url().'spk/konfirmasi_po' ?>" class="nav-link-new">Konfirmasi Terima PO (new)</a>
        ...
        <nav class="nav flex-column">
            ...
            <a href="<?= base_url().'spk/import_do_deltomed' ?>" class="nav-link-new">Import DO Deltomed (Batch)</a>
            <a href="<?= base_url().'spk/import_do_us' ?>" class="nav-link-new">Import DO US (Batch)</a>
        </nav>
    </div>
</div>