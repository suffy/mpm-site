    ...
    <div class="az-content">
        <div class="container-fluid">
            ...
            <div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <a href="<?= base_url().'spk/generate_surat_jalan_us/'.$tgldo ?>" class="btn btn-primary">Generate Surat Jalan</a>
                        <a href="<?= base_url().'spk/delete_surat_jalan_us/'.$tgldo ?>" class="btn btn-danger">Delete Surat Jalan</a>
                    </div>
                </div>
                        ...
                        <table id="tabel" style="width: 100%">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center">Tglpo</th>
                                    <th style="text-align: center">SuratJalanMPM</th>
                                    <th style="text-align: center">KodeAlamat</th>
                            ...
                            <?php foreach ($get_surat_jalan->result() as $a):?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url().'spk/export_surat_jalan/'.str_replace('/', '_', $a->kode_surat_jalan) ?>" class="btn btn-danger"><?= $a->kode_surat_jalan ?>
                                    </td>
