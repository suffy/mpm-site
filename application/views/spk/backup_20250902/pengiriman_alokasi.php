...
<div class="row mt-3">
    ...
    <div class="col-md-4">
        <input type="text" name="company" id="company" class="form-control" value="<?= $company ?>" readonly>
    </div>
</div>
...
<div class="row mt-1">
    ...
    <div class="col-md-4">
        <input type="text" name="npwp" id="npwp" class="form-control" value="<?= $npwp ?>" readonly>
    </div>
</div>
             ...
             <table id="table-data" class="display mb-4">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $a->nama_comp ?></td>
                        <td>
                            <textarea cols="30" rows="3" class = "form-control" readonly><?= $a->alamat ?></textarea>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
