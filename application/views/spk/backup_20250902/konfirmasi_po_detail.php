        ...
        <div class="col-md-12 mt-4">
            ...
            <thead>                
                <tr>
                    ...
                    <th colspan='2' style="text-align: center">SuratJalanMPM</th>
                </tr>
                <tr>                
                    <th><center><input type="button" class="btn btn-default btn-sm" id="toggle" value="click all" onclick="click_all_request()" ></th>                  
                    <th><font size="2px">NoDO</th>                        
                    <th><font size="2px">TglDO</th>                        
                    <th><font size="2px">Kodeprod</th>                        
                    <th><font size="2px">Namaprod</th>       
                    <th><font size="2px">Batch Number</th>                        
                    <th><font size="2px">ED</th>                        
                    <th><font size="2px">QTY DO</th>                        
                    <th style="background-color: #1d1d1d; color: white; text-align: center"><font size="2px">Tanggal Terima</th>                        
                    <th style="background-color: #1d1d1d; color: white; text-align: center"><font size="2px">QTY Terima</th>                        
                    <th><font size="2px">SuratJalanMPM</th>                        
            ...
            <tbody>
                ...
                foreach ($get_do->result() as $key) : 
                    $item_id = $key->nodo.'|'.$key->kodeprod.'|'.$key->batch_number .'|'.$no;
                ?>
                <tr>
                    <td>
                        <center>
                    ...
                    <td>
                        <a href="<?= base_url().'spk/surat_jalan_mpm_deltomed/'.str_replace('/', '_', $key->kode_surat_jalan).'/'.$signature; ?>"><?= $key->kode_surat_jalan ?></a>
                    </td>
