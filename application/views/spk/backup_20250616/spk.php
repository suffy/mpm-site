...
{    
    ...
    {       
        ...
        $this->load->model(array('model_outlet_transaksi', 'model_spk', 'model_master_data', 'model_inventory'));
    ...
    {
        if ($this->session->userdata('username') <> 'suffy' && $this->session->userdata('username') <> 'tria') 
        {
    ...
    public function import_spk()
    {
        ...
        if ($this->upload->do_upload('file')) 
        {
            ...
            if ($jumlahSheet > 1) 
            {
                ...
                redirect('spk/keranjan_belanja','refresh');
            }
