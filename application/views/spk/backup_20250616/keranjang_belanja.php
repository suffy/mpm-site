                    ...
                    foreach ($get_data->result() as $a) : ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?= base_url('spk/delete_keranjang/' . $a->signature_detail) ?>" onclick="return confirm('Are you sure?')" class="delete-button" style="width: 10px;height: 10px;padding: 10px 7px 10px 15px"></a>
                            </td>
                        </tr>
                    <?php
                        $no++;
