                ...
                <table class="content" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td class="padded">
                          ...
                          <h2>#<?php echo $id; ?></h2>
                          <h3>Perubahan Data Outlet <?php echo $branch_name." - ".$nama_comp; ?></h3>
                          <p>Dear Bapak/Ibu <strong><?php echo $to; ?></strong>.</p>

                          <p>
                          Permintaan perubahan data outlet anda sudah diproses. Silahkan cek lampiran. Dan lakukan konsolidasi di SDS anda.
                          <?php 
                            // echo $log_id;
                          ?>
                          </p>
