...
<center class="wrapper">
    <table class="top-panel center" width="602" border="0" cellspacing="0" cellpadding="0">
        <tbody>
        <tr>
            <td class="title" width="300">PT Mulia Putra Mandiri</td>
                ...
                <table class="content" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td class="padded">
                          ...
                          <h3>Data Toko Baru <?php echo $name." - ".$shop_name; ?></h3>
                          <p>Dear Bapak/Ibu <strong><?php echo $to; ?></strong>.</p>

                          <p>
                            Berikut adalah data customer yang melakukan registrasi via apps semut gajah :<br><br>
                            Tanggal : <?php echo $created_at; ?><br><br>
                            Nama : <?php echo $name; ?><br>
                            Nama Toko     : <?php echo $shop_name; ?><br>
                            Telp         : <?php echo $phone; ?><br><br>

                            Alamat        : <?php echo $address; ?><br>
                            Provinsi      : <?php echo $provinsi; ?><br>
                            Kota          : <?php echo $kota; ?><br>
                            Kecamatan      : <?php echo $kecamatan; ?><br>
                            Kelurahan          : <?php echo $kelurahan; ?><br>
                            Kode Pos          : <?php echo $kode_pos; ?><br>
                            <br>
                            Silahkan lakukan konsolidasi di SDS anda untuk memasukkan data ini ke sistem anda
                          </p>
                        </td>
                    </tr>
                    </tbody>
