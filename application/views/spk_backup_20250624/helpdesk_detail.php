                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mt-2">
                        <div class="card">
                            <div class="row">
                                <div class="col-md-4">
                                    <label for="site_code" class="form-label">No Tiket</label>
                                </div>
                                <div class="col-md-8">
                                    <label for="site_code" class="form-label">: <?= $helpdesk->row()->no_tiket ?></label>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <label for="site_code" class="form-label">: <?= $helpdesk->row()->site_code ?></label>
                                </div>
                            </div>

                            <div class="row">
                                <div class="col-md-4">
                                    <label for="site_code" class="form-label">Sub Branch</label>
                                </div>
                                <div class="col-md-8">
                                    <label for="site_code" class="form-label">: <?= $helpdesk->row()->nama_comp ?></label>
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-8">
                                    <label for="supp" class="form-label">: <?= $helpdesk->row()->namasupp ?></label>
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-8">
                                    <label for="surat_jalan" class="form-label">: <?= $helpdesk->row()->surat_jalan ?></label>
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-8">
                                    <label for="surat_jalan" class="form-label">: <?= $helpdesk->row()->ekspedisi ?></label>
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-8">
                                    <label for="surat_jalan" class="form-label">: <?= $helpdesk->row()->pic ?></label>
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-8">
                                    <label for="surat_jalan" class="form-label">: <?= $helpdesk->row()->telp ?></label>
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-8">
                                    <label for="surat_jalan" class="form-label">: <?= $helpdesk->row()->email ?></label>
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-8">
                                    <label for="surat_jalan" class="form-label" style="text-transform: capitalize;">: <?= $helpdesk->row()->nama_kategori ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="table-responsive">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="width: 80%; text-align: center;" >Pesan</th>
                            <th style="width: 80%; text-align: center;" >Attachment</th>
                            <th style="width: 80%; text-align: center;" >Video</th>
                    ...
                    <div class="row mt-2">
                        ...
                        <input type="text" name="signature" class="form-control" id="signature" value="<?= $helpdesk->row()->signature ?>" hidden>
                            <div class="col-md-12">
                                ...
                                <textarea type="text" class="form-control" rows="4" name="pesan" id="pesan" placeholder="Masukan Pesan" required></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mt-2 mb-3">
                            <div class="col-md-12">
                                <label for="attachment" class="form-label">File Tambahan (Opsional)</label>
