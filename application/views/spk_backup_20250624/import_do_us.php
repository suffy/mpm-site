            ...
            <div class="az-content-body pd-lg-l-40 d-flex flex-column">
                ...
                <div class="row mt-1">
                    <div class="col-md-12 mt-4">
                        ...
                        <a href="<?= $url_ftp; ?>" class="btn btn-submit-black" target="_blank">Go to File DO US</a>
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    <div class="col-md-12 mt-4">
                        ...
                        <table id="tabel" class="table table-hover" style="width:100%">
                            ...
                            <tbody>
                            <?php foreach ($get_do_us->result() as $a):?>
                                <tr>
                                    <td><?= $a->tgldo ?></td>
                                    ...
                                    <td><a href='<?= base_url("spk/export_do_deltomed/$a->tgldo")?>' type="button" class="btn btn-warning">Export</a></td>
                                    <td>
                                        <?php if ($a->count_surat_jalan == 0) { ?>
                                            <a href='<?= base_url() ?>spk/generate_surat_jalan_us/<?= $a->tgldo ?>' type="button" class="btn btn-warning">Generate now</a>
                                        <?php }else { ?> 
                                            <a href='<?= base_url() ?>spk/list_surat_jalan_us/<?= $a->tgldo ?>' type="button" class="btn btn-warning"><i class="fas fa-truck me-2"></i> <?= $a->count_surat_jalan ?> Surat Jalan</a>
                                        <?php } ?>
                                    </td>
                                </tr>
                            <?php endforeach;?>
...
<script>
    function toggleInsert(button) {
        ...
        button.textContent = isHidden ? "Close" : "Insert DO US";
    }
</script>
