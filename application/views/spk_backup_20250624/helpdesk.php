                    ...
                    <?= form_open_multipart($url_input,['method' => 'post']); ?>
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <select class="form-select" name="site_code" id="site_code" >
                        ...
                        <div class="row mt-2">
                            <div class="col-md-12">
                                ...
                                <select class="form-select" name="supp" id="supp" >
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="surat_jalan" id="surat_jalan" placeholder="Masukan Nomor Surat Jalan" >
                            </div>
                            <div class="col-md-6">
                                <label for="ekspedisi" class="form-label">Ekspedisi</label>
                                <input type="text" class="form-control" name="ekspedisi" id="ekspedisi" placeholder="Masukan Ekspedisi" >
                            </div>
                        </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="pic" id="pic" placeholder="Masukan Nama PIC" >
                            </div>
                        </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6">
                                ...
                                <input type="tel" class="form-control" name="telp" id="telp" placeholder="Masukan Nomor Telpon" >
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row mt-2">
                            <div class="col-md">
                                ...
                                <select name="kategori" class="form-control" id="kategori" onchange="tampilkanDiv()" >
                            ...
                            <div class="col-md-6" id="divMasalah">
                                ...
                                <input name="masalah" class="form-control" id="masalah" placeholder="Masukan Kategori Masalah">
                            </div>
                        </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-md-12">
                                ...
                                <textarea type="text" class="form-control" rows="4" name="kronologis" id="kronologis" placeholder="Masukan Kronologis Masalah" ></textarea>
                            </div>
                        </div>

                        <div class="row mt-2">
                            <div class="col-md-6">
                                <label for="berita" class="form-label">File Berita Acara </label>
                ...
                <div class="col-md-12">
                    <?= form_open($url_search, ['method' => 'post']);?>
                        ...
                        <select name="status" class="form-control" required>
                            ...
                            <option value="2" <?= $search['status'] === '3' ? 'selected' : '' ?>> Closed </option>
                    ...
                    <?php foreach ($data_helpdesk->result() as $a) : ?>
                        <tr>
                            <td style="text-align: center;">
                                ...
                                <a href="<?= base_url() . "spk/helpdesk_detail/$a->signature"; ?>" type="button" class="btn btn-submit pending-rilis-po btn-sm" style="text-transform: capitalize;" role="button">
                                    Detail
                                </a>
                            </td>
                            <td>
