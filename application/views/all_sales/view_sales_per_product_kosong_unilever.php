...
<pre>
<b>Select Product : </b>
<input type="checkbox" id="cbgroup1_master" name="checkall" onclick="checkUncheckAll(this);"/> ALL PRODUCT
</pre>
<hr>
<div class='row'>
...
<br />
    ...
    foreach($query->result() as $value)
    {
        ...
        <td>
           ...
           <input name="options[]" type="CHECKBOX" id="" class = "<?php echo $value->supp ?>" value="<?php echo $value->kodeprod ?>"><?php echo $value->namaprod.' ('.$value->kodeprod.')';?>
           </div>
        </td>
        <!-- <?php //echo $value->supp."[]" ?> -->
