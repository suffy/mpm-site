...
<input type="checkbox" name="001" id="001" onClick="testGroup.check(this);"/> Check all Deltomed
  ...
  <input TYPE="checkbox" NAME="herbana" id="001G0103" VALUE="green2" onClick="testGroup.check(this);"> Herbana (Divisi 3)
...
<div class='row'>
    ...
    <div class="col-md-2">
        <div class="form-group">
            <?php        
                echo form_label(" Class Outlet Condition : ");
                $kondisi_class=array();
                $kondisi_class['1']='On Faktur Transaction';
                $kondisi_class['2']='Current / Saat ini';
