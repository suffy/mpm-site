    ...
    <div class="chat-app-container">
        ...
        <div class="chat-header">
            ...
            <div class="chat-header-actions">
                <button class="chat-btn-icon" onclick="toggleModal(true)" title="Settings">
...
<div id="settings-modal" class="modal-overlay hidden opacity-0">
    <div id="modal-content" class="modal-box scale-95">
        <div class="modal-header">
            <h3><i class="ph ph-gear"></i> Settings</h3>
            <button class="chat-btn-icon" onclick="toggleModal()" style="width: 32px; height: 32px; font-size: 18px;">
                <i class="ph ph-x"></i>
            </button>
        </div>
        <div class="modal-body">
            <div class="form-group">
                ...
                <input type="text" id="webhook-url" class="form-input" placeholder="https://your-webhook-url.com" value="<?php echo $webhook_url; ?>">
            </div>
            <div class="toggle-row">
                <div>
                    <div style="font-weight: 600; font-size: 14px; color: var(--text-dark);">Debug Mode</div>
                    <div style="font-size: 13px; color: var(--text-gray); margin-top: 2px;">Tampilkan data JSON mentah</div>
                </div>
                <label class="switch">
            ...
            <div class="note-box">
                ...
                Webhook URL diperlukan untuk menghubungkan ke AI assistant. Pastikan URL yang dimasukkan valid.
            </div>
        </div>
...
<script>
    ...
    function formatText(text) {
        if (!text) return "";
        if (typeof text !== 'string') return `<code style="background: rgba(0,0,0,0.05); padding: 2px 6px; border-radius: 4px; font-family: monospace; font-size: 13px;">${escapeHtml(JSON.stringify(text))}</code>`;
