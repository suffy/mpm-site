...
<html>
    ...
    <div class="row">   
        ...
        <div class="col-xs-5">            
            ...
            <?php echo form_close(); ?>
            <a href="<?php echo base_url()."import/konversi_bangka/"; ?>  " class="btn btn-warning" role="button"><span class="glyphicon glyphicon-transfer" aria-hidden="true"></span> Konversi Ke Format MPM <span class="glyphicon glyphicon-transfer" aria-hidden="true"></span></a>
            ...
            <table id="myTable" class="table table-striped table-bordered table-hover">     
                    <thead>
                        <tr>                
                            ...
                            <th>noJual</th>
                            <th><font size="2px">tanggalJual</th>
                            ...
                            <th><font size="2px">hargaNet</th>
                            <th><font size="2px">bonus</th>
                    ...
                    <tbody>
                        ...
                        <tr>        
                            ...
                            <td><font size="2px"><?php echo $a->no_jual; ?></td>
                            <td><font size="2px"><?php echo $a->tanggal_jual; ?></td>
                            ...
                            <td><font size="2px"><?php echo $a->harga_net; ?></td>
                            <td><font size="2px"><?php echo $a->bonus; ?></td>
