    ...
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between">
            ...
            <div class="d-flex gap-2">
                <a href="<?= base_url().'management_sales/export_by_kodeprod_tipe_class/'.$filename ?>">
                ...
                <a href="<?= base_url().'management_sales/export_by_kodeprod_tipe_class_horizontal/'.$filename ?>">
                    ...
                    <table id="tabel" style="width: 100%">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" style="width: 10%">kodeprod</th>              
                                <th class="text-center" style="width: 10%">namaprod</th>              
                                <th class="text-center" style="width: 10%">principal</th>              
