    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-11">
                ...
                <a href="<?php echo base_url()."all_po/export_rofo_finish/"; ?> " class="btn btn-warning" role="button"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> export tabel rofo (.xls)</a>
                <a href="<?php echo base_url()."all_po/export_rofo_finish_summary/"; ?> " class="btn btn-info" role="button"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> export summary rofo (.xls)</a>
            </div>
        </div>
