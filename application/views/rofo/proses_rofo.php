    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-11">
                ...
                <a href="<?php echo base_url()."all_po/export_rofo_git/"; ?> " class="btn btn-warning" role="button"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> export tabel rofo (.xls)</a>
            </div>
        </div>
            ...
            <table id="myTable" class="table table-striped table-bordered table-hover">     
                    <thead>
                        <tr>                
                            ...
                            <th><font size="2px"><center>Stock</th>
                            <th><font size="2px"><center>POblmDO</th>
                            <th><font size="2px"><center>PO Berjalan</th>
