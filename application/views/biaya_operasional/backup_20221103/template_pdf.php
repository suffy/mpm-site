    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <tbody>
            <tr>
                ...
                <td width="2px">:</td>
                <td width="350px"><?= ucwords($header->username); ?></td>
            </tr>
            <tr>
        ...
        <tbody>
            ...
            foreach ($detail as $key) : ?>
                <tr>
                    ...
                    <td><?= number_format($key->total_km);?></td>
                    <td><?= $key->liter;?></td>
                ...
                <tr>
                    ...
                    <td>Rp. <?php if ($total_biaya->total_biaya == '') {
                        echo '0';
                    } else {
                        echo number_format($total_biaya->total_biaya);
                    }
                    ?></td>
                    <td colspan="2"></td>
                </tr>
