...
<button class="btn btn-primary btn-primary" onclick="addBiaya()"><i class="fa fa-plus"></i>Tambah
    Pengajuan</button>
<button class="btn btn-primary btn-warning btn-report" data-toggle="modal" data-target="#report">Report</button>
<button class="btn btn-primary btn-success" data-toggle="modal" data-target="#reimburse">Generate Report</button>
...
<script>
    $(document).ready(function () {
        ...
        if (id == 557 || id == 561 ) {
            $('button.btn-report').show()
        } else {
            $('button.btn-report').hide()
        }
    });
</script>