    ...
    <div class="card-block">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <a href="<?= base_url().'management_raw/template_balikpapan' ?>" class="btn btn-outline-warning">download template</a>
                ...
                <table id="example" class="table table-striped table-bordered" style="display: inline-block; overflow-y: scroll">
                    ...
                    <tbody>     
                        ...
                        <tr>
                            ...
                            <td><a href="<?= base_url().'management_raw/download_raw/DASD1/'.$a->signature ?>" class="btn btn-warning">download</a></td>           
                        </tr>
                        <?php endforeach; ?>   
                    </tbody>
                </table>
