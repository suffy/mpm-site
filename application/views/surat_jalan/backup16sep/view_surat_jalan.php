    ...
    <body>
     ...
     <div class="row">        
        ...
        <div class="col-xs-13">
            ...
            <div class="col-xs-2">
                <input type="text" class="form-control" id="datepicker3" name="start" placeholder="start date" autocomplete="off">                
            </div>
            <div class="col-xs-2">
                <input type="text" class="form-control" id="datepicker2" name="end" placeholder="end date" autocomplete="off">                       
            </div>
            <div class="col-xs-3">
                <?php $ketdd=array(
                                    1=>'Faktur Lunas',
        ...
        <div class="col-xs-13">  
            <div class="col-xs-3">            
                <input type="text" class="form-control" id="datepicker" name="tgl" placeholder="masukkan tanggal" autocomplete="off"> 
            </div>

            <div class="col-xs-6"> 
                <?php echo form_submit('submit','Cari Berdasarkan Tanggal','class="btn btn-success"');?>
                <?php echo form_close();?>
                <a href="<?php echo base_url()."all_surat_jalan/formTampilFaktur"; ?>  " class="btn btn-warning" role="button"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Tambah Surat Jalan</a>
            </div>
        </div>
    </div>
