    ...
    <div class="col-md-3">
        ...
        <div class="input-group input-daterange">
            ...
            <div class="input-group-addon">to</div>
                <input type="text" class = 'form-control' id="datepicker3" name="to" placeholder="" autocomplete="off">
            </div>
        </div>       
    </div>
    <input type="hidden" class = 'form-control' name="grup_lang" placeholder="" value="<?php echo $grup_lang; ?>">
    <input type="hidden" class = 'form-control' name="jenis_faktur" placeholder="" value="<?php echo $jenis_faktur; ?>">
...
<?php 
    echo form_open($url2.$grup_lang.'/'.$jenis_faktur);
?>
            ...
            <table id="myTable" class="table table-striped table-bordered table-hover">     
                ...
                <tbody>
                    ...
                    <tr>        
                        ...
                        <td><center>
                            <?php
                                echo anchor('all_surat_jalan/delete_temp/'.$grup_lang.'/'.$jenis_faktur.'/'.$tampil_temps->id, ' ',"class='glyphicon glyphicon-remove'");
                            ?>
                            </center>                           
                        </td>        
                    </tr>
