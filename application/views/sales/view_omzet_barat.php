...
<html>
    ...
    <div class="row">        
        <div class="col-xs-16">
            ...
            <h3>Data Omzet DP Wilayah Barat</h3><hr />
        </div>
        <div class="col-xs-2">
        ...
        <div class="col-xs-2">
            <a href="<?php echo base_url()."omzet/export_omzet_barat/". $tahun."/".$supp."/"; ?>  " class="btn btn-warning" role="button"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> export hasil proses ke dalam excel</a>
        </div>
            ...
            <table id="myTable" class="table table-striped table-bordered table-hover">     
                    <thead>
                        <tr>                
                            ...
                            <th><font size="2px">Upload Terakhir</th>
                        </tr>
                    </thead>
                    <tbody>
