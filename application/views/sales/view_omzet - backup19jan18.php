...
<html>
    ...
    <div class="row">        
        ...
        <div class="col-xs-2">
            <a href="<?php echo base_url()."omzet/export_omzet/". $tahun."/".$supp."/"; ?>  " class="btn btn-warning" role="button"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> export hasil proses ke dalam excel</a>
        </div>
