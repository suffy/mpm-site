<div class="col-xs-16">
    <a href="<?php echo base_url()."assets/input_assets"; ?>  " class="btn btn-warning" role="button"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Tambah Asset</a>
