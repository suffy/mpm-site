        ...
        <div class="row">
            <div class="col">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <!-- form pengajuan -->
                        <form action="<?= base_url('management_asset/pengajuan_asset_konfirm_non_it_tambah')?>"
                            method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-9">
                                    <a href="<?= base_url("management_asset/signature_digital/$signature/detail_non_it") ?>"
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <?php 
                            if ($key->deleted == 0) { ?>
                        <a href="<?= base_url().'management_asset/pengajuan_asset_konfirm_non_it_delete/'.$signature.'/'. $key->id; ?>"
