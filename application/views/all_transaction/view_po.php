...
<html>
        ...
        <div class="col-xs-5">
            ...
            <?php
                foreach($query_pel->result() as $value)
                {
                    ...
                    $x[$value->grup_lang]= $value->branch_name. ' / ' .$value->nama_customer;                                       
                    // $x[$value->grup_lang]= $value->branch_name;                                       
                }
    ...
    <div class="row">        
        ...
        <div class="col-xs-1">
            <a href="<?php echo base_url()."all_transaction/manual_update"; ?>" type="button" class="btn btn-primary">Update</a>
        </div>
    </div>
                    ...
                    <tbody>
                        ...
                        <tr>             
                            <td>
                                ...
                                echo anchor('transaction/download_pdf/' . $querys->id, $querys->id);
                                ?>
                            </td>
