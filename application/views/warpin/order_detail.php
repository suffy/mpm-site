                ...
                <table id="multi-colum-dt" class="table table-columned">
                    <thead>
                        <tr>
                            ...
                            <th>Status Cancel</th>
                            <th>Qty terpenuhi</th>
                            <th>Satuan terpenuhi</th>
                            <th>Qty terpenuhi Pcs</th>
                            <th>Satuan terpenuhi Pcs</th>
                            <th>HNA Pcs</th>
                            <th>Total Price</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <?php foreach ($get_warpin_order_detail as $key) : ?>
                            <tr>
                                ...
                                <td><input type="text" name="total_qty_pemenuhan[]" class="form-control" value=""></td>
                                <td>
                                    <select name="satuan_pemenuhan[]" class="form-control">
                                        <option value=""> - Pilih Satuan - </option>
                                        <option value="DUS">DUS</option>
                                        <option value="BOTOL">BOTOL</option>
                                    </select>                                  
                                </td>
                                <td><input type="text" name="total_qty_pemenuhan_pcs[]" class="form-control" value=""></td>
                                <td>
                                    <select name="satuan_pemenuhan_pcs[]" class="form-control">
                                        <option value=""> - Pilih Satuan - </option>
                                        <option value="DUS">DUS</option>
                                        <option value="BOTOL">BOTOL</option>
                                ...
                                <td><input type="text" name="hna_pcs[]" class="form-control" value=""></td>
                                <td><input type="text" name="total_harga_pcs[]" class="form-control" value=""></td>
                                <input type="hidden" name="total_qty_order[]" class="form-control" value="<?php echo $key->product_quantity; ?>">
                                <input type="hidden" name="satuan_order[]" class="form-control" value="<?php echo $key->uom; ?>">
        ...
        <div class="row">
            <div class="col-md-3">
                <select name="status_transaksi_manual" class="form-control">
                    ...
                    <option value="6">Terkirim / Selesai</option>
    ...
    <div class="card-header">
        <div class="card-block">
            <div class="title">
                <div class="row">
                    <div class="col">
                        <h4>Log post from <i>"SDS to MPM"</i></h4>
                    </div>
                </div>
            </div>
                ...
                <table id="table-listorder" class="table table-columned">
                    <thead>
                        <tr>
                            ...
                            <th width="1">qty pemenuhan</th>
                            <th width="1">qty pemenuhan pcs</th>
                            <th width="1">hna</th>
                        ...
                        <?php foreach ($get_erp_order_status as $key) : ?>
                            ...
                            <?php 
                                if ($key->status_cancel == 1) {
                                    $bg_aktif = 'style="background-color: crimson; color:white"';
                                } else{
                                    $bg_aktif = '';
                                }
                            ?>
                            ...
                            <tr>
                                ...
                                <td <?= $bg_aktif; ?>><?php echo $key->total_qty_pemenuhan; ?></td>
                                <td <?= $bg_aktif; ?>><?php echo $key->total_qty_pemenuhan_pcs; ?></td>
