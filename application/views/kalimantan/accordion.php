...
<div class="container-fluid">
    ...
    <div class="row mt-3">
        <div class="col-md-12">
            <p>
                <button class="btn btn-submit-black" type="button" data-toggle="collapse" data-target=".multi-collapse"
                    aria-expanded="false" aria-controls="multiCollapseExample1 multiCollapseExample2">Lihat Detail
                    Program</button>

                <!-- <button class="btn btn-submit" type="button" data-toggle="collapse" data-target=".multi-collapse-history" aria-expanded="false" aria-controls="multiCollapseExample1 multiCollapseExample2">Form Input Produk</button>
                
                <button class="btn btn-warning" type="button" data-toggle="collapse" data-target=".multi-collapse-dokumentasi" aria-expanded="false" aria-controls="multiCollapseExample3 multiCollapseExample3">Import Produk</button> -->
            </p>
                        ...
                        <div class="card card-body">
                            <div class="container">
                                ...
                                <div class="row mt-1">
                                    ...
                                    <div class="col-md-9">
                                        <label class="form-control" readonly><?= $get_pengajuan->row()->tipe ?></label>
                                    </div>
                                </div>
                                <div class="row mt-1">
                                    <div class="col-md-3">
                                ...
                                <div class="row mt-1">
                                    ...
                                    <div class="col-md-9">
                                        <label class="form-control" readonly><?= $get_pengajuan->row()->nama ?></label>
                                    </div>
                                </div>
                                <div class="row mt-1">
                                    <div class="col-md-3">
                                ...
                                <div class="row mt-1">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <a
                                            href="<?= base_url() . 'assets/file/retur/' . $get_pengajuan->row()->file ?>">
                                            <label class="form-control"
                                                readonly><?= $get_pengajuan->row()->file ?></label></a>
                                        <?php
                                        } else { ?>
                                ...
                                <div class="row mt-1">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <a
                                            ...
                                            <label
                                                class="form-control"><?= $get_pengajuan->row()->file_principal_ho ?></label></a>
                                        <?php
                                        } else { ?>
                                        <label class="form-control"><i>user tidak melampirkan
                                ...
                                <div class="row mt-1">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <a
                                            ...
                                            <!-- <input type="text" value="<?= $get_pengajuan->row()->file_pengiriman ?>" class="form-control"> -->
                                            <label
                                                class="form-control"><?= $get_pengajuan->row()->file_pengiriman ?></label></a>
                                        <?php
                                        } else { ?>
                                        <label class="form-control"><i>user tidak melampirkan
                                ...
                                <div class="row mt-1">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <a
                                            ...
                                            <!-- <input type="text" value="<?= $get_pengajuan->row()->file_terima_barang ?>" class="form-control"> -->
                                            <label
                                                class="form-control"><?= $get_pengajuan->row()->file_terima_barang ?></label></a>
                                        <?php
                                        } else { ?>
                                        <label class="form-control"><i>user tidak melampirkan
                                ...
                                <div class="row mt-1">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <a
                                            ...
                                            <label
                                                class="form-control"><?= $get_pengajuan->row()->file_pemusnahan ?></label></a>
                                        <?php
                                        } else { ?>
                                        <label class="form-control"><i>user tidak melampirkan
                                ...
                                <div class="row mt-1">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <a
                                            ...
                                            <label
                                                class="form-control"><?= $get_pengajuan->row()->foto_pemusnahan_1 ?></label></a>
                                        <?php
                                        } else { ?>
                                        <label class="form-control"><i>user tidak melampirkan
                                ...
                                <div class="row mt-1">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <a
                                            ...
                                            <label
                                                class="form-control"><?= $get_pengajuan->row()->foto_pemusnahan_2 ?></label></a>
                                        <?php
                                        } else { ?>
                                        <label class="form-control"><i>user tidak melampirkan foto pemusnahan
                                                2</i></label>
                                        <?php
                                        }
                                        ?>
                                        ...
                                        <?php 
                                            if ($get_pengajuan->row()->tanggal_terima_barang) { 
                                                ...
                                                <a href="<?= base_url().'management_inventory/generate_pdf_spbr/'.$signature.'/'.str_replace('/', '-', $get_pengajuan->row()->no_terima_barang) ?>"
                                                    class="btn btn-submit-black mt-2" target="_blank">SPBR (persetujuan)</a>
                                                <a href="<?= base_url().'management_inventory/generate_pdf_spbr_group_kodeprod/'.$signature.'/'.str_replace('/', '-', $get_pengajuan->row()->no_terima_barang) ?>"
                                                    class="btn btn-submit-black mt-2" target="_blank">SPBR summary
                                                    (persetujuan)</a>
                                                <a href="<?= base_url().'management_inventory/generate_pdf_spbr_penolakan/'.$signature.'/'.str_replace('/', '-', $get_pengajuan->row()->no_terima_barang) ?>"
                                                    class="btn btn-submit-black mt-2" target="_blank">STBR (penolakan)</a>
                                                <a href="<?= base_url().'management_inventory/generate_pdf_spbr_penolakan_group_kodeprod/'.$signature.'/'.str_replace('/', '-', $get_pengajuan->row()->no_terima_barang) ?>"
                                                    class="btn btn-submit-black mt-2" target="_blank">STBR summary
                                                    (penolakan)</a>
                                        <?php }
                                                ...
                                                <a href="<?= base_url().'management_inventory/generate_pdf_spbr_pemusnahan/'.$signature.'/'.str_replace('/', '-', $get_pengajuan->row()->no_terima_barang) ?>"
                                                    class="btn btn-submit-black mt-2" target="_blank">SPBR (pemusnahan)</a>
