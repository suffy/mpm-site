    ...
    <div class="row">   
        ...
        <div class="col-xs-4">
            <div class="input-group input-daterange">               
                ...
                <a href="<?php echo base_url()."all_po/export_po_outstanding_intrafood" ?> " class="btn btn-success" role="button" target="blank">Export Proses to Csv
                </a>
    ...
    <div class="row"> 
        <div class="col-xs-12">
            ...
            <tr>                
                ...
                <th width='10%'><center>QtyPemenuhan</th>
                <th width='10%'><center>TanggalKirim</th>
                <th width='10%'><center>TanggalTiba</th>
                <th width='10%'><center>Fulfilment</th>
                <th width='10%'><center>Leadtime</th>
            </tr>
            </thead>
            <tbody>
            ...
            <tr>          
                ...
                <td><font size="2"><?php echo number_format($x->tanggal_kirim); ?></td>
                <td><font size="2"><?php echo number_format($x->tanggal_tiba); ?></td>
                <td><font size="2"><?php echo number_format($x->fulfilment); ?></td>
                <td><font size="2"><?php echo number_format($x->leadtime); ?></td>
            </tr>
            <?php endforeach; ?>
