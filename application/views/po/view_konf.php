                ...
                <table id="myTable" class="table table-striped table-bordered table-hover">     
                    <thead>
                        <tr>                
                            ...
                            <th width="5%"><font size="2px">Volume (m3)</th>
                    ...
                    <tbody>
                        ...
                        <tr>        
                            ...
                            <td width="1"><font size="2px"><?php echo number_format($query->subberat, 1); ?></td>
                            <td width="1"><font size="2px"><?php echo number_format($query->subvolume,3); ?></td>    
                    ...
                    <th width="1" font size="2px">
                        <?php echo number_format($proses->tot_berat,1); ?></th>
                    <th width="1" font size="2px">
                        <?php echo number_format($proses->tot_volume,3); ?></th>
                    <th></th>
                    <th colspan="2"></th>
                    <?php endforeach; ?>
                    </tfoot>
