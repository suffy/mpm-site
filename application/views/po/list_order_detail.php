...
<html>
    ...
    <?php 
        foreach($header as $x){
            ...
            $alamat_override = $x->alamat_kirim;
            $nopo = $x->nopo;
            $tglpesan = $x->tglpesan;
            $tglpo = $x->tglpo;
            $tipe = $x->tipe;
    ...
    <div class="row">        
        ...
        <div class="col-xs-4">
            <a href="<?php echo base_url()."all_po/generate_new/".$id."/".$supp."/".$userid  ?> " class="btn btn-default" role="button">Generate No PO</a> 
        </div>
        ...
        <div class="col-xs-4">
            <textarea class="form-control" rows="6" name="alamat_kirim" required readonly><?php echo $alamat_kirim ?></textarea>
        </div>
        ...
        <div class="col-xs-4">
            <textarea class="form-control" rows="6" name="alamat_override" required readonly><?php echo $alamat_override ?></textarea>
        </div>
        ...
        <div class="col-xs-4">
            <a href="<?php echo base_url()."all_po/override_alamat/".$id."/".$supp."/".$userid  ?> " class="btn btn-success" role="button">Override alamat</a> 
        ...
        if ($lock == '1' && $nopo != null) { ?>
            ...
            <a href="<?php echo base_url()."all_po/proses_po_to_finance/".$id."/".$supp."/".$userid ?> " class="btn btn-success" role="button" disabled>Kirim ke Finance</a> 
            <a href="<?php echo base_url()."all_po/unlock_finance/".$id."/".$supp."/".$userid ?> " class="btn btn-danger" role="button" disabled>Unlock Status Finance Approval</a> 
            <!-- <a href="<?php echo base_url()."all_po/proses_po_to_finance/".$id."/".$supp."/".$userid ?> " class="btn btn-info" role="button">Email Permintaan Approval</a> -->

        <?php
        }else{ ?>

            <a href="<?php echo base_url()."all_po/proses_doi/".$id."/".$tahun."/".$bulan."/".$tglpesan."/".$kode."/".$supp."/".$userid ?> " class="btn btn-warning" role="button">Analisa DOI</a> 
            <a href="<?php echo base_url()."all_po/proses_po_to_finance/".$id."/".$supp."/".$userid ?> " class="btn btn-success" role="button">Kirim ke Finance</a> 
            <a href="<?php echo base_url()."all_po/unlock_finance/".$id."/".$supp."/".$userid ?> " class="btn btn-danger" role="button">Unlock Status Finance Approval</a> 
            <!-- <a href="<?php echo base_url()."all_po/proses_po_to_finance/".$id."/".$supp."/".$userid ?> " class="btn btn-info" role="button">Email Permintaan Approval</a> -->
                        ...
                        <tr>        
                            ...
                            <td><center>
                                ...
                                <?php
                                    ...
                                    echo anchor('all_po/delete_product/' . $id . '/' . $x->id_kodeprod. '/' . $x->supp. '/' . $userid, ' ',array('class' => 'glyphicon glyphicon-remove','onclick'=>'return confirm(\'Are you sure?\')'));
                                }
                            ?>
                            </td>
                        </tr>
