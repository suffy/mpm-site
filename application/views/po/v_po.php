            ...
            <table id="myTable" class="table table-striped table-bordered table-hover">     
                    <thead>
                        <tr>                
                            ...
                            <th><font size="2px">Alamat Kirim</th>           
                            <th><font size="2px">Jenis PO</th>
                            <th><font size="2px">Tanggal PO</th>
                            <th><font size="2px">Tanggal Kirim</th>
                    ...
                    <tbody>
                        ...
                        <tr>        
                            ...
                            <td><font size="2px"><?php echo $po->tgl_kirim; ?></td>
                            <td><font size="2px"><?php echo anchor('all_po/update_tgl/' . $po->id, 'update', ['class' => 'btn btn-primary btn-sm']);?></td>
                        </tr>
                    <?php endforeach; ?>
