...
class Upload_stock extends MY_Controller
{
    function upload_stock()
    {
        ...
        $this->load->model(array('M_menu','model_outlet_transaksi', 'model_upload_stock'));
        $this->load->database();
    }
    ...
    public function dashboard()
    {
        $data = [
            ...
            'title'     => 'UPLOAD STOCK DP',
            'url'       => 'upload_stock/proses_dashboard',
            'url_keluar' => 'upload_stock/proses_dashboard_keluar',
        ...
        $this->load->view('upload_stock/dashboard', $data);
