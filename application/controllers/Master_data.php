...
class Master_data extends MY_Controller
{
    ...
    public function pareto_mt()
    {
        ...
        foreach ($tahun as $y) {
            ...
            // die;
            $insert = $this->model_master_data->insert_master_outlet($y, $this->created_at);
            // die;
        
            // omzet by outlet
            $truncate = $this->model_master_data->truncate_pareto_mt("pareto_omzet_outlet_",$y);
            $insert = $this->model_master_data->insert_omzet_outlet($y, $this->created_at);

            // omzet by outlet add sub_group
            $truncate = $this->model_master_data->truncate_pareto_mt("pareto_omzet_outlet_sub_group_",$y);
            $insert = $this->model_master_data->insert_omzet_outlet_sub_group($y, $this->created_at);
