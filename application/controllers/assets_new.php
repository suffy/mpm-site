...
class Assets_new extends MY_Controller
{
    ...
    public function detail_mutasi()
    {
        ...
        $no_po = $kode.'/'.$no;
        $id_ref_barang = $this->uri->segment('5');
        // var_dump($no_po);die;
        $data = [
            'id' => $this->session->userdata('id'),
            'url' => 'assets_new/simpan_penyerahan_asset/',
            ...
            'get_label' => $this->M_menu->get_label(),
            'no_po' => $no_po,
            'id_ref_barang' => $id_ref_barang,
            'user' => $this->M_assets->getUser()->result(),
            'history' => $this->M_assets->get_history_penyerahan_asset($no_po, $id_ref_barang),
    ...
    public function simpan_penyerahan_asset()
    {
        ...
        if ($no_po === 'automatic') {
            ...
            $id_ref_barang = $this->input->post('id_ref_barang');
            ...
            $this->db->where('id_ref_barang', $id_ref_barang);
            $this->db->update('site.t_asset_penyerahan_asset'); 
            $this->M_assets->simpan('site.t_asset_penyerahan_asset',$data);
            redirect("assets_new/detail_mutasi/$no_po/$id_ref_barang");
        }        
    }
    // ========================================================================================================================
    // =================================================== Input Asset ========================================================
