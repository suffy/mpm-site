    ...
    public function repl($state=null,$key=0,$id='',$init='')
    {
        switch($state)
        {
            ...
            case 'show_temp':
            {
                ...
                $selectfi="select if(kodeprod='010074','010020',
                                  ...
                                  IF(kodeprod='010006','010082',
                                    ...
                                    IF(kodeprod='010076','010058',kodeprod)))))))kodeprod,sum(banyak) as  average from data".date('Y',strtotime($date[1])).".fi
                ...
                {
                    $selectfi.=" union all
                        select if(kodeprod='010074','010020',IF(kodeprod='010006','010082',
                            IF(kodeprod='010007','010082',
                            IF(kodeprod='010008','010083',
                            IF(kodeprod='010009','010083',IF(kodeprod='010075','010057',IF(kodeprod='010076','010058',kodeprod)))))))kodeprod,sum(banyak) as  average from data".date('Y',strtotime($date[$i])).".fi
                        where nocab=".'"'.$dp.'"'." and kode_type<>'TD' and bulan =".date('m',strtotime($date[$i]))." group by kodeprod
                        ";
                }
                $selectri="select if(kodeprod='010074','010020',IF(kodeprod='010006','010082',
                            IF(kodeprod='010007','010082',
                            IF(kodeprod='010008','010083',
                            IF(kodeprod='010009','010083',IF(kodeprod='010075','010057',IF(kodeprod='010076','010058',kodeprod)))))))kodeprod,sum(banyak) as  average from data".date('Y',strtotime($date[1])).".ri
                ...
                for($i=2;$i<$counter;$i++)
                {
                    $selectri.=" union all
                        select if(kodeprod='010074','010020',IF(kodeprod='010006','010082',
                            IF(kodeprod='010007','010082',
                            IF(kodeprod='010008','010083',
                            IF(kodeprod='010009','010083',IF(kodeprod='010075','010057',IF(kodeprod='010076','010058',kodeprod)))))))kodeprod,sum(banyak) as  average from data".date('Y',strtotime($date[$i])).".ri
    ...
    public function po($state=null,$key=0,$id='',$init='')
    {
        switch($state)
        {
            ...
            case 'email':
            {
                ...
                if($cekSupp == '002')
                {
                    echo "<h> Sedang Proses Pengecekan. Untuk Sementara fitur email di nonaktifkan !! <br><br>";
                    ...
                    $lista = $this->getEmail(substr($id,0,-3)).","."rikisugiarto@gmail.com";
                    //echo $lista;
                    ...
                    $this->email->cc($hasil);//'henryjoseph760@gmail.com','herman_oscar@yahoo.com');
