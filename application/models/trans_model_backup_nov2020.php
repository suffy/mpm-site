...
class Trans_model extends CI_Model
{
    ...
    public function list_product_supp_retur($supp)
    {
            ...
            return $this->db->query('
                ...
                from mpm.tabprod a LEFT JOIN mpm.tabprod b on a.KODEPROD = b.KODEPROD
                where a.supp ="'.$supp.'"
                ORDER BY b.namaprod
                ');
    ...
    public function spk($state='show_supp',$key=null,$id=null)
    {
        switch(strtolower($state))
        {
            ...
            case 'save'://purchase
            {
                ...
                $row=$query->row();
                $sql='insert into mpm.po_detail(id_ref,supp,kodeprod,namaprod,banyak,banyak_karton,harga,kode_prc,userid) select '.$row->id.',supp,kodeprod,namaprod,sum(banyak),sum(banyak_karton),sum(harga),kode_prc,userid from mpm.po_temp where userid='.$id.' and supp='.$supp.' group by kodeprod';
                $this->db->query($sql);
                ...
                switch($report){
                    ...
                    case 3:
                        ...
                        */
                        ...
                        case 4:                        
                            $sql="
                            select 	a.nodo_beli as no_retur, a.noseri_beli as no_faktur_pajak, a.tgldo, a.company,
                            ...
                            from mpm.trans a inner JOIN mpm.trans_detail b
                                        on a.id = b.id_ref
                            where date_format(tglbuat,'%m%Y')='".$tanggal."'
        ...
        switch($state)
        {
            ...
            case 'email':
            {
                ...
                foreach ($hasil->result() as $row) 
                {
                    ...
                    fputcsv($file, array($nopo,$customerid,$company,$alamat,$ship_to,$kodeprod,$dl_kodeprod,$dl_description,$namaprod, $banyak, $h_beli_mpm));
                }
            ...
            case 'manual_save':
            {
                ...
                $sql='insert into mpm.po_detail(id_ref,supp,kodeprod,namaprod,banyak,harga,kode_prc,userid) select '.$row->id.',supp,kodeprod,namaprod,sum(banyak),harga,kode_prc,userid from mpm.po_temp where userid='.$userid.' and supp='.$supp.' group by kodeprod';
                $this->db->query($sql);
