...
class Model_master_data extends CI_Model 
{
    ...
    public function get_tabcomp_by_kode_comp($kode_comp)
    {
        ...
        {
            $query = "
                select a.site_code, a.branch_name, a.nama_comp, a.site_code as kode_comp, a.site_code, a.sub
                from site.master_site a
                where a.site_code = '$kode_comp'
            ";
        }else{
            $query = "
    ...
    public function cek_product_penta($id_log, $bulan)
    {
        ...
        foreach ($proses->result() as $a) {
            ...
            if ($kode_produk == $kode_produk_master && $inventory_item_id == $inventory_item_id_master && $item_id_vend == $item_id_vend_master) 
            {
                // echo "data sama";
            }else{
    ...
    {   
        ...
        $query = "
            ...
            FROM    site.absensi_master_full_weekend a left join mpm.`user` b 
                        on a.userid = b.userid_absensi
            where 	year(a.tanggal) = '$tahun' and month(a.tanggal) = '$bulan'  and a.userid in (51,92,44)
            GROUP BY date(a.tanggal), a.userid
