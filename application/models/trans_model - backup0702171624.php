    ...
    public function repl($state=null,$key=0,$id='',$init='')
    {
        switch($state)
        {
            ...
            case 'show_temp':
            {
                ...
                echo "customerid /ID di tabel user : ".$customerid."<br>";
                echo "cycle / bulan periode : ".$cycle."<br>";
                echo "supp : ".$supp."<br>";
                echo "counter / Cycle + 1 : ".$counter."<br>";
                ...
                */
                ...
                $cari_group_repl= "
                    select group_repl,status_group_repl from mpm.tbl_tabcomp_new where kode_comp =".$kode_comp."
                ";
