...
class Model_outlet extends CI_Model {
    ...
    public function list_product()
    {
        ...
        // KHUSUS pak mardo, pak endang, pak qosim
        elseif ($supp=='001' and ($id =='374' or $id =='418' or $id =='419')) {
             $sql = "
                select *
                FROM
                (
    ...
    public function outlet_dp($dataSegment,$kodeprod=null){
        ...
        */
            ...
            $this->db->where('concat(kode_comp,nocab) = '.'"'.$naper.'"');
            $this->db->where('status = 1');
            $query = $this->db->get('mpm.tbl_tabcomp_new');
            foreach ($query->result() as $row) {
                $kode_comp = $row->kode_comp;
                //echo "kode_comp : ".$kode_comp."<br />";
            }
            //echo "napernya : ".$naper."<br>";
            //echo "kode comp nya : ".$kode_comp."<br>";
