...
class Model_proses_data extends CI_Model {
    ...
    public function view_upload_all_dp(){
        ...
        //$this->db->where('userid = '.'"'.$userid.'"');
        $this->db->order_by("id", "desc"); 
        $hasil = $this->db->get('mpm.upload', 1000);
    ...
    public function proses_data_omzet_all_dp($datacontroller){
        ...
        */
        ...
        $ddl1 = array('fi','fh','ri','rh','st','t_sales_rrk');
        $ddl2 = array('tblang','tbkota','m_sales_salsman_ob');
        $ddl3 = array('tabsupp','tabsales','tabsalur','tabtype','norayon','tabfaktr','tabgrupp');  
    ...
    public function proses_data($data){
        ...
        $ddl2 = array('tblang','tbkota','m_customer_creditlimit_prinsipal');
        $ddl3 = array('tabsupp','tabsales','tabsalur','tabtype','norayon','tabfaktr','tabgrupp');        
        $load="LOAD DATA INFILE 'C:/xampp/htdocs/cisk/assets/uploads/unzip/".$nocab."/";
            foreach($ddl1 as $ddl)
            {
            ...
            // // $this->db->query($sql_upd);
            // $delete00fi = "delete from db_upload.fi where (left(kodeprod,2)='00' or left(kodeprod,2)='80' or left(kodeprod,2)='90')";
            // $this->db->query($delete00fi);
            // $delete00ri = "delete from db_upload.ri where (left(kodeprod,2)='00' or left(kodeprod,2)='80' or left(kodeprod,2)='90')";
            // $this->db->query($delete00ri);
    ...
    public function submit_manual($data)
    {
        $nocab = $data['nocab'];
        $tahun = $data['tahun'];
        $tahun_stock = substr($tahun,2,2);
