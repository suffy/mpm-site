    ...
    private function getHarga($kode=null,$user=null)
    {
        ...
        switch($level)
        {
            case 4:
                ...
                $query = $this->db->get('mpm.tbl_tabcomp_new',1);
        ...
        switch($state)
        {
            ...
            case 'email2':
            {
                //echo "test";
                    ...
                    //echo "<br><br><br><br><br><br><br>email2";   
                    /*echo "<pre>";
                    echo "key : ";
                    print_r($key);
                    echo "<br>id : ";
                    ...
                    */$this->email_config_piutang();
                    ...
                    $this->email->to($this->getEmailFinance(substr($id,1)));                    
                    //echo "email to nya : <br>";
                    //print_r($this->getEmailFinance(substr($id,1)));
                    //$this->email->to("suffy.yanuar@gmail.com");
                    
                    $list = array('nanita7974@gmail.com','hwiryanto@gmail.com','herman_oscar@yahoo.com');
...
order by a.group_descr
        ...
        switch($state)
        {
            ...
            case 'show_temp':
            {
                ...
                */
                ...
                $query = $this->db->get('db_repl.t_bulan');
                foreach ($query->result() as $row) {
                    $hr = $row->hari_kerja;
                    echo "hr : ".$hr."<br>";
                }

                //menghapus db_po.t_temp_repl
                $sql = "delete from db_po.t_temp_repl where userid = '$userid'";
                $query=$this->db->query($sql);


                $month = '12';
                $y = (int)$month - (int)$cycle ;
                echo "y : ".$y."<br>";
                ...
                if($y<=0){
                    ...
                    for ($i=(int)$month-1; $i>(int)$y ; $i--) { 
                    $x[] = $i.',';
                    }$bulan = implode($x).(int)$y;
                    echo "bulan : ".$bulan;

                    //menghitung pesanan replineshment

                    $sql = "
                        insert into db_po.t_temp_repl
                        select	nocab,a.kodeprod, a.avg, a.sl, a.hrkerja, a.stdsl, a.stock_akhir, a.index_stock, a.sales_lalu, a.h_dp, a.karton, a.auto_repl1, a.auto_repl2,
                        ...
                        from
                        (
                            select	nocab,a.kodeprod, a.avg, a.sl, a.hrkerja, a.stdsl, a.stock_akhir, ((stock_akhir / avg) * hrkerja) as index_stock, 
                                    a.sales_lalu, (stock_akhir - stdsl) as auto_repl1, (stock_akhir - stdsl - sales_lalu) as auto_repl2,
                                    karton, kode_prc, h_dp            
                            from
                            (
                                select  nocab,a.kodeprod,cast(sum(unit)/$cycle as unsigned) as avg,
                                        b.sl, $hr as hrkerja, (cast(sum(unit)/$cycle as unsigned) / $hr)*b.sl as stdsl,
                                        c.stok as stock_akhir, d.sales_lalu
                                from
                                (
                                    select nocab,kodeprod,sum(banyak) as unit
                                    from data$year.fi
                                ...
                                (
                                    ...
                                    from data$year.st a
                                    where nocab = '$dp' and substr(bulan, 3) = $month
                                    GROUP BY KODEPROD
    ...
    public function retur($state='show_supp',$key=null,$id=null,$init=null)
    {
        switch(strtolower($state))
        {
            ...
            {
                echo "<pre>";
                echo "<br><br><br><br>aaaaaaaaaaaaaaaaaaaaa";
                //print_r($post['kodeprod']);
                echo "</pre>";
        ...
        switch($state)
        {
            ...
            case 'email':
            {
                ...
                $sql = "
                    ...
                    where a.id = '$key' and a.deleted = 0 and b.deleted = 0
                ";
                ...
                foreach ($hasil->result() as $row) 
                {
                    ...
                    $banyak = $row->banyak;
                    fputcsv($file, array($nopo,$customerid,$company,$alamat,$ship_to,$kodeprod,$dl_kodeprod,$dl_description,$namaprod, $banyak));
                }
                ...
                if($cekSupp == '002')
                {
                    ...
                    $lista = $this->getEmail(substr($id,0,-3)).","."rikisugiarto@gmail.com,nat.talia73@gmail.com,windaamelia078@gmail.com";
                ...
                elseif($cekSupp == '005'){
                    ...
                    $lista = $this->getEmail(substr($id,0,-3)).","."netty.herawati@ultrasakti.com,desy.suryani@ultrasakti.com";
                    $hasil = explode(',', $lista);
                    ...
                    unlink('./assets/po/'.$filename.'.pdf');
                    //redirect('trans/po/show');
                    redirect('all_po/export_po_us/'.$key);
                ...
                else
                {
                    ...
                    $lista = $this->getEmail(substr($id,0,-3));
            ...
            case 'show_detail':
            {
                ...
                select a.userid, a.supp, a.nopo, a.tglpo, a.nodo, a.tgldo, a.tglpesan,
                     ...
                     b.harga, b.kode_prc, b.userid, b.deleted,
