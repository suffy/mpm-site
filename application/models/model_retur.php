...
class Model_retur extends CI_Model 
{
    ...
    public function get_id_by_signature($signature , $versi = 0){
    ...
    public function log_retur($signature, $versi = 0)
    {
        if ($signature == null) {
            $params = "";
        }else{
        ...
        if ($versi == 2) {
            $select = "a.*, a.tanggal_terima_barang as tanggal_terima, a.no_terima_barang as no_terima, a.file_terima_barang as file_terima, if(b.branch_name is null, d.name, b.branch_name) as branch_name, 
