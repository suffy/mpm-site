...
class Trans_model extends CI_Model
{
    ...
    public function Trans_model()
    {
        ...
        $this->load->model(array('model_relokasi'));
    ...
    {
        return $this->db->query('
            select	a.supp,a.kodeprod,a.namaprod,a.kode_prc,a.grupprod, a.grup, a.isisatuan,a.h_dp, a.berat, a.volume
            from		mpm.tabprod a
...
order by a.group_descr
            ...
            case 'download':
            {
                ...
                switch($this->input->post('format'))
                {
                    ...
                    case 11:
                    {
                        ...
                        $tahun=substr($this->input->post('tanggal'),0,4);
                        delete_files('./assets/faktur');
                        $sql='select id,nodo_beli,supp from mpm.trans where supp=002 and month(tglbuat)=? and deleted=0 and year(tglbuat)=?' ;
                        $query=$this->db->query($sql,array($bulan,$tahun));
                        ...
                        if($query->num_rows() > 0)
                        {
                            ...
                            $db='mpm';
                            $this->load->library('PHPJasperXML');
                            $xml = simplexml_load_file("assets/report/report_retur_supp_non_tdt_marguna.jrxml");
                    ...
                    case 12:
                    {
                        ...
                        $tahun=substr($this->input->post('tanggal'),0,4);
                        delete_files('./assets/faktur');
                        $sql='select id,nodo_beli,supp from mpm.trans where supp=015 and month(tglbuat)=? and deleted=0 and year(tglbuat)=?' ;
                        $query=$this->db->query($sql,array($bulan,$tahun));
                        ...
                        if($query->num_rows() > 0)
                        {
                            ...
                            $db='mpm';
                            $this->load->library('PHPJasperXML');
                            $xml = simplexml_load_file("assets/report/report_retur_supp_non_tdt_mdj.jrxml");
                    ...
                    case 13:
                    {
                        ...
                        $tahun=substr($this->input->post('tanggal'),0,4);
                        delete_files('./assets/faktur');
                        $sql='select id,nodo_beli,supp from mpm.trans where supp=023 and month(tglbuat)=? and deleted=0 and year(tglbuat)=?' ;
                        $query=$this->db->query($sql,array($bulan,$tahun));
                        ...
                        if($query->num_rows() > 0)
                        {
                            ...
                            $db='mpm';
                            $this->load->library('PHPJasperXML');
                            $xml = simplexml_load_file("assets/report/report_retur_supp_non_tdt_kojiesan.jrxml");
                    ...
                    case 14:
                    {
                        ...
                        $tahun=substr($this->input->post('tanggal'),0,4);
                        delete_files('./assets/faktur');
                        $sql='select id,nodo_beli,supp from mpm.trans where supp=012 and month(tglbuat)=? and deleted=0 and year(tglbuat)=?' ;
                        $query=$this->db->query($sql,array($bulan,$tahun));
                        ...
                        if($query->num_rows() > 0)
                        {
                            ...
                            $db='mpm';
                            $this->load->library('PHPJasperXML');
                            $xml = simplexml_load_file("assets/report/report_retur_supp_non_tdt_intrafood.jrxml");
                    ...
                    case 15:
                    {
                        ...
                        $tahun=substr($this->input->post('tanggal'),0,4);
                        delete_files('./assets/faktur');
                        $sql='select id,nodo_beli,supp from mpm.trans where supp=025 and month(tglbuat)=? and deleted=0 and year(tglbuat)=?' ;
                        $query=$this->db->query($sql,array($bulan,$tahun));
                        ...
                        if($query->num_rows() > 0)
                        {
                            ...
                            $db='mpm';
                            $this->load->library('PHPJasperXML');
                            $xml = simplexml_load_file("assets/report/report_retur_supp_non_tdt_gdp.jrxml");
    ...
    public function retur($state='show_supp',$key=null,$id=null,$init=null)
    {
        switch(strtolower($state))
        {
                ...
                switch($report){
                    ...
                    case 3:
                        ...
                        */
                        ...
                        case 4:
                            $sql="
                            select 	if(a.nodo_beli = '', 'null', a.nodo_beli) as no_retur, a.noseri_beli as no_faktur_pajak, a.tgldo, a.tgldo_beli, a.tgl_beli, a.nopo, a.company,
                                    b.kodeprod, b.namaprod, abs(b.banyak) as qty, b.harga_beli, (abs(b.banyak) * b.harga_beli) as harga_jual_bkp, format((abs(b.banyak) * b.harga_beli),2)  as harga_jual_bkp_1, b.diskon_beli
                            from mpm.trans a inner JOIN mpm.trans_detail b
                                        on a.id = b.id_ref
                            where date_format(tglbuat,'%m%Y')='".$tanggal."' and a.supp = 005 and a.deleted = 0 and b.deleted = 0
                        ...
                        case 6:
                            ...
                            select 	a.tglbuat,a.nopo as nott,a.npwp,a.nama_wp,a.nodo,a.tglfaktur_beli,
                                    a.noseri,a.dpp,a.ppn,(a.dpp+a.ppn)tot_ret_client,a.supp,
                                    b.npwp as npwp_supp,b.namasupp,a.nodo_beli,a.tglfaktur,
                                    a.noseri_beli,a.kodeprod, a.namaprod, a.diskon_beli, a.harga_beli, qty,
                                    format(a.dpp_beli,0) as dpp_beli,
                                    /*format(a.ppn_beli,0) as ppn_beli,*/
                                    format(a.ppn_beli,0) as ppn_beli,
                                    format((a.dpp_beli+a.ppn_beli),0) as tot_ret_supp
                            ...
                            (
                                select 	npwp,nama_wp,a.supp,noseri,noseri_beli,nodo,nopo,
                                        ...
                                        format(sum((abs(banyak)*harga)-(abs(banyak)*harga*diskon/100)),2) as dpp,
                                        /*format(sum((banyak*harga_beli)-(banyak*harga_beli*diskon_beli/100)),0) as dpp_beli,*/
                                        sum((banyak*harga_beli*-1)-(banyak*harga_beli*diskon_beli*-1/100)) as dpp_beli,
                                        format(sum((abs(banyak)*harga)-(abs(banyak)*harga*diskon/100))/10,2) as ppn,
                                        /*format(sum((banyak*harga_beli)-(banyak*harga_beli*diskon_beli/100))/10,0) as ppn_beli */
                                        sum((banyak*harga_beli*-1)-(banyak*harga_beli*diskon_beli/100*-1))/10 as ppn_beli,
                                        b.kodeprod, b.namaprod, b.diskon_beli, b.harga_beli
                                from  	mpm.trans a inner join mpm.trans_detail b
                                                        on a.id=b.id_ref
                                where 	a.deleted=0 and b.deleted=0 and date_format(tglbuat,'%m%Y')='".$tanggal."' and a.supp = 015
                        ...
                        case 7:
                            ...
                            (
                                ...
                                from  	mpm.trans a inner join mpm.trans_detail b
                                            on a.id=b.id_ref
                                where 	a.deleted=0 and b.deleted=0 and date_format(tglbuat,'%m%Y')='".$tanggal."' and a.supp = 002
                                group by a.id
                            )a inner join  mpm.tabsupp b using(supp)
                            ";
                            return to_excel($this->db->query($sql),''.$tanggal);
                        ...
                        case 8:
                            ...
                            (
                                ...
                                from  	mpm.trans a inner join mpm.trans_detail b
                                                        on a.id=b.id_ref
                                where 	a.deleted=0 and b.deleted=0 and date_format(tglbuat,'%m%Y')='".$tanggal."' and a.supp = 012
                                group by a.id, b.kodeprod
                            )a inner join  mpm.tabsupp b using(supp)
                            ";
                            return to_excel($this->db->query($sql),''.$tanggal);
                        ...
                        case 9:
                            switch ($format) {
                                case 1:
                                    $sql = "
                                    SELECT c.site_code, c.nama_comp, a.no_retur, a.nota_retur, a.no_faktur_pajak, a.tgldo, a.tgldo_beli, a.tgl_beli, a.nopo, a.company, a.supp,
                                        a.kodeprod, a.namaprod, a.qty, a.harga_beli, a.harga_jual_bkp, a.harga_jual_bkp_1
                                    FROM
                                    (
                                        select 	a.no_pengajuan as no_retur, if(a.nodo_beli = '', 'null', a.nodo_beli) as nota_retur, a.noseri_beli as no_faktur_pajak, a.tgldo, a.tgldo_beli, a.tgl_beli, a.nopo, a.company, a.supp,
                                        b.kodeprod, b.namaprod, abs(b.banyak) as qty, b.harga_beli, (abs(b.banyak) * b.harga_beli) as harga_jual_bkp, format((abs(b.banyak) * b.harga_beli),2)  as harga_jual_bkp_1, a.id_pengajuan
                                        from mpm.trans a inner JOIN mpm.trans_detail b
                                                                on a.id = b.id_ref
                                        where date_format(tglbuat,'%m%Y')='$tanggal' and a.supp = 001 and a.deleted = 0 and b.deleted = 0 and (a.versi in ('V1') or a.versi is null)
                                        ORDER BY a.tglbuat desc, a.company asc
                                    )a inner join  mpm.tabsupp b using(supp)
                                    LEFT JOIN
                                    (
                                            SELECT a.id, a.site_code, b.nama_comp
                                    ...
                                    (
                                        ...
                                        from mpm.trans a inner JOIN mpm.trans_detail b
                                                                on a.id = b.id_ref
                                        where date_format(tglbuat,'%m%Y')='$tanggal' and a.supp = 001 and a.deleted = 0 and b.deleted = 0 and (a.versi in ('V2'))
                                        ORDER BY a.tglbuat desc, a.company asc
                                    )a inner join  mpm.tabsupp b using(supp)
                                    LEFT JOIN
                                    (
                                ...
                                case 2:
                                    $sql = "
                                    SELECT a.no_pengajuan, a.supp, b.kodeprod, b.nama_produk, b.batch_number, sum(b.jumlah) as qty, b.expired_date,
                                    if(c.nama_alasan is null, b.alasan, c.nama_alasan) as alasan
                                    FROM
                                    (
                                        select 	a.id_pengajuan, a.no_pengajuan, a.supp
                                        from  	mpm.trans a 
                                        where 	a.deleted=0  and date_format(tglbuat,'%m%Y')='$tanggal' and a.supp = 001 and a.versi in('V1')
                                        group by a.id_pengajuan, a.versi
                                    )a
                                    INNER JOIN
                                    (
                                        SELECT a.*, b.namaprod as nama_produk
                                    ...
                                    )b on a.id_pengajuan = b.id_pengajuan
                                    left join 
                                    (
                                        select *
                                        from management_inventory.master_alasan a
                                        where a.supp like '%001%'
                                        group by a.kode_alasan
                                    ) c on b.alasan = c.kode_alasan
                                    GROUP BY a.id_pengajuan, b.kodeprod, b.batch_number

                                    UNION ALL

                                    SELECT a.no_pengajuan, a.supp, b.kodeprod, b.nama_produk, b.batch_number, sum(b.qty_approval) as qty, b.expired_date, 
                                    if(c.nama_alasan is null, b.alasan, c.nama_alasan) as alasan
                                    FROM
                                    (
                                        select 	a.id_pengajuan, a.no_pengajuan, a.supp
                                        from  	mpm.trans a 
                                        where 	a.deleted=0  and date_format(tglbuat,'%m%Y')='$tanggal' and a.supp = 001 and a.versi in('V2')
                                        group by a.id_pengajuan, a.versi
                                    )a
                                    INNER JOIN
                                    (
                                    ...
                                    GROUP BY a.id_pengajuan, b.kodeprod, b.batch_number
                                ";
                                return to_excel($this->db->query($sql),'Lampiran Pendukung'.$tanggal);
                                echo "<pre>";
                                print_r($sql);
                                echo "</pre>";
                                break;
            ...
            case 'print_beli':
            {
                // cek template pdf baru atau lama by tot_bruto, tot_disc, tot_dpp
                $this->db->select('tot_bruto, tot_disc, tot_dpp');
                $this->db->where('id',$key);
                $trans = $this->db->get('mpm.trans');
                if (($trans->row()->tot_bruto == null || $trans->row()->tot_bruto == 0) || ($trans->row()->tot_disc  == null || $trans->row()->tot_disc  == 0) || ($trans->row()->tot_dpp  == null || $trans->row()->tot_dpp  == 0)) {
                    $view = "assets/report/report_retur_supp.jrxml";
                } else {
                    $view = "assets/report/report_retur_supp_new.jrxml";
                }
                ...
                $db='mpm';
                $this->load->library('PHPJasperXML');
                echo$xml = simplexml_load_file("$view");
                @$this->phpjasperxml->debugsql=false;
                @$this->phpjasperxml->arrayParameter=array('nopesan'=>$key);
                @$this->phpjasperxml->xml_dismantle($xml);
            ...
            case 'print_beli_marguna':
                {
                    ...
                    $trans = $this->db->get('mpm.trans');
                    if (($trans->row()->tot_bruto == null || $trans->row()->tot_bruto == 0) || ($trans->row()->tot_disc  == null || $trans->row()->tot_disc  == 0) || ($trans->row()->tot_dpp  == null || $trans->row()->tot_dpp  == 0)) {
                        $view = "assets/report/report_retur_supp_marguna.jrxml";
                    } else {
                        $view = "assets/report/report_retur_supp_marguna_new.jrxml";
                    }
                ...
                case 'print_beli_intrafood':
                    {
                        ...
                        $trans = $this->db->get('mpm.trans');
                        if (($trans->row()->tot_bruto == null || $trans->row()->tot_bruto == 0) || ($trans->row()->tot_disc  == null || $trans->row()->tot_disc  == 0) || ($trans->row()->tot_dpp  == null || $trans->row()->tot_dpp  == 0)) {
                            $view = "assets/report/report_retur_supp_intrafood.jrxml";
                        } else {
                            $view = "assets/report/report_retur_supp_intrafood_new.jrxml";
                        }
            ...
            case 'print_beli_us':
                {
                    ...
                    $trans = $this->db->get('mpm.trans');
                    if (($trans->row()->tot_bruto == null || $trans->row()->tot_bruto == 0) || ($trans->row()->tot_disc  == null || $trans->row()->tot_disc  == 0) || ($trans->row()->tot_dpp  == null || $trans->row()->tot_dpp  == 0)) {
                        $view = "assets/report/report_retur_supp_us.jrxml";
                    } else {
                        $view = "assets/report/report_retur_supp_us_new.jrxml";
                    }
                ...
                case 'print_beli_deltomed':
                    {
                        ...
                        $trans = $this->db->get('mpm.trans');
                        if (($trans->row()->tot_bruto == null || $trans->row()->tot_bruto == 0) || ($trans->row()->tot_disc  == null || $trans->row()->tot_disc  == 0) || ($trans->row()->tot_dpp  == null || $trans->row()->tot_dpp  == 0)) {
                            $view = "assets/report/report_retur_supp_deltomed.jrxml";
                        } else {
                            $view = "assets/report/report_retur_supp_deltomed_new.jrxml";
                        }
    ...
    public function po($state=null,$key=0,$id='',$init='')
    {
        ...
        switch($state)
        {
            ...
            case 'email':
            {
                ...
                $cekSupp = substr($id,-3);
                // var_dump($cekSupp);die;

                if ($cekSupp != '012') {
                    // echo  'a';die;
                    $data = [
                        "header" => $this->pdf($id_po, $cekSupp)->row(),
                        "detail" => $this->pdf($id_po, $cekSupp)->result()
                    ];
                    // var_dump($data);die;
                    $this->mypdf->download_po('transaction/template_pdf',$data,$filename,'A4','portrait');
                }else {
                    // echo 'b';die;
                    $data = [
                        "header" => $this->pdf($id_po,$cekSupp)->row(),
                    ...
                    $this->mypdf->download_po('transaction/template_pdf_intrafood',$data,$filename,'A4','portrait');
                    // $this->mypdf->download_po('transaction/template_pdf',$data,$filename,'A4','portrait');
                }
                ...
                if($this->getTipe2($key)=='B')
                {
                    ...
                    $this->email->from('suffy@muliaputramandiri.net', 'PO Kebutuhan Stok '.date('F Y'));
                }
                else
                {
                    $this->email->from('suffy@muliaputramandiri.net', '('.$this->getTipe($key).') '.'Automatic Email Sender');
                }
                ...
                if($cekSupp == '002')
                {
                    ...
                    $lista = $this->getEmail(substr($id,0,-3)).","."windaamelia078@gmail.com,anitria728@gmail.com";
                ...
                elseif($cekSupp == '005'){
                    ...
                    $lista = $this->getEmail(substr($id,0,-3)).","."anitria728@gmail.com, tria@muliaputramandiri.com";
                    $hasil = explode(',', $lista);
                ...
                }elseif($cekSupp == '012')
                {
                    ...
                    $lista = $this->getEmail(substr($id,0,-3)).","."anitria728@gmail.com";
