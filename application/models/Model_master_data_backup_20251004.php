...
class Model_master_data extends CI_Model 
{
    ...
    {   
        ...
        $query = "
            ...
            FROM    site.absensi_master_full_weekend a left join mpm.`user` b 
                        on a.userid = b.userid_absensi
            where 	year(a.tanggal) = '$tahun' and month(a.tanggal) = '$bulan'  and a.userid in (51,92)
            GROUP BY date(a.tanggal), a.userid
    ...
    public function get_master_site_by_username($username){
        if(strlen($username) > 3){
            $params = "where a.site_code= '$username'";
        } else {
            $params = "where left(a.site_code,3) = '$username'";
        }
