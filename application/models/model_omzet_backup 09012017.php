						...
						(
								...
								(
									SELECT  naper, sub, b.NAMA_COMP,
											...
											format((total/jmlbulan),0) rata,".'"'.$supp.'"'.",".$tgl_created.",".$year."
									FROM
									(
											select  nocab, b1, b2, b3, b4, b5, b6, b7, b8, b9, b10, b11, b12, ".$id.", 
													total, 
													format(sum(xb1+xb2+xb3+xb4+xb5+xb6+xb7+xb8+xb9+xb10+xb11+xb12),0, 1) jmlbulan,t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,t12
											FROM
											(
												select  nocab,                              
						...
						from
								(
											SELECT  naper, sub, b.NAMA_COMP,
													...
													".$id.", 
													total, 
													(total/jmlbulan) as rata,".'"'.$supp.'"'.",".$tgl_created.",".$year."
											FROM
											(
													select  nocab, b1, b2, b3, b4, b5, b6, b7, b8, b9, b10, b11, b12, ".$id.", 
															total, 
