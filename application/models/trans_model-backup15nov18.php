    ...
    public function repl($state=null,$key=0,$id='',$init='')
    {
        switch($state)
        {
            ...
            case 'show_temp':
            {
                ...
                //echo "<pre>";
                //print_r($cari_kode_comp);
                //echo "</pre>";
                $kode_comp = "'".$row->username."'";
                //echo "<hr>kode_comp : ".$kode_comp."<br>";
                
                $cari_group_repl= "
                    select group_repl,status_group_repl,jawa from mpm.tbl_tabcomp_new where kode_comp =".$kode_comp."
                ";
                ...
                if ($group_repl == '') { //JIKA DP TIDAK PUNYA GROUP / NORMAL
                    ...
                    */
                    ...
                    if ($jawa == '1')
                    {
                        $harga =  '(a.h_dp-(a.h_dp*d_dp/100))';
                    }else{
                        $harga = '(a.h_luarjawa-(a.h_luarjawa*d_luarjawa/100))'; 
                    }
                        $sql="
                                        ...
                                        (
                                            ...
                                            (
                                                select  nocab,kodeprod,namaprod,substr(bulan,3) as bulan,
                                                        ...
                                                        (sales+Pinjam+kvbeli+retur_depo+tukar_klr+klr_gddepo))) as stok,sl
                                                from    data2018.st a
                                                        inner join
                                                        (
                                                            select  kodeprod,
                                            ...
                                            (
                                                SELECT a.nocab, a.productid, qty as git
                                                FROM
                                                (
                                                        ...
                                                        (
                                                                ...
                                                                where year(a.tgl_do) = $year and month(a.tgl_do) = $month and a.`status` is null and a.userid = $customerid
                ...
                $cari_dp_lain= "
                    select kode_comp,naper from mpm.tbl_tabcomp_new where group_repl =".'"'.$group_repl.'"'.
                    " and `status` = 1 group by naper ORDER BY status_group_repl desc";
