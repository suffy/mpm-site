        ...
        $sql=" select naper,nama_comp,t1,b1,t2,b2,t3,b3,t4,b4,t5,b5,t6,b6,t7,b7,t8,b8,t9,b9,t10,b10,t11,b11,t12,b12,lastupdate from(
                ...
                from
                    ...
                    select
                        ...
                        group by nocab) a
                     inner join
                     mpm.tabcomp b USING (nocab) where wilayah=2 ".$tambahDP."
                group by naper
                order by naper
                )a
                left join
    ...
    public function print_omzet($year=null,$file=null)
    {
        ...
        else if($supp=='001')
        {
            ...
            elseif ($id == '323') { //user miko, all jtm dan seluruh dp jawa timur (mlg, sdo, kdr, tga, mdu, blt)
                $wheresupp='and (kodeprod like "60%" or kodeprod like "01%" or kodeprod like "50%" or kodeprod like "70%")
                            and (nocab = 91 or nocab = 27 or nocab = 46 or nocab = 74 or nocab = 24 or nocab = 26 or nocab = 23 or nocab = 69) ';
            }
    ...
    public function print_per_product($kodeprod=null,$year=null,$file=null)
    {
        ...
        switch($uv)
        {
            ...
            case 1:$unit='tot1';break;
                    ...
                    elseif ($id == '323') { //user miko, all jtm dan seluruh dp jawa timur (mlg, sdo, kdr, tga, mdu, blt)
                        $tambahan='and nocab = 91 or nocab = 27 or nocab = 46 or nocab = 74 or nocab = 24 or nocab = 26 or nocab = 23 or nocab = 69';
                    }
    ...
    public function sales_outlet($limit=0,$offset=0,$year=null,$kodeprod=null,$dp=null,$retur=false)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if($row->new)
                {
                    //echo "ini muncul jika row->new <br>";
                    //echo "kode sales =  ".$kode_sales."<br>";
                    //echo "kode produk =  ".$kodeprod."<br>";
                    if($naper == '91')
                    {
                ...
                {
                    //echo "ini muncul jika tidak row->new <br>";
                    //echo "kode sales =  ".$kode_sales."<br>";
                    //echo "kode produk =  ".$kodeprod."<br>";
