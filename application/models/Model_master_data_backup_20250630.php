...
class Model_master_data extends CI_Model 
{
    ...
    public function get_po_outstanding_deltomed()
    {
        ...
        $this->db->query("truncate db_po_new.t_temp_report_po_update");

        // die;

        // deltomed
        $this->db->query("truncate db_po_new.t_temp_do_po_outstanding");
        $this->db->query("delete from db_po_new.t_po_outstanding_deltomed where year(tglpo) = $tahun");
        
        // us
        $this->db->query("truncate db_po_new.t_temp_do_po_outstanding_us");
        $this->db->query("delete from db_po_new.t_po_outstanding_us where year(tglpo) = $tahun");
