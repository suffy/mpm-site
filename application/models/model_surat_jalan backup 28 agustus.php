...
{    
    ...
    $grup_lang = $dataSegment['grup_lang'];
        ...
        $sql="
            ...
            (
                ...
                where   group_id<>'' and 
                        group_id<>'100159'
            )a order by grup_lang = ".'"'.$grup_lang.'" desc,'."grup_nama"
            ;
        /*
        echo "<pre>";
        print_r($sql);
    ...
    public function list_faktur($dataSegment = '')
    {
        ...
        $sql="
            select tgldokjdi, nodokjdi, a.nomor 
            from 
            (
                select  tgldokjdi, 
                ...
                where group_id = ".$grup_lang." and retur=0
            ) a inner join
            (
    ...
    public function get_faktur($dataSegment,$kode="")
    {
        ...
        { 
            ...
            $sql="
                    insert into pusat.permit_temp (id,faktur,nildok,pajak,keterangan,userid)
                    select  '',concat(right(a.no_seri_pajak,8),'/MPM/',substr(a.tanggal,6,2),substr(a.tanggal,3,2)) nomor,
                            ...
                            concat(right(a.no_seri_pajak,8),'/',substr(a.tanggal,6,2),substr(a.tanggal,3,2)) pajak, '".$keterangan."', $userid
                    FROM
                    (
    ...
    public function proses_save_surat_jalan($dataSegment){
        ...
        $id_ref=$row->id;
        $sql="
            insert into pusat.permit_detail(id_ref,faktur,nildok,pajak,keterangan) 
            select  ".$id_ref.",faktur,nildok,pajak,keterangan 
