                ...
                (
                    ...
                    (
                        ...
                        (
                            ...
                            FROM
                            (
                                select c.username, a.userid, if(b.kodeprod = '700009','010067',if(b.kodeprod = '700012', '010094', b.kodeprod)) kodeprod, sum(b.banyak) as git, month(a.tglpo) as bulan
                                ...
                                where   year(tglpo) = $year and month(tglpo) in ($git) and a.deleted = 0 and 
                                                b.deleted = 0 and (b.status_terima is null or b.status_terima = null or b.status_terima = '0') and  (a.nopo is not null and left(a.nopo,4) <> '/mpm')
                ...
                $sql = "
                    ...
                    (
                        ...
                        from   mpm.po a INNER JOIN mpm.po_detail b
                                    ...
                                    LEFT JOIN mpm.`user` c on a.userid = c.id
                        where   year(tglpo) = $year and month(tglpo) in ($git) and a.deleted = 0 and 
                                        b.deleted = 0 and (b.status_terima is null or b.status_terima = null or b.status_terima = '0') and 
                                                                                (a.nopo is not null and left(a.nopo,4) <> '/mpm')
                        GROUP BY b.kodeprod, a.userid
                        ORDER BY bulan asc, b.kodeprod
                    )a inner JOIN
                    (
