        ...
        switch($state)
        {
            ...
            case 'show':
            {
                ...
                if($query->num_rows()>0)
                {
                    ...
                    $this->table->set_template($this->tmpl);
                    $this->table->set_caption('ORDER LIST');
                    $this->table->set_heading('DELETE','NO ORDER','COMPANY','ORDER DATE', 'NO PO','PO DATE','SUPPLIER','TIPE','TOTAL VALUE','DETAIL','PRINT','EMAIL', 'NOTE ACC','CSV','US','US(rev)');
                    ...
                    foreach ($query->result() as $value)
                    {
                        ...
                        $this->table->add_row(
                                ...
                                //,'<div div style="text-align:center">'.anchor('trans/po_delete/'.$value->nopesan,img($image_properties_del),$js).'</div>'
                                //,$image_email_warn
                                ,$value->note_acc, $image_email_csv, $us, $us_rev
                                );
                    }
