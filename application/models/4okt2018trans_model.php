        ...
        switch($state)
        {
            ...
            case 'show_temp':
            {
                ...
                if ($group_repl == '') { //JIKA DP TIDAK PUNYA GROUP / NORMAL
                    ...
                    $selectfi="
                    select  if(kodeprod='010074','010020',
                            IF(kodeprod='010075','010057',
                            IF(kodeprod='010006','010082',
                            IF(kodeprod='010007','010082',
                            IF(kodeprod='010008','010083',
                            IF(kodeprod='010009','010083',                            
                            IF(kodeprod='010076','010058',kodeprod)))))))kodeprod,
                        ...
                        $sql="
                            ...
                            (
                                    ...
                                    (
                                        ...
                                        from
                                        (
                                            select  if(kodeprod='010074','010020',IF(kodeprod='010075','010057',IF(kodeprod='010076','010058',kodeprod)))kodeprod,
                                                    namaprod,
                                                    sl,
        ...
        switch($state)
        {
            ...
            case 'show':
            {
                ...
                if($query->num_rows()>0)
                {
                    ...
                    $this->table->set_template($this->tmpl);
                    $this->table->set_caption('ORDER LIST');
                    $this->table->set_heading('DELETE','NO ORDER','COMPANY','ORDER DATE', 'NO PO','PO DATE','SUPPLIER','TIPE','TOTAL VALUE','DETAIL','PRINT','EMAIL', 'NOTE ACC');
            ...
            case 'email':
            {
                ...
                $sql = "
                    select    a.nopo, d.customerid, c.company, d.alamat,  c.address as ship_to,  
                              kodeprod, namaprod, banyak
                    from      mpm.po a LEFT JOIN
                    (
                        select  id_ref,kodeprod, namaprod, banyak
                        from    mpm.po_detail
                    )b on a.id = b.id_ref
                    left JOIN
                    (
                ...
                foreach ($hasil->result() as $row) 
                {
                    ...
                    $banyak = $row->banyak;
                    fputcsv($file, array($nopo,$customerid,$company,$alamat,$ship_to,$kodeprod,$namaprod, $banyak));
                }
