...
class Model_management_rpd extends CI_Model 
{
    public function get_pengajuan($id = ""){
        ...
        $query = "
        select 	a.no_rpd, a.pelaksana, a.maksud_perjalanan_dinas, date(a.created_at) as created_at , a.attachment_akomodasi, b.attachment_realisasi,
    ...
    public function get_pengajuan_bysignature($signature = ""){
        ...
        $query = "
            select 	a.id, a.no_rpd, a.pelaksana, a.jabatan, a.radius_perjalanan, a.attachment_akomodasi, a.keterangan_akomodasi, b.userid_pelaksana as userid_pelaksana,
                    a.attachment_radius_perjalanan, a.tanggal_mulai, a.tanggal_akhir, a.jumlah_verifikasi, a.maksud_perjalanan_dinas, a.tanggal_berangkat, a.tempat_berangkat, 
                    ...
                    a.verifikasi1_ttd, a.verifikasi2_ttd, a.jumlah_verifikasi, a.signature, a.status_realisasi, a.verifikasi1_name, a.verifikasi2_name, a.verifikasi1_status, a.verifikasi2_status
            from management_rpd.pengajuan a left join 
            (
                select a.userid_pelaksana, a.userid_verifikasi1, a.userid_verifikasi2, a.userid_verifikasi3
    ...
    public function generate($created_at){
        ...
        $query = "
            select a.no_rpd, max(substr(a.no_rpd,5,3)) as urut
            from management_rpd.pengajuan a left join (
                select a.id, a.username
                from mpm.user a 
    ...
    public function get_user($id, $kode_company = ''){
        ...
        if ($kode_company) {
            $params_company = "a.active = 1 and a.kode_company = '$kode_company'";
        }else{
            $params_company = "";
        }
        ...
        $query = "
            select *
            from mpm.user a 
            where $params_id $params_company
        ";
    ...
    public function get_approval_by_userid($id = '')
    {
        ...
        $query = "
                SELECT a.userid_pelaksana, b.username, a.userid_verifikasi1, c.username as username_verifikasi1, a.userid_verifikasi2,
                 d.username as username_verifikasi2, b.name as name_pelaksana, c.name as name_verifikasi1, d.name as name_verifikasi2,
                 a.userid_verifikasi3, e.name as name_verifikasi3, e.username as username_verifikasi3
                FROM management_rpd.m_karyawan a
                LEFT JOIN (
                ...
                LEFT JOIN (
                            SELECT a.id, a.username, a.active, a.name
                            FROM mpm.`user` a
                )d ON a.userid_verifikasi2 = d.id
                LEFT JOIN (
                    SELECT a.id, a.username, a.active, a.name
                    FROM mpm.`user` a
                )e ON a.userid_verifikasi3 = e.id
    ...
    public function get_master_limit()
    {
        $query = "
            select * 
            from management_rpd.master_limit a
        ";
        // echo "<pre>";
        // print_r($query);
        // echo "</pre>";
    ...
    public function get_pengajuan_by_no_rpd($no_rpd)
    {
        $query = "
            select *
            from management_rpd.pengajuan a 
            where a.no_rpd = '$no_rpd'
        ";
    ...
    public function update_pengajuan($signature, $data)
    {
